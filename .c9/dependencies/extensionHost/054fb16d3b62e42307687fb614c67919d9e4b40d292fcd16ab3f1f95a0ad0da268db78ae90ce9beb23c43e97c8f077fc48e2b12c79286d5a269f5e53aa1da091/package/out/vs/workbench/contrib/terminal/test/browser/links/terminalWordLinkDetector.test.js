...
define(["require", "exports", "vs/platform/configuration/common/configuration", "vs/platform/configuration/test/common/testConfigurationService", "vs/platform/instantiation/test/common/instantiationServiceMock", "vs/workbench/contrib/terminal/browser/links/terminalWordLinkDetector", "vs/workbench/contrib/terminal/test/browser/links/linkTestUtils", "xterm"], function (require, exports, configuration_1, testConfigurationService_1, instantiationServiceMock_1, terminalWordLinkDetector_1, linkTestUtils_1, xterm_1) {
    ...
    suite('Workbench - TerminalWordLinkDetector', () => {
        ...
        setup(() => {
            ...
            detector = instantiationService.createInstance(terminalWordLinkDetector_1.TerminalWordLinkDetector, xterm);
        });
        async function assertLink(text, expected) {
            await (0, linkTestUtils_1.assertLinkHelper)(text, expected, detector, 3 /* TerminalBuiltinLinkType.Search */);
        }
