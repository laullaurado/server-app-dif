...
define(["require", "exports", "vs/base/common/uri", "vs/base/common/extpath", "vs/base/common/path", "vs/base/common/map", "vs/base/common/strings", "vs/base/common/arrays", "vs/base/common/lifecycle", "vs/base/common/decorators", "vs/base/common/event", "vs/base/common/resources", "vs/workbench/contrib/files/common/explorerFileNestingTrie", "vs/base/common/types"], function (require, exports, uri_1, extpath_1, path_1, map_1, strings_1, arrays_1, lifecycle_1, decorators_1, event_1, resources_1, explorerFileNestingTrie_1, types_1) {
    ...
    class ExplorerItem {
        constructor(resource, fileService, configService, _parent, _isDirectory, _isSymbolicLink, _readonly, _name = (0, resources_1.basenameOrAuthority)(resource), _mtime, _unknown = false) {
        ...
        hasChildren(filter) {
            var _a, _b;
            if (this.hasNests) {
                return (_b = (_a = this.nestedChildren) === null || _a === void 0 ? void 0 : _a.some(c => filter(c))) !== null && _b !== void 0 ? _b : false;
            }
            else {
        ...
        get hasNests() {
            var _a;
            return !!((_a = this.nestedChildren) === null || _a === void 0 ? void 0 : _a.length);
        }
    ...
    class NewExplorerItem extends ExplorerItem {
        constructor(fileService, configService, parent, isDirectory) {
            super(uri_1.URI.file(''), fileService, configService, parent, isDirectory);
            this._isDirectoryResolved = true;
        }
    }
