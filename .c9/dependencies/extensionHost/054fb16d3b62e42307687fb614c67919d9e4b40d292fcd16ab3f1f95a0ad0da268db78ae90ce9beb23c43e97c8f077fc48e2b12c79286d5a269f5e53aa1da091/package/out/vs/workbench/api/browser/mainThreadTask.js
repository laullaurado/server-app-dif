    ...
    let MainThreadTask = class MainThreadTask {
        constructor(extHostContext, _taskService, _workspaceContextServer, _configurationResolverService) {
            ...
            this._taskService.onDidStateChange(async (event) => {
                ...
                if (event.kind === "start" /* TaskEventKind.Start */) {
                    ...
                    if (((_a = execution.task) === null || _a === void 0 ? void 0 : _a.execution) && CustomExecutionDTO.is(execution.task.execution) && event.resolvedVariables) {
                        const dictionary = {};
        ...
        getWorkspace(value) {
            ...
            if (typeof value === 'string') {
                ...
                if (((_a = workspaceObject.configuration) === null || _a === void 0 ? void 0 : _a.toString()) === uri.toString()) {
                        ...
                        this._taskService.getTask(workspace, value.id, true).then((task) => {
                            if (!task) {
                                ...
                                this._taskService.run(task).then(summary => {
                                    ...
                                    if (((summary === null || summary === void 0 ? void 0 : summary.exitCode) === undefined) || (summary.exitCode !== 0)) {
            ...
            this._taskService.registerTaskSystem(key, {
                ...
                resolveVariables: (workspaceFolder, toResolve, target) => {
                    ...
                    return Promise.resolve(this._proxy.$resolveVariables(workspaceFolder.uri, { process: toResolve.process, variables: vars })).then(values => {
                        ...
                        (0, collections_1.forEach)(values.variables, (entry) => {
