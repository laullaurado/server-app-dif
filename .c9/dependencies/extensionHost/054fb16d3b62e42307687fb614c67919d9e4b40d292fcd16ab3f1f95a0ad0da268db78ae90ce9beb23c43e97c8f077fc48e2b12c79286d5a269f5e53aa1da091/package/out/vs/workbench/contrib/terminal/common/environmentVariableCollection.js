 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/common/platform", "vs/workbench/contrib/terminal/common/environmentVariable"], function (require, exports, platform_1, environmentVariable_1) {
    "use strict";
    ...
    class MergedEnvironmentVariableCollection {
        ...
        async applyToProcessEnvironment(env, variableResolver) {
