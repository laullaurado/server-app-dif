 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/base/common/lifecycle", "vs/editor/common/languages/language", "vs/workbench/contrib/notebook/browser/viewModel/foldingModel", "vs/workbench/contrib/notebook/browser/controller/cellOperations", "vs/workbench/contrib/notebook/browser/viewModel/cellSelectionCollection", "vs/workbench/contrib/notebook/common/notebookCommon", "vs/workbench/contrib/notebook/test/browser/testNotebookEditor"], function (require, exports, assert, lifecycle_1, language_1, foldingModel_1, cellOperations_1, cellSelectionCollection_1, notebookCommon_1, testNotebookEditor_1) {
    "use strict";
            ...
            await (0, testNotebookEditor_1.withTestNotebook)([
                ...
                editor.textModel.applyEdits([{
                        editType: 1 /* CellEditType.Replace */, index: 0, count: 0, cells: [
                            new testNotebookEditor_1.TestCell(viewModel.viewType, 7, '# header f', 'markdown', notebookCommon_1.CellKind.Code, [], languageService),
                            new testNotebookEditor_1.TestCell(viewModel.viewType, 8, 'var g = 5;', 'javascript', notebookCommon_1.CellKind.Code, [], languageService)
                        ]
                    }], true, undefined, () => undefined, undefined, false);
                viewModel.updateFoldingRanges(foldingModel.regions);
                cellList.setHiddenAreas(viewModel.getHiddenRanges(), true);
