...
define(["require", "exports", "vs/base/common/path"], function (require, exports, path_1) {
    ...
    exports.osPathModule = exports.updateLinkWithRelativeCwd = exports.positionIsInRange = exports.getXtermLineContent = exports.convertBufferRangeToViewport = exports.convertLinkRangeToBuffer = void 0;
    /**
     ...
     */
    function updateLinkWithRelativeCwd(capabilities, y, text, pathSeparator) {
        var _a;
        const cwd = (_a = capabilities.get(2 /* TerminalCapability.CommandDetection */)) === null || _a === void 0 ? void 0 : _a.getCwdForLine(y);
        if (!cwd) {
            return undefined;
        }
