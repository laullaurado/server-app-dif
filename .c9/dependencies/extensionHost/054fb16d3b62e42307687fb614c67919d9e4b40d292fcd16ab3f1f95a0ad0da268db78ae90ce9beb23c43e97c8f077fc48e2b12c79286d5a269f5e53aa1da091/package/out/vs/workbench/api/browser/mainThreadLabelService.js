...
define(["require", "exports", "vs/workbench/api/common/extHost.protocol", "vs/workbench/services/extensions/common/extHostCustomers", "vs/platform/label/common/label", "vs/base/common/lifecycle"], function (require, exports, extHost_protocol_1, extHostCustomers_1, label_1, lifecycle_1) {
    "use strict";
    ...
    let MainThreadLabelService = class MainThreadLabelService {
        ...
        $unregisterResourceLabelFormatter(handle) {
            (0, lifecycle_1.dispose)(this._resourceLabelFormatters.get(handle));
