...
define(["require", "exports", "vs/base/common/event", "vs/base/common/iterator", "vs/base/common/lifecycle", "vs/base/common/types", "vs/workbench/contrib/testing/browser/explorerProjections/hierarchalNodes", "vs/workbench/contrib/testing/browser/explorerProjections/index", "vs/workbench/contrib/testing/browser/explorerProjections/nodeHelper", "vs/workbench/contrib/testing/common/getComputedState", "vs/workbench/contrib/testing/common/testResultService", "vs/workbench/contrib/testing/common/testService"], function (require, exports, event_1, iterator_1, lifecycle_1, types_1, hierarchalNodes_1, index_1, nodeHelper_1, getComputedState_1, testResultService_1, testService_1) {
    "use strict";
    ...
    const computedStateAccessor = {
        ...
        getChildren: i => iterator_1.Iterable.filter(i.children.values(), (t) => t instanceof index_1.TestItemTreeElement),
        *getParents(i) {
    ...
    let HierarchicalByLocationProjection = class HierarchicalByLocationProjection extends lifecycle_1.Disposable {
        constructor(lastState, testService, results) {
            ...
            this.renderNode = (node, recurse) => {
                ...
                if (node.depth === 0) {
                    ...
                    if (!(0, nodeHelper_1.peersHaveChildren)(node, () => this.roots)) {
            ...
            this._register(results.onResultsChanged((evt) => {
                ...
                for (const inTree of [...this.items.values()].sort((a, b) => b.depth - a.depth)) {
                    ...
                    inTree.ownDuration = lookup === null || lookup === void 0 ? void 0 : lookup.ownDuration;
                    (0, getComputedState_1.refreshComputedState)(computedStateAccessor, inTree, (_b = lookup === null || lookup === void 0 ? void 0 : lookup.ownComputedState) !== null && _b !== void 0 ? _b : 0 /* TestResultState.Unset */).forEach(this.addUpdated);
                }
            ...
            this._register(results.onTestChanged(ev => {
                ...
                (0, getComputedState_1.refreshComputedState)(computedStateAccessor, item, explicitComputed, refreshDuration).forEach(this.addUpdated);
                this.addUpdated(item);
                this.updateEmitter.fire();
            }));
        ...
        get roots() {
            ...
            return iterator_1.Iterable.filter(rootsIt, types_1.isDefined);
        }
        /**
        ...
        unstoreItem(items, treeElement) {
            ...
            parent === null || parent === void 0 ? void 0 : parent.children.delete(treeElement);
            items.delete(treeElement.test.item.extId);
            if (parent instanceof hierarchalNodes_1.ByLocationTestItemElement) {
                (0, getComputedState_1.refreshComputedState)(computedStateAccessor, parent, undefined, !!treeElement.duration).forEach(this.addUpdated);
            }
            return treeElement.children;
        }
        storeItem(treeElement) {
            var _a, _b;
            (_a = treeElement.parent) === null || _a === void 0 ? void 0 : _a.children.add(treeElement);
            ...
            const prevState = (_b = this.results.getStateById(treeElement.test.item.extId)) === null || _b === void 0 ? void 0 : _b[1];
            if (prevState) {
                treeElement.ownState = prevState.computedState;
                treeElement.ownDuration = prevState.ownDuration;
                (0, getComputedState_1.refreshComputedState)(computedStateAccessor, treeElement, undefined, !!treeElement.ownDuration).forEach(this.addUpdated);
            }
        }
    };
