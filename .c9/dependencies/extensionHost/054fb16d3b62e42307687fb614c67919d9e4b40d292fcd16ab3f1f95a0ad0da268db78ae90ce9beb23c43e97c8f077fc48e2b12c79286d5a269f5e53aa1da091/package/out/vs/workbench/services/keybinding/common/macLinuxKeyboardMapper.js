    ...
    class MacLinuxKeyboardMapper {
        ...
        simpleKeybindingToScanCodeBinding(keybinding) {
            ...
            if (keybinding.keyCode === 3 /* KeyCode.Enter */) {
                return [new keybindings_1.ScanCodeBinding(keybinding.ctrlKey, keybinding.shiftKey, keybinding.altKey, keybinding.metaKey, 46 /* ScanCode.Enter */)];
            }
            ...
            for (let i = 0, len = scanCodeCombos.length; i < len; i++) {
                ...
                result[i] = new keybindings_1.ScanCodeBinding(scanCodeCombo.ctrlKey, scanCodeCombo.shiftKey, scanCodeCombo.altKey, keybinding.metaKey, scanCodeCombo.scanCode);
            }
            return result;
        }
        ...
        getUserSettingsLabelForScanCodeBinding(binding) {
            ...
            const immutableKeyCode = keyCodes_1.IMMUTABLE_CODE_TO_KEY_CODE[binding.scanCode];
            ...
            if (constantKeyCode !== -1 /* KeyCode.DependsOnKbLayout */) {
                ...
                let reverseBindings = this.simpleKeybindingToScanCodeBinding(new keybindings_1.SimpleKeybinding(binding.ctrlKey, binding.shiftKey, binding.altKey, binding.metaKey, constantKeyCode));
        ...
        resolveKeyboardEvent(keyboardEvent) {
            ...
            const keypress = new keybindings_1.ScanCodeBinding(keyboardEvent.ctrlKey, keyboardEvent.shiftKey, keyboardEvent.altKey, keyboardEvent.metaKey, code);
        ...
        _resolveSimpleUserBinding(binding) {
            ...
            if (binding instanceof keybindings_1.ScanCodeBinding) {
                return [binding];
            }
