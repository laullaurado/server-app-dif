...
define(["require", "exports", "vs/nls", "vs/base/browser/dom", "vs/base/common/color", "vs/base/common/lifecycle", "vs/editor/browser/editorExtensions", "vs/editor/common/core/range", "vs/editor/common/encodedTokenAttributes", "vs/editor/common/languages/language", "vs/platform/notification/common/notification", "vs/platform/theme/common/colorRegistry", "vs/platform/theme/common/themeService", "vs/workbench/services/textMate/common/TMHelper", "vs/workbench/services/textMate/browser/textMate", "vs/workbench/services/themes/common/workbenchThemeService", "vs/base/common/cancellation", "vs/platform/theme/common/tokenClassificationRegistry", "vs/platform/configuration/common/configuration", "vs/editor/common/services/modelService", "vs/platform/theme/common/theme", "vs/base/common/network", "vs/editor/common/services/languageFeatures", "vs/css!./inspectEditorTokens"], function (require, exports, nls, dom, color_1, lifecycle_1, editorExtensions_1, range_1, encodedTokenAttributes_1, language_1, notification_1, colorRegistry_1, themeService_1, TMHelper_1, textMate_1, workbenchThemeService_1, cancellation_1, tokenClassificationRegistry_1, configuration_1, modelService_1, theme_1, network_1, languageFeatures_1) {
    "use strict";
    ...
    InspectEditorTokensController = __decorate([
        __param(1, textMate_1.ITextMateService),
    ...
    class InspectEditorTokensWidget extends lifecycle_1.Disposable {
        ...
        _beginCompute(position) {
            ...
            Promise.all([grammar, semanticTokens]).then(([grammar, semanticTokens]) => {
                ...
                setTimeout(() => {
                    var _a;
                    (_a = InspectEditorTokensController.get(this._editor)) === null || _a === void 0 ? void 0 : _a.stop();
                });
            });
        }
        _isSemanticColoringEnabled() {
            var _a;
            const setting = (_a = this._configurationService.getValue(modelService_1.SEMANTIC_HIGHLIGHTING_SETTING_ID, { overrideIdentifier: this._model.getLanguageId(), resource: this._model.uri })) === null || _a === void 0 ? void 0 : _a.enabled;
        ...
        _decodeMetadata(metadata) {
            ...
            let tokenType = encodedTokenAttributes_1.TokenMetadata.getTokenType(metadata);
            let fontStyle = encodedTokenAttributes_1.TokenMetadata.getFontStyle(metadata);
            let foreground = encodedTokenAttributes_1.TokenMetadata.getForeground(metadata);
            let background = encodedTokenAttributes_1.TokenMetadata.getBackground(metadata);
            return {
                ...
                if (posLine === line && character <= posCharacter && posCharacter < character + len) {
                    ...
                    if (tokenStyle) {
                        metadata = {
                            ...
                            strikethrough: tokenStyle === null || tokenStyle === void 0 ? void 0 : tokenStyle.strikethrough,
                            foreground: colorMap[(tokenStyle === null || tokenStyle === void 0 ? void 0 : tokenStyle.foreground) || 0 /* ColorId.None */],
    ...
    (0, themeService_1.registerThemingParticipant)((theme, collector) => {
        ...
        if (border) {
            let borderWidth = (0, theme_1.isHighContrast)(theme.type) ? 2 : 1;
