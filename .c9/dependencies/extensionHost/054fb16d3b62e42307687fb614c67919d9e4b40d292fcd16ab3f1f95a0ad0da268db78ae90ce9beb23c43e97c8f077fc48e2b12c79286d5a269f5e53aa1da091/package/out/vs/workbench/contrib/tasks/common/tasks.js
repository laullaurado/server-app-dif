...
define(["require", "exports", "vs/nls", "vs/base/common/types", "vs/base/common/resources", "vs/base/common/objects", "vs/platform/contextkey/common/contextkey", "vs/workbench/contrib/tasks/common/taskDefinitionRegistry"], function (require, exports, nls, Types, resources, Objects, contextkey_1, taskDefinitionRegistry_1) {
    ...
    (function (TaskSourceKind) {
        ...
        function toConfigurationTarget(kind) {
            switch (kind) {
                case TaskSourceKind.User: return 1 /* ConfigurationTarget.USER */;
                case TaskSourceKind.WorkspaceFile: return 4 /* ConfigurationTarget.WORKSPACE */;
                default: return 5 /* ConfigurationTarget.WORKSPACE_FOLDER */;
            }
        }
    ...
    class CustomTask extends CommonTask {
        ...
        getFolderId() {
            var _a;
            return this._source.kind === TaskSourceKind.User ? exports.USER_TASKS_GROUP_KEY : (_a = this._source.config.workspaceFolder) === null || _a === void 0 ? void 0 : _a.uri.toString();
        }
        getCommonTaskId() {
            var _a;
    ...
    var TaskEvent;
    (function (TaskEvent) {
        function create(kind, task, processIdOrExitCodeOrTerminalId, resolvedVariables) {
            if (task) {
                let result = {
                    kind: kind,
                    taskId: task._id,
