...
define(["require", "exports", "vs/nls", "vs/editor/common/services/languagesAssociations", "vs/editor/common/services/model", "vs/editor/common/languages/language", "vs/editor/common/services/resolverService", "vs/workbench/contrib/debug/common/debug", "vs/workbench/contrib/debug/common/debugSource", "vs/editor/common/services/editorWorker", "vs/editor/common/core/editOperation", "vs/editor/common/core/range", "vs/base/common/cancellation", "vs/editor/common/languages/modesRegistry"], function (require, exports, nls_1, languagesAssociations_1, model_1, language_1, resolverService_1, debug_1, debugSource_1, editorWorker_1, editOperation_1, range_1, cancellation_1, modesRegistry_1) {
    "use strict";
    ...
    let DebugContentProvider = class DebugContentProvider {
        ...
        createOrUpdateContentModel(resource, createIfNotExists) {
            ...
            if (!session) {
                return Promise.reject(new Error((0, nls_1.localize)('unable', "Unable to resolve the resource without a debug session")));
            }
