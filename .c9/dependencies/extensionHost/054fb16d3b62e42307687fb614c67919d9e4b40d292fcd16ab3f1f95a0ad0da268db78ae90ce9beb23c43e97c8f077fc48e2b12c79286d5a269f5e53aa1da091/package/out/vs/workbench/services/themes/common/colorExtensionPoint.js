                ...
                for (const extension of delta.added) {
                    ...
                    for (const colorContribution of extensionValue) {
                        ...
                        colorRegistry.registerColor(colorContribution.id, {
                            ...
                            hcDark: parseColorValue((_a = defaults.highContrast) !== null && _a !== void 0 ? _a : defaults.dark, 'configuration.colors.defaults.highContrast'),
                            hcLight: parseColorValue((_b = defaults.highContrastLight) !== null && _b !== void 0 ? _b : defaults.light, 'configuration.colors.defaults.highContrastLight'),
