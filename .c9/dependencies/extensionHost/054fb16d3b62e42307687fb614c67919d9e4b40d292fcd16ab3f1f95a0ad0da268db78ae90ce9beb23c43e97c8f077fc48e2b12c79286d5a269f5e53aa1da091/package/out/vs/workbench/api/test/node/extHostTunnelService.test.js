 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/workbench/api/node/extHostTunnelService"], function (require, exports, assert, extHostTunnelService_1) {
    "use strict";
...
0 S node      1058  1056  0  80   0 -   770 pipe_w   888   9 14:43 ?        00:00:00 grep root`;
    suite('ExtHostTunnelService', () => {
        test('getSockets', function () {
            const result = (0, extHostTunnelService_1.getSockets)(procSockets);
        ...
        test('loadConnectionTable', function () {
            const result = (0, extHostTunnelService_1.loadConnectionTable)(tcp);
        ...
        test('loadListeningPorts', function () {
            const result = (0, extHostTunnelService_1.loadListeningPorts)(tcp, tcp6);
        ...
        test('tryFindRootPorts', function () {
            var _a;
            const rootProcesses = (0, extHostTunnelService_1.getRootProcesses)(psStdOut);
            assert.strictEqual(rootProcesses.length, 6);
            const result = (0, extHostTunnelService_1.tryFindRootPorts)([{ socket: 1000, ip: '127.0.0.1', port: 5000 }], psStdOut, new Map());
            assert.strictEqual(result.size, 1);
            assert.strictEqual((_a = result.get(5000)) === null || _a === void 0 ? void 0 : _a.pid, 514);
        });
        test('findPorts', async function () {
            const result = await (0, extHostTunnelService_1.findPorts)((0, extHostTunnelService_1.loadListeningPorts)(tcp, tcp6), (0, extHostTunnelService_1.getSockets)(procSockets), processes);
