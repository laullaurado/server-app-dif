...
define(["require", "exports", "vs/platform/product/common/productService", "vs/base/common/actions", "vs/base/common/uri", "vs/platform/instantiation/common/instantiation", "vs/nls", "vs/base/common/cancellation", "vs/platform/request/common/request", "vs/base/common/resources", "vs/platform/dialogs/common/dialogs", "vs/base/common/severity", "vs/platform/opener/common/opener", "vs/platform/native/electron-sandbox/native", "vs/workbench/services/environment/electron-sandbox/environmentService", "vs/platform/profiling/common/profiling", "vs/platform/files/common/files", "vs/base/common/buffer"], function (require, exports, productService_1, actions_1, uri_1, instantiation_1, nls_1, cancellation_1, request_1, resources_1, dialogs_1, severity_1, opener_1, native_1, environmentService_1, profiling_1, files_1, buffer_1) {
    "use strict";
...
- VS Code version: \`${this._productService.version}\`\n\n${message}`);
            ...
            this._dialogService.show(severity_1.default.Info, (0, nls_1.localize)('attach.title', "Did you attach the CPU-Profile?"), undefined, { detail: (0, nls_1.localize)('attach.msg', "This is a reminder to make sure that you have not forgotten to attach '{0}' to the issue you have just created.", path.fsPath) });
        }
    };
    ...
    let ShowExtensionSlowAction = class ShowExtensionSlowAction extends actions_1.Action {
        ...
        async run() {
            ...
            this._openerService.open(uri_1.URI.parse(url));
            this._dialogService.show(severity_1.default.Info, (0, nls_1.localize)('attach.title', "Did you attach the CPU-Profile?"), undefined, { detail: (0, nls_1.localize)('attach.msg2', "This is a reminder to make sure that you have not forgotten to attach '{0}' to an existing performance issue.", path.fsPath) });
        }
    };
