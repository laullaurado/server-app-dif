...
define(["require", "exports", "vs/base/browser/dom", "vs/base/browser/ui/actionbar/actionbar", "vs/base/browser/ui/button/button", "vs/base/browser/ui/inputbox/inputBox", "vs/base/browser/ui/widget", "vs/base/common/actions", "vs/base/common/async", "vs/base/common/event", "vs/editor/contrib/find/browser/findModel", "vs/nls", "vs/platform/clipboard/common/clipboardService", "vs/platform/configuration/common/configuration", "vs/platform/contextkey/common/contextkey", "vs/platform/contextview/browser/contextView", "vs/platform/keybinding/common/keybinding", "vs/platform/keybinding/common/keybindingsRegistry", "vs/platform/theme/common/styler", "vs/platform/theme/common/themeService", "vs/platform/history/browser/contextScopedHistoryWidget", "vs/workbench/contrib/search/browser/searchActions", "vs/workbench/contrib/search/common/constants", "vs/platform/accessibility/common/accessibility", "vs/base/common/platform", "vs/base/browser/ui/toggle/toggle", "vs/workbench/common/views", "vs/workbench/contrib/search/browser/searchIcons", "vs/workbench/contrib/searchEditor/browser/constants", "vs/platform/history/browser/historyWidgetKeybindingHint"], function (require, exports, dom, actionbar_1, button_1, inputBox_1, widget_1, actions_1, async_1, event_1, findModel_1, nls, clipboardService_1, configuration_1, contextkey_1, contextView_1, keybinding_1, keybindingsRegistry_1, styler_1, themeService_1, contextScopedHistoryWidget_1, searchActions_1, Constants, accessibility_1, platform_1, toggle_1, views_1, searchIcons_1, constants_1, historyWidgetKeybindingHint_1) {
    ...
    class ReplaceAllAction extends actions_1.Action {
        constructor(_searchWidget) {
            super(ReplaceAllAction.ID, '', themeService_1.ThemeIcon.asClassName(searchIcons_1.searchReplaceAllIcon), false);
    ...
    let SearchWidget = class SearchWidget extends widget_1.Widget {
        ...
        renderSearchInput(parent, options) {
            ...
            const inputOptions = {
                ...
                appendCaseSensitiveLabel: (0, searchActions_1.appendKeyBindingLabel)('', this.keybindingService.lookupKeybinding(Constants.ToggleCaseSensitiveCommandId), this.keybindingService),
                appendWholeWordsLabel: (0, searchActions_1.appendKeyBindingLabel)('', this.keybindingService.lookupKeybinding(Constants.ToggleWholeWordCommandId), this.keybindingService),
                appendRegexLabel: (0, searchActions_1.appendKeyBindingLabel)('', this.keybindingService.lookupKeybinding(Constants.ToggleRegexCommandId), this.keybindingService),
            ...
            this._register((0, styler_1.attachFindReplaceInputBoxStyler)(this.searchInput, this.themeService));
            ...
            this.showContextToggle = new toggle_1.Toggle({
                isChecked: false,
                title: (0, searchActions_1.appendKeyBindingLabel)(nls.localize('showContext', "Toggle Context Lines"), this.keybindingService.lookupKeybinding(constants_1.ToggleSearchEditorContextLinesCommandId), this.keybindingService),
            ...
            if (options.showContextToggle) {
                ...
                this._register((0, styler_1.attachInputBoxStyler)(this.contextLinesInput, this.themeService));
        ...
        renderReplaceInput(parent, options) {
            ...
            this.replaceInput = this._register(new contextScopedHistoryWidget_1.ContextScopedReplaceInput(replaceBox, this.contextViewService, {
                ...
                appendPreserveCaseLabel: (0, searchActions_1.appendKeyBindingLabel)('', this.keybindingService.lookupKeybinding(Constants.TogglePreserveCaseId), this.keybindingService),
            ...
            this._register((0, styler_1.attachFindReplaceInputBoxStyler)(this.replaceInput, this.themeService));
        ...
        onToggleReplaceButton() {
            ...
            if (this.isReplaceShown()) {
                this.toggleReplaceButton.element.classList.remove(...themeService_1.ThemeIcon.asClassNameArray(searchIcons_1.searchHideReplaceIcon));
                this.toggleReplaceButton.element.classList.add(...themeService_1.ThemeIcon.asClassNameArray(searchIcons_1.searchShowReplaceIcon));
            }
            else {
                this.toggleReplaceButton.element.classList.remove(...themeService_1.ThemeIcon.asClassNameArray(searchIcons_1.searchShowReplaceIcon));
                this.toggleReplaceButton.element.classList.add(...themeService_1.ThemeIcon.asClassNameArray(searchIcons_1.searchHideReplaceIcon));
            }
    ...
    SearchWidget.REPLACE_ALL_ENABLED_LABEL = (keyBindingService2) => {
        ...
        return (0, searchActions_1.appendKeyBindingLabel)(nls.localize('search.action.replaceAll.enabled.label', "Replace All"), kb, keyBindingService2);
    };
    ...
    function registerContributions() {
        keybindingsRegistry_1.KeybindingsRegistry.registerCommandAndKeybindingRule({
            ...
            handler: accessor => {
                ...
                if ((0, searchActions_1.isSearchViewFocused)(viewsService)) {
