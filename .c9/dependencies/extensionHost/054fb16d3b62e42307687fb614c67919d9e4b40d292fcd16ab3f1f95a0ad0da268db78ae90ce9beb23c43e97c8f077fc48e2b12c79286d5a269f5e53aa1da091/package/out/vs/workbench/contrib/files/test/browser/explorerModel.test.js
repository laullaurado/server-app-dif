...
define(["require", "exports", "assert", "vs/base/common/platform", "vs/base/common/uri", "vs/base/common/path", "vs/workbench/contrib/files/browser/fileActions", "vs/workbench/contrib/files/common/explorerModel", "vs/base/test/common/utils", "vs/workbench/test/browser/workbenchTestServices", "vs/platform/configuration/test/common/testConfigurationService"], function (require, exports, assert, platform_1, uri_1, path_1, fileActions_1, explorerModel_1, utils_1, workbenchTestServices_1, testConfigurationService_1) {
    ...
    suite('Files - View Model', function () {
        ...
        function createStat(path, name, isFolder, hasChildren, size, mtime) {
            return new explorerModel_1.ExplorerItem(utils_1.toResource.call(this, path), fileService, configService, undefined, isFolder, false, false, name, mtime);
        }
        ...
        test('Merge Local with Disk', function () {
            const merge1 = new explorerModel_1.ExplorerItem(uri_1.URI.file((0, path_1.join)('C:\\', '/path/to')), fileService, configService, undefined, true, false, false, 'to', Date.now());
            const merge2 = new explorerModel_1.ExplorerItem(uri_1.URI.file((0, path_1.join)('C:\\', '/path/to')), fileService, configService, undefined, true, false, false, 'to', Date.now());
            // Merge Properties
            ...
            merge2.addChild(new explorerModel_1.ExplorerItem(uri_1.URI.file((0, path_1.join)('C:\\', '/path/to/foo.html')), fileService, configService, undefined, true, false, false, 'foo.html', Date.now()));
            explorerModel_1.ExplorerItem.mergeLocalWithDisk(merge2, merge1);
            // Merge Child with isDirectoryResolved=true
            const child = new explorerModel_1.ExplorerItem(uri_1.URI.file((0, path_1.join)('C:\\', '/path/to/foo.html')), fileService, configService, undefined, true, false, false, 'foo.html', Date.now());
