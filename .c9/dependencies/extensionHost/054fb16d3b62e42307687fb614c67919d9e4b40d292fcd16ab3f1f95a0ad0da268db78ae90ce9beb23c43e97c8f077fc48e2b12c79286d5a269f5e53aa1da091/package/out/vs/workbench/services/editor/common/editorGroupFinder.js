...
define(["require", "exports", "vs/base/common/resources", "vs/platform/configuration/common/configuration", "vs/platform/editor/common/editor", "vs/workbench/common/editor", "vs/workbench/services/editor/common/editorGroupsService", "vs/workbench/services/editor/common/editorService"], function (require, exports, resources_1, configuration_1, editor_1, editor_2, editorGroupsService_1, editorService_1) {
    ...
    function doFindGroup(input, preferredGroup, editorGroupService, configurationService) {
        let group;
        let editor = (0, editor_2.isEditorInputWithOptions)(input) ? input.editor : input;
        ...
        // Group: Unspecified without a specific index to open
            ...
            if (!group) {
                if ((options === null || options === void 0 ? void 0 : options.revealIfOpened) || configurationService.getValue('workbench.editor.revealIfOpen') || ((0, editor_2.isEditorInput)(editor) && editor.hasCapability(8 /* EditorInputCapabilities.Singleton */))) {
    ...
    function matchesEditor(typedEditor, editor) {
        ...
        if (typedEditor.resource) {
            return (0, resources_1.isEqual)(typedEditor.resource, editor_2.EditorResourceAccessor.getCanonicalUri(editor));
        }
        return false;
    }
});
