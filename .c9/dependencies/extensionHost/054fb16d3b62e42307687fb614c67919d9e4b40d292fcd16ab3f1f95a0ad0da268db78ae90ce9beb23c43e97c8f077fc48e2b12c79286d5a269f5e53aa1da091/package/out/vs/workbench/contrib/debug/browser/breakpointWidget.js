...
define(["require", "exports", "vs/nls", "vs/base/browser/ui/selectBox/selectBox", "vs/base/common/lifecycle", "vs/base/browser/dom", "vs/editor/common/core/position", "vs/editor/contrib/zoneWidget/browser/zoneWidget", "vs/platform/contextview/browser/contextView", "vs/workbench/contrib/debug/common/debug", "vs/platform/theme/common/styler", "vs/platform/theme/common/themeService", "vs/platform/instantiation/common/instantiation", "vs/platform/contextkey/common/contextkey", "vs/editor/browser/editorExtensions", "vs/editor/common/editorContextKeys", "vs/editor/common/services/model", "vs/base/common/uri", "vs/editor/contrib/suggest/browser/suggest", "vs/editor/browser/services/codeEditorService", "vs/platform/theme/common/colorRegistry", "vs/platform/instantiation/common/serviceCollection", "vs/editor/browser/widget/codeEditorWidget", "vs/workbench/contrib/codeEditor/browser/simpleEditorOptions", "vs/editor/common/core/range", "vs/base/common/errors", "vs/platform/configuration/common/configuration", "vs/editor/common/languages/modesRegistry", "vs/editor/common/services/languageFeatures", "vs/css!./media/breakpointWidget"], function (require, exports, nls, selectBox_1, lifecycle, dom, position_1, zoneWidget_1, contextView_1, debug_1, styler_1, themeService_1, instantiation_1, contextkey_1, editorExtensions_1, editorContextKeys_1, model_1, uri_1, suggest_1, codeEditorService_1, colorRegistry_1, serviceCollection_1, codeEditorWidget_1, simpleEditorOptions_1, range_1, errors_1, configuration_1, modesRegistry_1, languageFeatures_1) {
    "use strict";
    ...
    function createDecorations(theme, placeHolder) {
        var _a;
        const transparentForeground = (_a = theme.getColor(colorRegistry_1.editorForeground)) === null || _a === void 0 ? void 0 : _a.transparent(0.4);
        return [{
                range: {
                    startLineNumber: 0,
                    endLineNumber: 0,
    ...
    let BreakpointWidget = class BreakpointWidget extends zoneWidget_1.ZoneWidget {
        ...
        _fillContainer(container) {
            ...
            this.toDispose.push((0, styler_1.attachSelectBoxStyler)(selectBox, this.themeService));
