...
define(["require", "exports", "vs/nls", "vs/base/browser/dom", "vs/base/browser/fastDomNode", "vs/base/browser/formattedTextRenderer", "vs/base/browser/ui/aria/aria", "vs/base/browser/ui/widget", "vs/base/common/lifecycle", "vs/base/common/platform", "vs/base/common/strings", "vs/base/common/uri", "vs/editor/browser/editorExtensions", "vs/editor/common/editorContextKeys", "vs/editor/contrib/toggleTabFocusMode/browser/toggleTabFocusMode", "vs/platform/configuration/common/configuration", "vs/platform/contextkey/common/contextkey", "vs/platform/instantiation/common/instantiation", "vs/platform/keybinding/common/keybinding", "vs/platform/opener/common/opener", "vs/platform/theme/common/colorRegistry", "vs/platform/theme/common/themeService", "vs/platform/actions/common/actions", "vs/platform/commands/common/commands", "vs/workbench/contrib/files/browser/fileConstants", "vs/editor/browser/services/codeEditorService", "vs/css!./accessibility"], function (require, exports, nls, dom, fastDomNode_1, formattedTextRenderer_1, aria_1, widget_1, lifecycle_1, platform, strings, uri_1, editorExtensions_1, editorContextKeys_1, toggleTabFocusMode_1, configuration_1, contextkey_1, instantiation_1, keybinding_1, opener_1, colorRegistry_1, themeService_1, actions_1, commands_1, fileConstants_1, codeEditorService_1) {
    "use strict";
        ...
        constructor(editor, _contextKeyService, _keybindingService, _configurationService, _openerService) {
            ...
            this._register(dom.addStandardDisposableListener(this._contentDomNode.domNode, 'keydown', (e) => {
                ...
                if (e.equals(2048 /* KeyMod.CtrlCmd */ | 35 /* KeyCode.KeyE */)) {
                    (0, aria_1.alert)(nls.localize('emergencyConfOn', "Now changing the setting `editor.accessibilitySupport` to 'on'."));
                    this._configurationService.updateValue('editor.accessibilitySupport', 'on');
                    e.preventDefault();
                    e.stopPropagation();
                }
                if (e.equals(2048 /* KeyMod.CtrlCmd */ | 38 /* KeyCode.KeyH */)) {
                    (0, aria_1.alert)(nls.localize('openingDocs', "Now opening the VS Code Accessibility documentation page."));
