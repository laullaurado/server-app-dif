...
define(["require", "exports", "vs/nls", "vs/base/common/color", "vs/base/common/types"], function (require, exports, nls, color_1, types_1) {
    ...
    function createValidator(prop) {
        const type = (0, types_1.isArray)(prop.type) ? prop.type : [prop.type];
    ...
    function getInvalidTypeError(value, type) {
        ...
        const typeArr = (0, types_1.isArray)(type) ? type : [type];
    ...
    function valueValidatesAsType(value, type) {
        ...
        if (type === 'boolean') {
            ...
            return value && !(0, types_1.isArray)(value) && valueType === 'object';
        }
        else if (type === 'null') {
            return value === null;
        }
        else if (type === 'array') {
            return (0, types_1.isArray)(value);
        }
        else if (type === 'string') {
    ...
    function getArrayValidator(prop) {
        if (prop.type === 'array' && prop.items && !(0, types_1.isArray)(prop.items)) {
            const propItems = prop.items;
            if (propItems && !(0, types_1.isArray)(propItems.type)) {
