...
define(["require", "exports", "vs/base/browser/dom", "vs/base/browser/keyboardEvent", "vs/base/browser/ui/actionbar/actionbar", "vs/base/browser/ui/actionbar/actionViewItems", "vs/base/browser/ui/widget", "vs/base/common/actions", "vs/base/common/event", "vs/base/common/htmlContent", "vs/base/common/lifecycle", "vs/base/common/network", "vs/base/common/resources", "vs/base/common/uri", "vs/nls", "vs/platform/history/browser/contextScopedHistoryWidget", "vs/platform/history/browser/historyWidgetKeybindingHint", "vs/platform/contextkey/common/contextkey", "vs/platform/contextview/browser/contextView", "vs/platform/instantiation/common/instantiation", "vs/platform/keybinding/common/keybinding", "vs/platform/label/common/label", "vs/platform/theme/common/colorRegistry", "vs/platform/theme/common/styler", "vs/platform/theme/common/themeService", "vs/platform/workspace/common/workspace", "vs/workbench/common/theme", "vs/workbench/contrib/preferences/browser/preferencesIcons", "vs/workbench/services/environment/common/environmentService", "vs/workbench/services/preferences/common/preferences", "vs/editor/common/languages/language"], function (require, exports, DOM, keyboardEvent_1, actionbar_1, actionViewItems_1, widget_1, actions_1, event_1, htmlContent_1, lifecycle_1, network_1, resources_1, uri_1, nls_1, contextScopedHistoryWidget_1, historyWidgetKeybindingHint_1, contextkey_1, contextView_1, instantiation_1, keybinding_1, label_1, colorRegistry_1, styler_1, themeService_1, workspace_1, theme_1, preferencesIcons_1, environmentService_1, preferences_1, language_1) {
    ...
    let FolderSettingsActionViewItem = class FolderSettingsActionViewItem extends actionViewItems_1.BaseActionViewItem {
        ...
        async update() {
            ...
            if (this._folder) {
                ...
                this.anchorElement.title = ((_a = (await this.preferencesService.getEditableSettingsURI(5 /* ConfigurationTarget.WORKSPACE_FOLDER */, this._folder.uri))) === null || _a === void 0 ? void 0 : _a.fsPath) || '';
    ...
    let SettingsTargetsWidget = class SettingsTargetsWidget extends widget_1.Widget {
        constructor(parent, options, contextService, instantiationService, environmentService, labelService, preferencesService, languageService) {
            super();
            this.contextService = contextService;
        ...
        create(parent) {
            ...
            this.userLocalSettings = new actions_1.Action('userSettings', '', '.settings-tab', true, () => this.updateTarget(2 /* ConfigurationTarget.USER_LOCAL */));
            this.preferencesService.getEditableSettingsURI(2 /* ConfigurationTarget.USER_LOCAL */).then(uri => {
                // Don't wait to create UI on resolving remote
                this.userLocalSettings.tooltip = (uri === null || uri === void 0 ? void 0 : uri.fsPath) || '';
            });
            this.userRemoteSettings = new actions_1.Action('userSettingsRemote', '', '.settings-tab', true, () => this.updateTarget(3 /* ConfigurationTarget.USER_REMOTE */));
            this.preferencesService.getEditableSettingsURI(3 /* ConfigurationTarget.USER_REMOTE */).then(uri => {
                this.userRemoteSettings.tooltip = (uri === null || uri === void 0 ? void 0 : uri.fsPath) || '';
            });
            this.workspaceSettings = new actions_1.Action('workspaceSettings', '', '.settings-tab', false, () => this.updateTarget(4 /* ConfigurationTarget.WORKSPACE */));
            this.folderSettingsAction = new actions_1.Action('folderSettings', '', '.settings-tab', false, async (folder) => {
                this.updateTarget((0, workspace_1.isWorkspaceFolder)(folder) ? folder.uri : 2 /* ConfigurationTarget.USER_LOCAL */);
            });
        ...
        set settingsTarget(settingsTarget) {
            ...
            this.userLocalSettings.checked = 2 /* ConfigurationTarget.USER_LOCAL */ === this.settingsTarget;
            this.userRemoteSettings.checked = 3 /* ConfigurationTarget.USER_REMOTE */ === this.settingsTarget;
            this.workspaceSettings.checked = 4 /* ConfigurationTarget.WORKSPACE */ === this.settingsTarget;
        ...
        setResultCount(settingsTarget, count) {
            if (settingsTarget === 4 /* ConfigurationTarget.WORKSPACE */) {
            ...
            else if (settingsTarget === 2 /* ConfigurationTarget.USER_LOCAL */) {
        ...
        onWorkbenchStateChanged() {
            ...
            this.update();
            if (this.settingsTarget === 4 /* ConfigurationTarget.WORKSPACE */ && this.contextService.getWorkbenchState() === 3 /* WorkbenchState.WORKSPACE */) {
                this.updateTarget(2 /* ConfigurationTarget.USER_LOCAL */);
            }
        }
        ...
        async update() {
            ...
            this.folderSettings.getAction().enabled = this.contextService.getWorkbenchState() === 3 /* WorkbenchState.WORKSPACE */ && this.contextService.getWorkspace().folders.length > 0;
            this.workspaceSettings.tooltip = ((_a = (await this.preferencesService.getEditableSettingsURI(4 /* ConfigurationTarget.WORKSPACE */))) === null || _a === void 0 ? void 0 : _a.fsPath) || '';
        }
    };
    ...
    let SearchWidget = class SearchWidget extends widget_1.Widget {
        ...
        createInputBox(parent) {
            ...
            const box = this._register(new contextScopedHistoryWidget_1.ContextScopedHistoryInputBox(parent, this.contextViewService, Object.assign(Object.assign({}, this.options), { showHistoryHint }), this.contextKeyService));
