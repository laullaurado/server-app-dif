...
define(["require", "exports", "vs/workbench/contrib/terminal/common/terminalEnvironment", "vs/workbench/contrib/terminal/common/terminal", "vs/platform/log/common/log", "vs/base/common/event", "vs/workbench/services/history/common/history", "vs/platform/instantiation/common/instantiation", "vs/platform/workspace/common/workspace", "vs/workbench/services/configurationResolver/common/configurationResolver", "vs/base/common/network", "vs/platform/remote/common/remoteHosts", "vs/workbench/services/environment/common/environmentService", "vs/platform/product/common/productService", "vs/workbench/services/remote/common/remoteAgentService", "vs/base/common/lifecycle", "vs/base/common/types", "vs/workbench/contrib/terminal/browser/environmentVariableInfo", "vs/workbench/services/path/common/pathService", "vs/workbench/contrib/terminal/common/environmentVariable", "vs/platform/terminal/common/terminalRecorder", "vs/nls", "vs/workbench/contrib/terminal/common/terminalStrings", "vs/base/common/platform", "vs/platform/configuration/common/configuration", "vs/workbench/contrib/terminal/browser/terminal", "vs/platform/terminal/common/capabilities/terminalCapabilityStore", "vs/platform/terminal/common/capabilities/naiveCwdDetectionCapability", "vs/platform/telemetry/common/telemetry"], function (require, exports, terminalEnvironment, terminal_1, log_1, event_1, history_1, instantiation_1, workspace_1, configurationResolver_1, network_1, remoteHosts_1, environmentService_1, productService_1, remoteAgentService_1, lifecycle_1, types_1, environmentVariableInfo_1, pathService_1, environmentVariable_1, terminalRecorder_1, nls_1, terminalStrings_1, platform_1, configuration_1, terminal_2, terminalCapabilityStore_1, naiveCwdDetectionCapability_1, telemetry_1) {
    "use strict";
    ...
    let TerminalProcessManager = class TerminalProcessManager extends lifecycle_1.Disposable {
        ...
        async detachFromProcess() {
            var _a, _b;
            await ((_b = (_a = this._process) === null || _a === void 0 ? void 0 : _a.detach) === null || _b === void 0 ? void 0 : _b.call(_a));
            this._process = null;
        }
                ...
                if (!!this.remoteAuthority) {
                    ...
                    if (shellLaunchConfig.attachPersistentProcess) {
                        ...
                        try {
                            ...
                            if ((e === null || e === void 0 ? void 0 : e.message) === 'Could not fetch remote environment') {
                ...
                newProcess.onDidChangeProperty(({ type, value }) => {
                    ...
                    switch (type) {
                        ...
                        case "failedShellIntegrationActivation" /* ProcessPropertyType.FailedShellIntegrationActivation */:
                            (_a = this._telemetryService) === null || _a === void 0 ? void 0 : _a.publicLog2('terminal/shellIntegrationActivationFailureCustomArgs');
                            break;
                    }
        ...
        async setUnicodeVersion(version) {
            var _a;
            return (_a = this._process) === null || _a === void 0 ? void 0 : _a.setUnicodeVersion(version);
        }
        _resize(cols, rows) {
            if (!this._process) {
                return;
        ...
        async updateProperty(type, value) {
            var _a;
            return (_a = this._process) === null || _a === void 0 ? void 0 : _a.updateProperty(type, value);
        }
    ...
    TerminalProcessManager = __decorate([
        ...
        __param(13, terminal_1.ITerminalProfileResolverService),
        __param(14, configuration_1.IConfigurationService),
        __param(15, terminal_2.ITerminalInstanceService),
