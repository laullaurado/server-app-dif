    ...
    let MainThreadProgress = class MainThreadProgress {
        ...
        async $startProgress(handle, options, extensionId) {
            ...
            if (options.location === 15 /* ProgressLocation.Notification */ && extensionId) {
                const notificationOptions = Object.assign(Object.assign({}, options), { location: 15 /* ProgressLocation.Notification */, secondaryActions: [new ManageExtensionAction(extensionId, (0, nls_1.localize)('manageExtension', "Manage Extension"), this._commandService)] });
