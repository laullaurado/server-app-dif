...
define(["require", "exports", "vs/nls", "vs/base/browser/dom", "vs/platform/list/browser/listService", "vs/platform/instantiation/common/instantiation", "vs/workbench/common/theme", "vs/platform/theme/common/themeService", "vs/platform/theme/common/colorRegistry", "vs/workbench/browser/parts/notifications/notificationsViewer", "vs/workbench/browser/parts/notifications/notificationsActions", "vs/platform/contextview/browser/contextView", "vs/base/common/types", "vs/base/common/codicons", "vs/workbench/common/contextkeys", "vs/css!./media/notificationsList"], function (require, exports, nls_1, dom_1, listService_1, instantiation_1, theme_1, themeService_1, colorRegistry_1, notificationsViewer_1, notificationsActions_1, contextView_1, types_1, codicons_1, contextkeys_1) {
    "use strict";
    ...
    let NotificationsList = class NotificationsList extends themeService_1.Themable {
        ...
        show(focus) {
            if (this.isVisible) {
                if (focus) {
                    const list = (0, types_1.assertIsDefined)(this.list);
                    list.domFocus();
                }
        ...
        createNotificationsList() {
            ...
            const list = this.list = this._register(this.instantiationService.createInstance(listService_1.WorkbenchList, 'NotificationsList', this.listContainer, listDelegate, [renderer], Object.assign(Object.assign({}, options), { setRowLineHeight: false, horizontalScrolling: false, overrideStyles: {
                    listBackground: theme_1.NOTIFICATIONS_BACKGROUND
                }, accessibilityProvider: {
                    getAriaLabel(element) {
                        if (!element.source) {
                            return (0, nls_1.localize)('notificationAriaLabel', "{0}, notification", element.message.raw);
                        }
                        return (0, nls_1.localize)('notificationWithSourceAriaLabel', "{0}, source: {1}, notification", element.message.raw, element.source);
                    },
                    getWidgetAriaLabel() {
                        var _a;
                        return (_a = options.widgetAriaLabel) !== null && _a !== void 0 ? _a : (0, nls_1.localize)('notificationsList', "Notifications List");
                    },
                    getRole() {
    ...
    (0, themeService_1.registerThemingParticipant)((theme, collector) => {
        ...
        if (notificationErrorIconForegroundColor) {
            collector.addRule(`
		.monaco-workbench .notifications-center ${codicons_1.Codicon.error.cssSelector},
		.monaco-workbench .notifications-toasts ${codicons_1.Codicon.error.cssSelector} {
        ...
        if (notificationWarningIconForegroundColor) {
            collector.addRule(`
		.monaco-workbench .notifications-center ${codicons_1.Codicon.warning.cssSelector},
		.monaco-workbench .notifications-toasts ${codicons_1.Codicon.warning.cssSelector} {
        ...
        if (notificationInfoIconForegroundColor) {
            collector.addRule(`
		.monaco-workbench .notifications-center ${codicons_1.Codicon.info.cssSelector},
		.monaco-workbench .notifications-toasts ${codicons_1.Codicon.info.cssSelector} {
