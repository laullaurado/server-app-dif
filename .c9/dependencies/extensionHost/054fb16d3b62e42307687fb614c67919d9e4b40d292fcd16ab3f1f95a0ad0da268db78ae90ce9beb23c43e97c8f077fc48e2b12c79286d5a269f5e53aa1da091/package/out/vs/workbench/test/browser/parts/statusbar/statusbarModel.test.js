 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/workbench/browser/parts/statusbar/statusbarModel", "vs/workbench/test/common/workbenchTestServices"], function (require, exports, assert, statusbarModel_1, workbenchTestServices_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    suite('Workbench status bar model', () => {
        test('basics', () => {
            const container = document.createElement('div');
            const model = new statusbarModel_1.StatusbarViewModel(new workbenchTestServices_1.TestStorageService());
