...
define(["require", "exports", "vs/workbench/common/editor/editorModel", "vs/editor/common/languages/language", "vs/editor/common/services/model", "vs/base/common/lifecycle", "vs/editor/common/languages/modesRegistry", "vs/base/common/types", "vs/workbench/services/languageDetection/common/languageDetectionWorkerService", "vs/base/common/async", "vs/platform/accessibility/common/accessibility", "vs/nls"], function (require, exports, editorModel_1, language_1, model_1, lifecycle_1, modesRegistry_1, types_1, languageDetectionWorkerService_1, async_1, accessibility_1, nls_1) {
    "use strict";
    ...
    let BaseTextEditorModel = class BaseTextEditorModel extends editorModel_1.EditorModel {
        constructor(modelService, languageService, languageDetectionService, accessibilityService, textEditorModelHandle) {
            ...
            this.autoDetectLanguageThrottler = this._register(new async_1.ThrottledDelayer(BaseTextEditorModel.AUTO_DETECT_LANGUAGE_THROTTLE_DELAY));
        ...
        getLanguageId() {
            var _a;
            return (_a = this.textEditorModel) === null || _a === void 0 ? void 0 : _a.getLanguageId();
        }
        autoDetectLanguage() {
        ...
        async doAutoDetectLanguage() {
            ...
            if (this.hasLanguageSetExplicitly || // skip detection when the user has made an explicit choice on the language
                ...
                !this.languageDetectionService.isEnabledForLanguage((_a = this.getLanguageId()) !== null && _a !== void 0 ? _a : modesRegistry_1.PLAINTEXT_LANGUAGE_ID) // require a valid language that is enlisted for detection
            ) {
                return;
            }
            ...
            if (lang && !this.isDisposed()) {
                ...
                if (languageName) {
                    this.accessibilityService.alert((0, nls_1.localize)('languageAutoDetected', "Language {0} was automatically detected and set as the language mode.", languageName));
                }
            }
        }
        /**
        ...
        getOrCreateLanguage(resource, languageService, preferredLanguage, firstLineText) {
            ...
            if (!preferredLanguage || preferredLanguage === modesRegistry_1.PLAINTEXT_LANGUAGE_ID) {
                return languageService.createByFilepathOrFirstLine((0, types_1.withUndefinedAsNull)(resource), firstLineText);
            }
