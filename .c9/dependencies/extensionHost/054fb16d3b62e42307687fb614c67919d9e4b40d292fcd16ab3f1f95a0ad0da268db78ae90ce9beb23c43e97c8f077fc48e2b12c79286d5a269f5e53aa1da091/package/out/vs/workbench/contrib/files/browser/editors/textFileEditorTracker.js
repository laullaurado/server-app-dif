    ...
    let TextFileEditorTracker = class TextFileEditorTracker extends lifecycle_2.Disposable {
        ...
        ensureDirtyTextFilesAreOpened(resources) {
            this.doEnsureDirtyTextFilesAreOpened((0, arrays_1.distinct)(resources.filter(resource => {
                ...
                if (fileModel === null || fileModel === void 0 ? void 0 : fileModel.hasState(2 /* TextFileEditorModelState.PENDING_SAVE */)) {
                    return false; // resource must not be pending to save
                }
                if (this.filesConfigurationService.getAutoSaveMode() === 1 /* AutoSaveMode.AFTER_SHORT_DELAY */ && !(fileModel === null || fileModel === void 0 ? void 0 : fileModel.hasState(5 /* TextFileEditorModelState.ERROR */))) {
                ...
                const model = fileModel !== null && fileModel !== void 0 ? fileModel : this.textFileService.untitled.get(resource);
