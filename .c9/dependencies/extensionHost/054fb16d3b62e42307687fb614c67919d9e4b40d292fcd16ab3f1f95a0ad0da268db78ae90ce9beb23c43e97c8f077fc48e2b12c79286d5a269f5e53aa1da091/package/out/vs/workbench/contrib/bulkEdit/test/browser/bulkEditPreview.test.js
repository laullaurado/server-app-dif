 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/base/common/event", "vs/platform/files/common/files", "vs/workbench/test/common/workbenchTestServices", "vs/platform/instantiation/common/instantiationService", "vs/platform/instantiation/common/serviceCollection", "vs/editor/common/services/model", "vs/base/common/uri", "vs/workbench/contrib/bulkEdit/browser/preview/bulkEditPreview", "vs/editor/common/core/range", "vs/editor/browser/services/bulkEditService"], function (require, exports, assert, event_1, files_1, workbenchTestServices_1, instantiationService_1, serviceCollection_1, model_1, uri_1, bulkEditPreview_1, range_1, bulkEditService_1) {
    "use strict";
