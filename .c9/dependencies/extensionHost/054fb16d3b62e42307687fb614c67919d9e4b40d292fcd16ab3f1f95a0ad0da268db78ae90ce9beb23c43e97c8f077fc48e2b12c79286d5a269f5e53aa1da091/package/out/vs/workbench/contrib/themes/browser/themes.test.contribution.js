...
define(["require", "exports", "vs/base/common/uri", "vs/editor/common/languages/language", "vs/platform/commands/common/commands", "vs/platform/instantiation/common/instantiation", "vs/workbench/services/themes/common/workbenchThemeService", "vs/workbench/services/editor/common/editorService", "vs/workbench/common/editor", "vs/workbench/services/textMate/browser/textMate", "vs/editor/common/languages", "vs/editor/common/encodedTokenAttributes", "vs/workbench/services/textMate/common/TMHelper", "vs/base/common/color", "vs/platform/files/common/files", "vs/base/common/resources", "vs/base/common/network", "vs/base/common/strings"], function (require, exports, uri_1, language_1, commands_1, instantiation_1, workbenchThemeService_1, editorService_1, editor_1, textMate_1, languages_1, encodedTokenAttributes_1, TMHelper_1, color_1, files_1, resources_1, network_1, strings_1) {
    "use strict";
    ...
    let Snapper = class Snapper {
        ...
        _themedTokenize(grammar, lines) {
            let colorMap = languages_1.TokenizationRegistry.getColorMap();
            let state = null;
            ...
            for (let i = 0, len = lines.length; i < len; i++) {
                ...
                for (let j = 0, lenJ = tokenizationResult.tokens.length >>> 1; j < lenJ; j++) {
                    ...
                    let color = encodedTokenAttributes_1.TokenMetadata.getForeground(metadata);
                    result[resultLen++] = {
                        text: tokenText,
        ...
        captureSyntaxTokens(fileName, content) {
            ...
            return this.textMateService.createGrammar(languageId).then((grammar) => {
                ...
                let lines = (0, strings_1.splitLines)(content);
    ...
    Snapper = __decorate([
        ...
        __param(2, textMate_1.ITextMateService)
    ], Snapper);
    commands_1.CommandsRegistry.registerCommand('_workbench.captureSyntaxTokens', function (accessor, resource) {
        let process = (resource) => {
            ...
            let fileName = (0, resources_1.basename)(resource);
