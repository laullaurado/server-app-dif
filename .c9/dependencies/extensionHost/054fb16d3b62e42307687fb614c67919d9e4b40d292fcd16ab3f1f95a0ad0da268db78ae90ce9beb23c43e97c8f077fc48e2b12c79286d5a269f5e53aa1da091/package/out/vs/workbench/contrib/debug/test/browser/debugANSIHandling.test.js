 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/base/common/uuid", "vs/workbench/contrib/debug/browser/debugANSIHandling", "vs/workbench/test/browser/workbenchTestServices", "vs/workbench/contrib/debug/browser/linkDetector", "vs/base/common/color", "vs/platform/theme/test/common/testThemeService", "vs/workbench/contrib/terminal/common/terminalColorRegistry", "vs/workbench/contrib/debug/test/browser/mockDebug", "vs/workbench/contrib/debug/test/browser/callStack.test", "vs/base/common/lifecycle"], function (require, exports, assert, uuid_1, debugANSIHandling_1, workbenchTestServices_1, linkDetector_1, color_1, testThemeService_1, terminalColorRegistry_1, mockDebug_1, callStack_test_1, lifecycle_1) {
    "use strict";
    ...
    suite('Debug - ANSI Handling', () => {
        ...
        setup(() => {
            ...
            session = (0, callStack_test_1.createMockSession)(model);
