...
define(["require", "exports", "vs/workbench/services/themes/common/colorThemeData", "assert", "vs/platform/theme/common/tokenClassificationRegistry", "vs/base/common/color", "vs/base/common/types", "vs/platform/files/common/fileService", "vs/platform/log/common/log", "vs/platform/files/node/diskFileSystemProvider", "vs/base/common/network", "vs/workbench/services/extensionResourceLoader/electron-sandbox/extensionResourceLoaderService", "vs/workbench/test/common/workbenchTestServices"], function (require, exports, colorThemeData_1, assert, tokenClassificationRegistry_1, color_1, types_1, fileService_1, log_1, diskFileSystemProvider_1, network_1, extensionResourceLoaderService_1, workbenchTestServices_1) {
    ...
    function ts(foreground, styleFlags) {
        ...
        return new tokenClassificationRegistry_1.TokenStyle(foregroundColor, styleFlags === null || styleFlags === void 0 ? void 0 : styleFlags.bold, styleFlags === null || styleFlags === void 0 ? void 0 : styleFlags.underline, styleFlags === null || styleFlags === void 0 ? void 0 : styleFlags.strikethrough, styleFlags === null || styleFlags === void 0 ? void 0 : styleFlags.italic);
    }
    ...
    suite('Themes - TokenStyleResolving', () => {
        ...
        test('color defaults', async () => {
            ...
            themeData.location = network_1.FileAccess.asFileUri('./color-theme.json', require);
