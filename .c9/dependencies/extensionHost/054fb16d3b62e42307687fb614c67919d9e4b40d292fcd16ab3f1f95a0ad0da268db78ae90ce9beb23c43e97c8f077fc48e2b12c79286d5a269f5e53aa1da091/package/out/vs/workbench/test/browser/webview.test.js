 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/workbench/browser/webview"], function (require, exports, assert, webview_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    suite('parentOriginHash', () => {
        test('localhost 1', async () => {
            const hash = await (0, webview_1.parentOriginHash)('http://localhost:9888', '123456');
            assert.strictEqual(hash, '0fnsiac2jaup1t266qekgr7iuj4pnm31gf8r0h1o6k2lvvmfh6hk');
        });
        test('localhost 2', async () => {
            const hash = await (0, webview_1.parentOriginHash)('http://localhost:9888', '123457');
            assert.strictEqual(hash, '07shf01bmdfrghk96voldpletbh36vj7blnl4td8kdq1sej5kjqs');
        });
        test('localhost 3', async () => {
            const hash = await (0, webview_1.parentOriginHash)('http://localhost:9887', '123456');
