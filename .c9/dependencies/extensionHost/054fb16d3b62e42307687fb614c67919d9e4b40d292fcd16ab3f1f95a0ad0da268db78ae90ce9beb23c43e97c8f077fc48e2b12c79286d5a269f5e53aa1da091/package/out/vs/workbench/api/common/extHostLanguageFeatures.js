...
define(["require", "exports", "vs/base/common/uri", "vs/base/common/objects", "vs/workbench/api/common/extHostTypeConverters", "vs/workbench/api/common/extHostTypes", "vs/editor/common/languages", "./extHost.protocol", "vs/base/common/strings", "vs/editor/common/core/range", "vs/base/common/arrays", "vs/base/common/types", "vs/editor/common/core/selection", "vs/base/common/cancellation", "vs/base/common/lifecycle", "vs/editor/common/services/semanticTokensDto", "vs/base/common/idGenerator", "./cache", "vs/base/common/stopwatch", "vs/base/common/errors", "vs/base/common/async", "vs/workbench/services/extensions/common/extensions"], function (require, exports, uri_1, objects_1, typeConvert, extHostTypes_1, languages, extHostProtocol, strings_1, range_1, arrays_1, types_1, selection_1, cancellation_1, lifecycle_1, semanticTokensDto_1, idGenerator_1, cache_1, stopwatch_1, errors_1, async_1, extensions_1) {
    ...
    class DocumentPasteEditProvider {
        ...
        async prepareDocumentPaste(resource, range, dataTransferDto, token) {
        ...
        async providePasteEdits(requestId, resource, range, dataTransferDto, token) {
            const doc = this._documents.getDocument(resource);
            const vscodeRange = typeConvert.Range.to(range);
            ...
            if (edit instanceof extHostTypes_1.WorkspaceEdit) {
    ...
    class InlineCompletionAdapter extends InlineCompletionAdapterBase {
        constructor(_extension, _documents, _provider, _commands) {
            ...
            this._isAdditionsProposedApiEnabled = (0, extensions_1.isProposedApiEnabled)(this._extension, 'inlineCompletionsAdditions');
        ...
        get supportsHandleDidShowCompletionItem() {
            return (0, extensions_1.isProposedApiEnabled)(this._extension, 'inlineCompletionsAdditions') && typeof this._provider.handleDidShowCompletionItem === 'function';
        }
        async provideInlineCompletions(resource, position, context, token) {
            const doc = this._documents.getDocument(resource);
            const pos = typeConvert.Position.to(position);
            ...
            const commands = this._isAdditionsProposedApiEnabled ? (0, types_1.isArray)(result) ? [] : result.commands || [] : [];
    ...
    class ExtHostLanguageFeatures {
        ...
        // --- copy/paste actions
        registerDocumentPasteEditProvider(extension, selector, provider) {
            const handle = this._nextHandle();
        ...
        $prepareDocumentPaste(handle, resource, range, dataTransfer, token) {
            return this._withAdapter(handle, DocumentPasteEditProvider, adapter => adapter.prepareDocumentPaste(uri_1.URI.revive(resource), range, dataTransfer, token), undefined, token);
        }
        $providePasteEdits(handle, resource, range, dataTransferDto, token) {
            return this._withAdapter(handle, DocumentPasteEditProvider, adapter => adapter.providePasteEdits(0, uri_1.URI.revive(resource), range, dataTransferDto, token), undefined, token);
        }
        // --- configuration
