...
define(["require", "exports", "assert", "vs/workbench/test/browser/workbenchTestServices", "vs/workbench/services/editor/common/editorGroupsService", "vs/workbench/common/editor", "vs/base/common/uri", "vs/platform/instantiation/common/descriptors", "vs/base/common/lifecycle", "vs/platform/keybinding/test/common/mockKeybindingService", "vs/platform/configuration/test/common/testConfigurationService", "vs/platform/configuration/common/configuration", "vs/workbench/common/editor/sideBySideEditorInput"], function (require, exports, assert, workbenchTestServices_1, editorGroupsService_1, editor_1, uri_1, descriptors_1, lifecycle_1, mockKeybindingService_1, testConfigurationService_1, configuration_1, sideBySideEditorInput_1) {
    ...
    suite('EditorGroupsService', () => {
        ...
        test('sideGroup', async () => {
            ...
            let input1 = new workbenchTestServices_1.TestFileEditorInput(uri_1.URI.file('foo/bar1'), TEST_EDITOR_INPUT_ID);
            let input2 = new workbenchTestServices_1.TestFileEditorInput(uri_1.URI.file('foo/bar2'), TEST_EDITOR_INPUT_ID);
            let input3 = new workbenchTestServices_1.TestFileEditorInput(uri_1.URI.file('foo/bar3'), TEST_EDITOR_INPUT_ID);
        ...
        test('copy/merge groups', async () => {
            ...
            const rightGroup = part.addGroup(rootGroup, 3 /* GroupDirection.RIGHT */, { activate: true });
        ...
        test('find editors (side by side support)', async () => {
            ...
            const group = part.activeGroup;
            assert.strictEqual(group.isEmpty, true);
            const secondaryInput = new workbenchTestServices_1.TestFileEditorInput(uri_1.URI.file('foo/bar-secondary'), TEST_EDITOR_INPUT_ID);
            const primaryInput = new workbenchTestServices_1.TestFileEditorInput(uri_1.URI.file('foo/bar-primary'), `${TEST_EDITOR_INPUT_ID}-1`);
        ...
        test('onWillOpenEditor', async () => {
            ...
            const rightGroup = part.addGroup(group, 3 /* GroupDirection.RIGHT */);
            const input = new workbenchTestServices_1.TestFileEditorInput(uri_1.URI.file('foo/bar'), TEST_EDITOR_INPUT_ID);
            const secondInput = new workbenchTestServices_1.TestFileEditorInput(uri_1.URI.file('foo/bar/second'), TEST_EDITOR_INPUT_ID);
            const thirdInput = new workbenchTestServices_1.TestFileEditorInput(uri_1.URI.file('foo/bar/third'), TEST_EDITOR_INPUT_ID);
            let leftFiredCount = 0;
        ...
        test('locked groups - auto locking via setting', async () => {
            ...
            input1 = new workbenchTestServices_1.TestFileEditorInput(uri_1.URI.file('foo/bar1'), TEST_EDITOR_INPUT_ID);
            input2 = new workbenchTestServices_1.TestFileEditorInput(uri_1.URI.file('foo/bar2'), TEST_EDITOR_INPUT_ID);
            await rootGroup.openEditor(input1, { pinned: true });
