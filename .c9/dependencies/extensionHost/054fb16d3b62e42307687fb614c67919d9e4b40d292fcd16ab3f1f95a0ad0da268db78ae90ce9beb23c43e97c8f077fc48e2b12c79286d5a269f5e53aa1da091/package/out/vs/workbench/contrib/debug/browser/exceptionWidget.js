...
define(["require", "exports", "vs/nls", "vs/base/browser/dom", "vs/editor/contrib/zoneWidget/browser/zoneWidget", "vs/workbench/contrib/debug/common/debug", "vs/base/common/async", "vs/platform/theme/common/themeService", "vs/platform/theme/common/colorRegistry", "vs/platform/instantiation/common/instantiation", "vs/workbench/contrib/debug/browser/linkDetector", "vs/base/browser/ui/actionbar/actionbar", "vs/base/common/actions", "vs/platform/theme/common/iconRegistry", "vs/css!./media/exceptionWidget"], function (require, exports, nls, dom, zoneWidget_1, debug_1, async_1, themeService_1, colorRegistry_1, instantiation_1, linkDetector_1, actionbar_1, actions_1, iconRegistry_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.ExceptionWidget = exports.debugExceptionWidgetBackground = exports.debugExceptionWidgetBorder = void 0;
    const $ = dom.$;
    // theming
    exports.debugExceptionWidgetBorder = (0, colorRegistry_1.registerColor)('debugExceptionWidget.border', { dark: '#a31515', light: '#a31515', hcDark: '#a31515', hcLight: '#a31515' }, nls.localize('debugExceptionWidgetBorder', 'Exception widget border color.'));
    exports.debugExceptionWidgetBackground = (0, colorRegistry_1.registerColor)('debugExceptionWidget.background', { dark: '#420b0d', light: '#f1dfde', hcDark: '#420b0d', hcLight: '#f1dfde' }, nls.localize('debugExceptionWidgetBackground', 'Exception widget background color.'));
    let ExceptionWidget = class ExceptionWidget extends zoneWidget_1.ZoneWidget {
        ...
        _fillContainer(container) {
            ...
            actionBar.push(new actions_1.Action('editor.closeExceptionWidget', nls.localize('close', "Close"), themeService_1.ThemeIcon.asClassName(iconRegistry_1.widgetClose), true, async () => {
