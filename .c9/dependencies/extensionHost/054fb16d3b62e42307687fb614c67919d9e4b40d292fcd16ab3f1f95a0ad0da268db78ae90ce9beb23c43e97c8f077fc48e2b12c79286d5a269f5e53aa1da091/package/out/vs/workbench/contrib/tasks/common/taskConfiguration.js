...
define(["require", "exports", "vs/nls", "vs/base/common/objects", "vs/base/common/types", "vs/base/common/uuid", "vs/workbench/contrib/tasks/common/problemMatcher", "./tasks", "./taskDefinitionRegistry", "vs/workbench/contrib/tasks/common/taskService"], function (require, exports, nls, Objects, Types, UUID, problemMatcher_1, Tasks, taskDefinitionRegistry_1, taskService_1) {
    ...
    exports.createCustomTask = exports.parse = exports.TaskConfigSource = exports.UUIDMap = exports.JsonSchemaVersion = exports.ExecutionEngine = exports.TaskParser = exports.GroupKind = exports.ProblemMatcherConverter = exports.RunOptions = exports.RunOnOptions = exports.CommandString = exports.TaskIdentifier = exports.ShellQuoting = void 0;
    var ShellQuoting;
    ...
    })(ProblemMatcherConverter = exports.ProblemMatcherConverter || (exports.ProblemMatcherConverter = {}));
    const partialSource = {
        label: 'Workspace',
        config: undefined
    };
    ...
    (function (GroupKind) {
        function from(external) {
            if (external === undefined) {
                ...
                let isDefault = Types.isUndefined(external.isDefault) ? false : external.isDefault;
        ...
        GroupKind.to = to;
    })(GroupKind = exports.GroupKind || (exports.GroupKind = {}));
    var TaskDependency;
    ...
    (function (ConfiguringTask) {
        ...
        function from(external, context, index, source, registry) {
            ...
            let typeDeclaration = type ? ((_a = registry === null || registry === void 0 ? void 0 : registry.get) === null || _a === void 0 ? void 0 : _a.call(registry, type)) || taskDefinitionRegistry_1.TaskDefinitionRegistry.get(type) : undefined;
            if (!typeDeclaration) {
    ...
    (function (CustomTask) {
        ...
        function createCustomTask(contributedTask, configuredProps) {
            let result = new Tasks.CustomTask(configuredProps._id, Object.assign({}, configuredProps._source, { customizes: contributedTask.defines }), configuredProps.configurationProperties.name || contributedTask._label, Tasks.CUSTOMIZED_TASK_TYPE, contributedTask.command, false, contributedTask.runOptions, {
    ...
    (function (TaskParser) {
        ...
        function from(externals, globals, context, source, registry) {
            ...
            let schema2_0_0 = context.schemaVersion === 2 /* Tasks.JsonSchemaVersion.V2_0_0 */;
            const baseLoadIssues = Objects.deepClone(context.taskLoadIssues);
            for (let index = 0; index < externals.length; index++) {
                let external = externals[index];
                const definition = external.type ? ((_a = registry === null || registry === void 0 ? void 0 : registry.get) === null || _a === void 0 ? void 0 : _a.call(registry, external.type)) || taskDefinitionRegistry_1.TaskDefinitionRegistry.get(external.type) : undefined;
            ...
            const defaultBuildGroupName = Types.isString((_b = defaultBuildTask.task) === null || _b === void 0 ? void 0 : _b.configurationProperties.group) ? (_c = defaultBuildTask.task) === null || _c === void 0 ? void 0 : _c.configurationProperties.group : (_e = (_d = defaultBuildTask.task) === null || _d === void 0 ? void 0 : _d.configurationProperties.group) === null || _e === void 0 ? void 0 : _e._id;
            const defaultTestTaskGroupName = Types.isString((_f = defaultTestTask.task) === null || _f === void 0 ? void 0 : _f.configurationProperties.group) ? (_g = defaultTestTask.task) === null || _g === void 0 ? void 0 : _g.configurationProperties.group : (_j = (_h = defaultTestTask.task) === null || _h === void 0 ? void 0 : _h.configurationProperties.group) === null || _j === void 0 ? void 0 : _j._id;
    ...
    })(TaskParser = exports.TaskParser || (exports.TaskParser = {}));
    var Globals;
    (function (Globals) {
        function from(config, context) {
            let result = fromBase(config, context);
    ...
    class ConfigurationParser {
        ...
        createTaskRunnerConfiguration(fileConfig, context, source) {
            ...
            if ((!result.custom || result.custom.length === 0) && (globals.command && globals.command.name)) {
                const matchers = (_a = ProblemMatcherConverter.from(fileConfig.problemMatcher, context).value) !== null && _a !== void 0 ? _a : [];
                ...
                let task = new Tasks.CustomTask(context.uuidMap.getUUID(name), Object.assign({}, source, { config: { index: -1, element: fileConfig, workspaceFolder: context.workspaceFolder } }), name, Tasks.CUSTOMIZED_TASK_TYPE, {
                    name: undefined,
                    runtime: undefined,
                    presentation: undefined,
