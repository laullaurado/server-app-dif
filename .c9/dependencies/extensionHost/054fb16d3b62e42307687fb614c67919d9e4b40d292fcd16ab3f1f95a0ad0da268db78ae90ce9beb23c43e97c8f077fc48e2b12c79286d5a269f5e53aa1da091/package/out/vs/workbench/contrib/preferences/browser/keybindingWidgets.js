...
define(["require", "exports", "vs/nls", "vs/base/common/platform", "vs/base/common/lifecycle", "vs/base/common/event", "vs/base/browser/ui/keybindingLabel/keybindingLabel", "vs/base/browser/ui/widget", "vs/base/browser/dom", "vs/base/browser/keyboardEvent", "vs/base/browser/fastDomNode", "vs/platform/keybinding/common/keybinding", "vs/platform/contextview/browser/contextView", "vs/platform/instantiation/common/instantiation", "vs/platform/theme/common/styler", "vs/platform/theme/common/themeService", "vs/platform/theme/common/colorRegistry", "vs/workbench/contrib/preferences/browser/preferencesWidgets", "vs/base/common/types", "vs/base/common/async", "vs/platform/contextkey/common/contextkey", "vs/css!./media/keybindings"], function (require, exports, nls, platform_1, lifecycle_1, event_1, keybindingLabel_1, widget_1, dom, keyboardEvent_1, fastDomNode_1, keybinding_1, contextView_1, instantiation_1, styler_1, themeService_1, colorRegistry_1, preferencesWidgets_1, types_1, async_1, contextkey_1) {
    ...
    let KeybindingsSearchWidget = class KeybindingsSearchWidget extends preferencesWidgets_1.SearchWidget {
        constructor(parent, options, contextViewService, instantiationService, themeService, contextKeyService, keybindingService) {
            ...
            this._register((0, styler_1.attachInputBoxStyler)(this.inputBox, themeService));
    ...
    let DefineKeybindingWidget = class DefineKeybindingWidget extends widget_1.Widget {
        constructor(parent, instantiationService, themeService) {
            ...
            this.keybindingLabelStylers = this.disposables.add(new lifecycle_1.DisposableStore());
            ...
            this._register((0, styler_1.attachStylerCallback)(this.themeService, { editorWidgetBackground: colorRegistry_1.editorWidgetBackground, editorWidgetForeground: colorRegistry_1.editorWidgetForeground, widgetShadow: colorRegistry_1.widgetShadow }, colors => {
        ...
        onKeybinding(keybinding) {
            ...
            const firstLabel = new keybindingLabel_1.KeybindingLabel(this._outputNode, platform_1.OS);
            firstLabel.set((0, types_1.withNullAsUndefined)(this._firstPart));
            this.keybindingLabelStylers.add((0, styler_1.attachKeybindingLabelStyler)(firstLabel, this.themeService));
            if (this._chordPart) {
                this._outputNode.appendChild(document.createTextNode(nls.localize('defineKeybinding.chordsTo', "chord to")));
                const chordLabel = new keybindingLabel_1.KeybindingLabel(this._outputNode, platform_1.OS);
                chordLabel.set(this._chordPart);
                this.keybindingLabelStylers.add((0, styler_1.attachKeybindingLabelStyler)(chordLabel, this.themeService));
            }
