...
define(["require", "exports", "vs/base/browser/dom", "vs/base/browser/ui/actionbar/actionbar", "vs/base/browser/ui/countBadge/countBadge", "vs/base/common/lifecycle", "vs/base/common/path", "vs/nls", "vs/platform/configuration/common/configuration", "vs/platform/files/common/files", "vs/platform/instantiation/common/instantiation", "vs/platform/label/common/label", "vs/platform/theme/common/styler", "vs/platform/theme/common/themeService", "vs/platform/workspace/common/workspace", "vs/workbench/contrib/search/browser/searchActions", "vs/workbench/contrib/search/common/searchModel", "vs/base/common/resources"], function (require, exports, DOM, actionbar_1, countBadge_1, lifecycle_1, paths, nls, configuration_1, files_1, instantiation_1, label_1, styler_1, themeService_1, workspace_1, searchActions_1, searchModel_1, resources_1) {
    ...
    let FolderMatchRenderer = class FolderMatchRenderer extends lifecycle_1.Disposable {
        ...
        renderElement(node, index, templateData) {
            ...
            actions.push(this.instantiationService.createInstance(searchActions_1.RemoveAction, this.searchView.getControl(), folderMatch));
    ...
    let FileMatchRenderer = class FileMatchRenderer extends lifecycle_1.Disposable {
        ...
        renderElement(node, index, templateData) {
            ...
            actions.push(this.instantiationService.createInstance(searchActions_1.RemoveAction, this.searchView.getControl(), fileMatch));
            templateData.actions.push(actions, { icon: true, label: false });
        }
        disposeElement(element, index, templateData) {
        }
    ...
    let MatchRenderer = class MatchRenderer extends lifecycle_1.Disposable {
        ...
        renderElement(node, index, templateData) {
            ...
            if (this.searchModel.isReplaceActive()) {
                templateData.actions.push([this.instantiationService.createInstance(searchActions_1.ReplaceAction, this.searchView.getControl(), match, this.searchView), this.instantiationService.createInstance(searchActions_1.RemoveAction, this.searchView.getControl(), match)], { icon: true, label: false });
            }
            else {
                templateData.actions.push([this.instantiationService.createInstance(searchActions_1.RemoveAction, this.searchView.getControl(), match)], { icon: true, label: false });
            }
        }
        disposeElement(element, index, templateData) {
        }
