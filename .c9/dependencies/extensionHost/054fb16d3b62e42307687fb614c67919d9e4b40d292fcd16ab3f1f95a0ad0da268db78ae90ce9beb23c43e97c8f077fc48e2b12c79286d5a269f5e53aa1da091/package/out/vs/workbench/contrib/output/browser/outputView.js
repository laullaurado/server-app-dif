...
define(["require", "exports", "vs/nls", "vs/platform/telemetry/common/telemetry", "vs/platform/storage/common/storage", "vs/editor/common/services/textResourceConfiguration", "vs/platform/instantiation/common/instantiation", "vs/platform/contextkey/common/contextkey", "vs/workbench/browser/parts/editor/textResourceEditor", "vs/workbench/services/output/common/output", "vs/platform/theme/common/themeService", "vs/platform/configuration/common/configuration", "vs/workbench/services/editor/common/editorGroupsService", "vs/workbench/services/editor/common/editorService", "vs/workbench/browser/parts/views/viewPane", "vs/platform/keybinding/common/keybinding", "vs/platform/contextview/browser/contextView", "vs/workbench/common/views", "vs/workbench/common/editor/textResourceEditorInput", "vs/platform/opener/common/opener", "vs/platform/registry/common/platform", "vs/platform/theme/common/styler", "vs/base/common/arrays", "vs/workbench/common/theme", "vs/platform/theme/common/colorRegistry", "vs/base/browser/ui/actionbar/actionViewItems", "vs/base/browser/dom", "vs/base/common/async"], function (require, exports, nls, telemetry_1, storage_1, textResourceConfiguration_1, instantiation_1, contextkey_1, textResourceEditor_1, output_1, themeService_1, configuration_1, editorGroupsService_1, editorService_1, viewPane_1, keybinding_1, contextView_1, views_1, textResourceEditorInput_1, opener_1, platform_1, styler_1, arrays_1, theme_1, colorRegistry_1, actionViewItems_1, dom_1, async_1) {
    ...
    let OutputEditor = class OutputEditor extends textResourceEditor_1.AbstractTextResourceEditor {
        constructor(telemetryService, instantiationService, storageService, configurationService, textResourceConfigurationService, themeService, outputService, editorGroupService, editorService) {
    ...
    let SwitchOutputActionViewItem = class SwitchOutputActionViewItem extends actionViewItems_1.SelectActionViewItem {
        ...
        render(container) {
            ...
            this._register((0, styler_1.attachStylerCallback)(this.themeService, { selectBorder: colorRegistry_1.selectBorder }, colors => {
        ...
        updateOptions() {
            const groups = (0, arrays_1.groupBy)(this.outputService.getChannelDescriptors(), (c1, c2) => {
                if (!c1.log && c2.log) {
                    return -1;
                }
                if (c1.log && !c2.log) {
