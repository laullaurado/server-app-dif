...
define(["require", "exports", "vs/nls", "vs/base/common/async", "vs/base/common/htmlContent", "vs/base/common/keyCodes", "vs/base/common/keybindings", "vs/base/common/lifecycle", "vs/platform/keybinding/common/keybinding", "vs/platform/instantiation/common/instantiation", "vs/platform/contextkey/common/contextkey", "vs/editor/common/core/range", "vs/editor/browser/editorExtensions", "vs/editor/contrib/snippet/browser/snippetController2", "vs/workbench/contrib/preferences/common/smartSnippetInserter", "vs/workbench/contrib/preferences/browser/keybindingWidgets", "vs/workbench/browser/codeeditor", "vs/base/common/json", "vs/editor/common/editorContextKeys", "vs/workbench/services/keybinding/common/windowsKeyboardMapper", "vs/platform/theme/common/themeService", "vs/editor/common/core/editorColorRegistry", "vs/editor/common/model", "vs/base/common/keybindingParser", "vs/base/common/arrays", "vs/base/common/types", "vs/platform/environment/common/environment", "vs/base/common/resources"], function (require, exports, nls, async_1, htmlContent_1, keyCodes_1, keybindings_1, lifecycle_1, keybinding_1, instantiation_1, contextkey_1, range_1, editorExtensions_1, snippetController2_1, smartSnippetInserter_1, keybindingWidgets_1, codeeditor_1, json_1, editorContextKeys_1, windowsKeyboardMapper_1, themeService_1, editorColorRegistry_1, model_1, keybindingParser_1, arrays_1, types_1, environment_1, resources_1) {
    "use strict";
    ...
    let KeybindingWidgetRenderer = class KeybindingWidgetRenderer extends lifecycle_1.Disposable {
        constructor(_editor, _instantiationService) {
            ...
            this._editor = _editor;
            this._instantiationService = _instantiationService;
            this._launchWidget = this._register(this._instantiationService.createInstance(codeeditor_1.FloatingClickWidget, this._editor, NLS_LAUNCH_MESSAGE, DefineKeybindingCommand.ID));
        ...
        _onAccepted(keybinding) {
            ...
            if (keybinding && this._editor.hasModel()) {
                ...
                (_a = snippetController2_1.SnippetController2.get(this._editor)) === null || _a === void 0 ? void 0 : _a.insert(snippetText, { overwriteBefore: 0, overwriteAfter: 0 });
            }
        }
    };
    ...
    let KeybindingEditorDecorationsRenderer = class KeybindingEditorDecorationsRenderer extends lifecycle_1.Disposable {
        ...
        static _userSettingsFuzzyEquals(a, b) {
            ...
            return (0, arrays_1.equals)(aParts, bParts, (a, b) => this._userBindingEquals(a, b));
        }
        static _userBindingEquals(a, b) {
            ...
            if (a instanceof keybindings_1.SimpleKeybinding && b instanceof keybindings_1.SimpleKeybinding) {
                return a.equals(b);
            }
            if (a instanceof keybindings_1.ScanCodeBinding && b instanceof keybindings_1.ScanCodeBinding) {
                return a.equals(b);
            }
            return false;
        }
    ...
    class DefineKeybindingCommand extends editorExtensions_1.EditorCommand {
        ...
        runEditorCommand(accessor, editor) {
            if (!isInterestingEditorModel(editor, accessor.get(environment_1.IEnvironmentService)) || editor.getOption(82 /* EditorOption.readOnly */)) {
                return;
            }
    ...
    function isInterestingEditorModel(editor, environmentService) {
        ...
        return (0, resources_1.isEqual)(model.uri, environmentService.keybindingsResource);
    }
    (0, editorExtensions_1.registerEditorContribution)(DefineKeybindingController.ID, DefineKeybindingController);
    (0, editorExtensions_1.registerEditorCommand)(new DefineKeybindingCommand());
});
