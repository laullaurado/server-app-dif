 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/nls", "./extHostTypes", "vs/base/common/resources", "vs/base/common/uri", "vs/base/common/event", "vs/base/common/lifecycle", "vs/base/common/async", "vs/workbench/api/common/extHostTypes", "vs/base/common/types", "vs/base/common/arrays", "vs/workbench/api/common/extHostTypeConverters", "vs/base/common/cancellation", "vs/workbench/services/views/common/treeViewsService", "vs/workbench/services/extensions/common/extensions"], function (require, exports, nls_1, types, resources_1, uri_1, event_1, lifecycle_1, async_1, extHostTypes_1, types_1, arrays_1, extHostTypeConverters_1, cancellation_1, treeViewsService_1, extensions_1) {
    "use strict";
    ...
    class ExtHostTreeViews {
        constructor(_proxy, commands, logService) {
            ...
            this.treeDragAndDropService = new treeViewsService_1.TreeviewsService();
        ...
        createTreeView(viewId, options, extension) {
            ...
            const dropMimeTypes = (_b = (_a = options.dragAndDropController) === null || _a === void 0 ? void 0 : _a.dropMimeTypes) !== null && _b !== void 0 ? _b : [];
            const dragMimeTypes = (_d = (_c = options.dragAndDropController) === null || _c === void 0 ? void 0 : _c.dragMimeTypes) !== null && _d !== void 0 ? _d : [];
            const hasHandleDrag = !!((_e = options.dragAndDropController) === null || _e === void 0 ? void 0 : _e.handleDrag);
            const hasHandleDrop = !!((_f = options.dragAndDropController) === null || _f === void 0 ? void 0 : _f.handleDrop);
            const supportsFileDataTransfers = (0, extensions_1.isProposedApiEnabled)(extension, 'dataTransferFiles');
            ...
            return {
                ...
                get badge() {
                    (0, extensions_1.checkProposedApiEnabled)(extension, 'badges');
        ...
        $getChildren(treeViewId, treeItemHandle) {
            ...
            if (!treeView) {
                return Promise.reject(new Error((0, nls_1.localize)('treeView.notRegistered', 'No tree view with id \'{0}\' registered.', treeViewId)));
            }
        ...
        async $handleDrop(destinationViewId, requestId, treeDataTransferDTO, targetItemHandle, token, operationUuid, sourceViewId, sourceTreeItemHandles) {
            ...
            if (!treeView) {
                return Promise.reject(new Error((0, nls_1.localize)('treeView.notRegistered', 'No tree view with id \'{0}\' registered.', destinationViewId)));
            }
        ...
        async addAdditionalTransferItems(treeDataTransfer, treeView, sourceTreeItemHandles, token, operationUuid) {
            ...
            if (existingTransferOperation) {
                (_a = (await existingTransferOperation)) === null || _a === void 0 ? void 0 : _a.forEach((value, key) => {
                    if (value) {
        ...
        async $handleDrag(sourceViewId, sourceTreeItemHandles, operationUuid, token) {
            ...
            if (!treeView) {
                return Promise.reject(new Error((0, nls_1.localize)('treeView.notRegistered', 'No tree view with id \'{0}\' registered.', sourceViewId)));
            }
            ...
            return extHostTypeConverters_1.DataTransfer.toDataTransferDTO(treeDataTransfer);
        }
        async $hasResolve(treeViewId) {
            const treeView = this.treeViews.get(treeViewId);
            if (!treeView) {
                throw new Error((0, nls_1.localize)('treeView.notRegistered', 'No tree view with id \'{0}\' registered.', treeViewId));
            }
    ...
    class ExtHostTreeView extends lifecycle_1.Disposable {
        ...
        async handleDrag(sourceTreeItemHandles, treeDataTransfer, token) {
            ...
            if (!((_a = this.dndController) === null || _a === void 0 ? void 0 : _a.handleDrag) || (extensionTreeItems.length === 0)) {
                return;
            }
        ...
        get hasHandleDrag() {
            var _a;
            return !!((_a = this.dndController) === null || _a === void 0 ? void 0 : _a.handleDrag);
        }
        async onDrop(treeDataTransfer, targetHandleOrNode, token) {
            ...
            if ((!target && targetHandleOrNode) || !((_a = this.dndController) === null || _a === void 0 ? void 0 : _a.handleDrop)) {
                return;
            }
            return (0, async_1.asPromise)(() => {
                var _a;
                return ((_a = this.dndController) === null || _a === void 0 ? void 0 : _a.handleDrop)
