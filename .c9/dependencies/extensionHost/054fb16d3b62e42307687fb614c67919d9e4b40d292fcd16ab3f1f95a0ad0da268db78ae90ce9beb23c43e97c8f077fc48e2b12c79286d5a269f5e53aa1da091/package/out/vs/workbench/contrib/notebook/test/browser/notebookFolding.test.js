 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/workbench/contrib/notebook/common/notebookCommon", "vs/workbench/contrib/notebook/test/browser/testNotebookEditor", "vs/platform/undoRedo/common/undoRedo", "vs/workbench/contrib/notebook/browser/viewModel/foldingModel", "vs/base/common/lifecycle"], function (require, exports, assert, notebookCommon_1, testNotebookEditor_1, undoRedo_1, foldingModel_1, lifecycle_1) {
    "use strict";
    ...
    suite('Notebook Folding', () => {
        ...
        test('Folding based on markdown cells', async function () {
            await (0, testNotebookEditor_1.withTestNotebook)([
                ...
                const foldingController = new foldingModel_1.FoldingModel();
