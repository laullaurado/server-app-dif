...
define(["require", "exports", "vs/base/common/async", "vs/base/common/cancellation", "vs/base/common/errors", "vs/base/common/event", "vs/base/common/labels", "vs/base/common/lifecycle", "vs/base/common/map", "vs/base/common/strings", "vs/base/common/uri", "vs/editor/common/core/range", "vs/editor/common/model", "vs/editor/common/model/textModel", "vs/editor/common/services/model", "vs/platform/instantiation/common/instantiation", "vs/workbench/services/search/common/replace", "vs/workbench/services/search/common/search", "vs/platform/telemetry/common/telemetry", "vs/platform/theme/common/colorRegistry", "vs/platform/theme/common/themeService", "vs/workbench/contrib/search/common/replace", "vs/workbench/services/search/common/searchHelpers", "vs/base/common/types", "vs/base/common/decorators", "vs/platform/configuration/common/configuration", "vs/base/common/comparers", "vs/base/common/network", "vs/platform/uriIdentity/common/uriIdentity"], function (require, exports, async_1, cancellation_1, errors, event_1, labels_1, lifecycle_1, map_1, strings_1, uri_1, range_1, model_1, textModel_1, model_2, instantiation_1, replace_1, search_1, telemetry_1, colorRegistry_1, themeService_1, replace_2, searchHelpers_1, types_1, decorators_1, configuration_1, comparers_1, network_1, uriIdentity_1) {
    "use strict";
    ...
    let FileMatch = class FileMatch extends lifecycle_1.Disposable {
        ...
        updateMatchesForModel() {
            ...
            const matches = this._model
                .findMatches(this._query.pattern, this._model.getFullModelRange(), !!this._query.isRegExp, !!this._query.isCaseSensitive, wordSeparators, false, (_a = this._maxResults) !== null && _a !== void 0 ? _a : Number.MAX_SAFE_INTEGER);
        ...
        updatesMatchesForLineAfterReplace(lineNumber, modelChange) {
            ...
            const wordSeparators = this._query.isWordMatch && this._query.wordSeparators ? this._query.wordSeparators : null;
            const matches = this._model.findMatches(this._query.pattern, range, !!this._query.isRegExp, !!this._query.isCaseSensitive, wordSeparators, false, (_a = this._maxResults) !== null && _a !== void 0 ? _a : Number.MAX_SAFE_INTEGER);
        ...
        updateMatches(matches, modelChange) {
            ...
            const textSearchResults = (0, searchHelpers_1.editorMatchesToTextSearchResults)(matches, this._model, this._previewOptions);
            ...
            this.addContext((0, searchHelpers_1.addContextToEditorMatches)(textSearchResults, this._model, this.parent().parent().query)
        ...
        name() {
            return (0, labels_1.getBaseLabel)(this.resource);
        }
        addContext(results) {
            if (!results) {
                return;
    ...
    let FolderMatch = class FolderMatch extends lifecycle_1.Disposable {
        ...
        name() {
            return (0, labels_1.getBaseLabel)((0, types_1.withNullAsUndefined)(this.resource)) || '';
        }
        parent() {
            return this._parent;
        }
    ...
    let SearchResult = class SearchResult extends lifecycle_1.Disposable {
        constructor(_searchModel, replaceService, instantiationService, modelService, uriIdentityService) {
            ...
            this._folderMatchesMap = map_1.TernarySearchTree.forUris(key => this.uriIdentityService.extUri.ignorePathCasing(key));
    ...
    let SearchModel = class SearchModel extends lifecycle_1.Disposable {
        ...
        async search(query, onProgress) {
            ...
            Promise.race([currentRequest, event_1.Event.toPromise(progressEmitter.event)]).finally(() => {
                /* __GDPR__
    ...
    exports.ISearchWorkbenchService = (0, instantiation_1.createDecorator)('searchWorkbenchService');
    /**
