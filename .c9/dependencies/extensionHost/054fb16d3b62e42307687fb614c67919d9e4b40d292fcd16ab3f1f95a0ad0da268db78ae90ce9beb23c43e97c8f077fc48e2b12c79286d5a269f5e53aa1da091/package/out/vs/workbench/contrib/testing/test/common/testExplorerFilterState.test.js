 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/platform/storage/common/storage", "vs/workbench/contrib/testing/common/testExplorerFilterState"], function (require, exports, assert, storage_1, testExplorerFilterState_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    suite('TestExplorerFilterState', () => {
        let t;
        setup(() => {
            t = new testExplorerFilterState_1.TestExplorerFilterState(new storage_1.InMemoryStorageService());
        });
        ...
        test('filters to patterns', () => {
            ...
            assert.deepStrictEqual(t.includeTags, new Set());
            assert.deepStrictEqual(t.excludeTags, new Set());
            assertFilteringFor(Object.assign(Object.assign({}, termFiltersOff), { ["@doc" /* TestFilterTerm.CurrentDoc */]: true }));
        });
