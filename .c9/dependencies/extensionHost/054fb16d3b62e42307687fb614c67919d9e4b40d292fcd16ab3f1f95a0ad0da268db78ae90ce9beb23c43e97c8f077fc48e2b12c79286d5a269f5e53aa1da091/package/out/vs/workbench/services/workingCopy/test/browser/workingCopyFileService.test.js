...
define(["require", "exports", "assert", "vs/workbench/services/textfile/common/textFileEditorModel", "vs/base/test/common/utils", "vs/workbench/test/browser/workbenchTestServices", "vs/workbench/test/common/workbenchTestServices", "vs/base/common/buffer", "vs/base/common/cancellation", "vs/base/common/async", "vs/base/common/lifecycle"], function (require, exports, assert, textFileEditorModel_1, utils_1, workbenchTestServices_1, workbenchTestServices_2, buffer_1, cancellation_1, async_1, lifecycle_1) {
    ...
    suite('WorkingCopyFileService', () => {
        ...
        test('move - source identical to target', async function () {
            let sourceModel = instantiationService.createInstance(textFileEditorModel_1.TextFileEditorModel, utils_1.toResource.call(this, '/path/file.txt'), 'utf8', undefined);
        ...
        test('move - one source == target and another source != target', async function () {
            let sourceModel1 = instantiationService.createInstance(textFileEditorModel_1.TextFileEditorModel, utils_1.toResource.call(this, '/path/file1.txt'), 'utf8', undefined);
            let sourceModel2 = instantiationService.createInstance(textFileEditorModel_1.TextFileEditorModel, utils_1.toResource.call(this, '/path/file2.txt'), 'utf8', undefined);
            let targetModel2 = instantiationService.createInstance(textFileEditorModel_1.TextFileEditorModel, utils_1.toResource.call(this, '/path/file_target2.txt'), 'utf8', undefined);
        ...
        test('registerWorkingCopyProvider', async function () {
            ...
            await model1.resolve();
            model1.textEditorModel.setValue('foo');
            const testWorkingCopy = new workbenchTestServices_2.TestWorkingCopy(utils_1.toResource.call(this, '/path/file-2.txt'), true);
            ...
            const participant = accessor.workingCopyFileService.addFileOperationParticipant({
                participate: async (files, operation) => {
                    for (let i = 0; i < files.length; i++) {
                        ...
                        assert.strictEqual(source === null || source === void 0 ? void 0 : source.toString(), sourceModel.resource.toString());
                    }
                    eventCounter++;
