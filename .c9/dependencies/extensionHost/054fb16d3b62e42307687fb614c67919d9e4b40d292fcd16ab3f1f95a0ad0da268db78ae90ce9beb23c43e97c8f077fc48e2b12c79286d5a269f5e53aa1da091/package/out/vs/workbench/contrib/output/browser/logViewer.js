...
define(["require", "exports", "vs/nls", "vs/base/common/path", "vs/platform/telemetry/common/telemetry", "vs/platform/storage/common/storage", "vs/editor/common/services/textResourceConfiguration", "vs/platform/instantiation/common/instantiation", "vs/workbench/browser/parts/editor/textResourceEditor", "vs/platform/theme/common/themeService", "vs/workbench/common/editor/textResourceEditorInput", "vs/base/common/uri", "vs/editor/common/services/resolverService", "vs/workbench/services/output/common/output", "vs/workbench/services/editor/common/editorGroupsService", "vs/workbench/services/editor/common/editorService", "vs/workbench/services/textfile/common/textfiles", "vs/platform/files/common/files", "vs/platform/label/common/label"], function (require, exports, nls_1, path_1, telemetry_1, storage_1, textResourceConfiguration_1, instantiation_1, textResourceEditor_1, themeService_1, textResourceEditorInput_1, uri_1, resolverService_1, output_1, editorGroupsService_1, editorService_1, textfiles_1, files_1, label_1) {
    "use strict";
    ...
    let LogViewerInput = class LogViewerInput extends textResourceEditorInput_1.TextResourceEditorInput {
        constructor(outputChannelDescriptor, textModelResolverService, textFileService, editorService, fileService, labelService) {
            super(uri_1.URI.from({ scheme: output_1.LOG_SCHEME, path: outputChannelDescriptor.id }), (0, path_1.basename)(outputChannelDescriptor.file.path), (0, path_1.dirname)(outputChannelDescriptor.file.path), undefined, undefined, textModelResolverService, textFileService, editorService, fileService, labelService);
        }
        get typeId() {
