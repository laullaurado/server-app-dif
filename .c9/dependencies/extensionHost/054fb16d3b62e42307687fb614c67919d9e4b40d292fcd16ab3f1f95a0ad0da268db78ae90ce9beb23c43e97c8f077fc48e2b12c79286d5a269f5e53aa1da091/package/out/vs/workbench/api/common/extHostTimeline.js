...
define(["require", "exports", "vs/base/common/uri", "vs/platform/instantiation/common/instantiation", "vs/workbench/api/common/extHost.protocol", "vs/base/common/lifecycle", "vs/workbench/api/common/extHostTypes", "vs/workbench/api/common/extHostTypeConverters", "vs/base/common/types"], function (require, exports, uri_1, instantiation_1, extHost_protocol_1, lifecycle_1, extHostTypes_1, extHostTypeConverters_1, types_1) {
    "use strict";
    ...
    class ExtHostTimeline {
        ...
        async $getTimeline(id, uri, options, token) {
            ...
            return provider === null || provider === void 0 ? void 0 : provider.provideTimeline(uri_1.URI.revive(uri), options, token);
        }
        registerTimelineProvider(scheme, provider, _extensionId, commandConverter) {
            ...
            return this.registerTimelineProviderCore(Object.assign(Object.assign({}, provider), { scheme: scheme, onDidChange: undefined, async provideTimeline(uri, options, token) {
                    var _a;
                    if (options === null || options === void 0 ? void 0 : options.resetCache) {
        ...
        convertTimelineItem(source, commandConverter, disposables) {
            return (uri, options) => {
                ...
                return (item) => {
                    ...
                    return Object.assign(Object.assign({}, props), { id: (_b = props.id) !== null && _b !== void 0 ? _b : undefined, handle: handle, source: source, command: item.command ? commandConverter.toInternal(item.command, disposables) : undefined, icon: icon, iconDark: iconDark, themeIcon: themeIcon, tooltip, accessibilityInformation: item.accessibilityInformation });
                };
            };
        }
