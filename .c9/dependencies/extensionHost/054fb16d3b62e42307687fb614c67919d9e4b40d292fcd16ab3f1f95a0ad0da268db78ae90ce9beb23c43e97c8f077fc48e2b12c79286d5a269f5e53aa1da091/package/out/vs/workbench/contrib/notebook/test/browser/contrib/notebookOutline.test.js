 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/workbench/contrib/notebook/test/browser/testNotebookEditor", "vs/workbench/contrib/notebook/browser/contrib/outline/notebookOutline", "vs/platform/theme/common/themeService", "vs/base/test/common/mock", "vs/base/common/event", "vs/workbench/services/editor/common/editorService", "vs/platform/markers/common/markers", "vs/platform/markers/common/markerService", "vs/workbench/contrib/notebook/common/notebookCommon", "vs/base/common/lifecycle"], function (require, exports, assert, testNotebookEditor_1, notebookOutline_1, themeService_1, mock_1, event_1, editorService_1, markers_1, markerService_1, notebookCommon_1, lifecycle_1) {
    "use strict";
    ...
    suite('Notebook Outline', function () {
        ...
        function withNotebookOutline(cells, callback) {
            return (0, testNotebookEditor_1.withTestNotebook)(cells, (editor) => {
                ...
                const outline = instantiationService.createInstance(notebookOutline_1.NotebookCellOutline, editor, 1 /* OutlineTarget.OutlinePane */);
