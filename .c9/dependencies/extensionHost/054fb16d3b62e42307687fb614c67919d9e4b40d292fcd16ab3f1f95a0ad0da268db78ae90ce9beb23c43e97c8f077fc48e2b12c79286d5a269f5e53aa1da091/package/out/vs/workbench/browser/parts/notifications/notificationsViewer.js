...
define(["require", "exports", "vs/base/browser/dom", "vs/platform/opener/common/opener", "vs/base/common/uri", "vs/nls", "vs/base/browser/ui/button/button", "vs/platform/theme/common/styler", "vs/platform/theme/common/themeService", "vs/base/browser/ui/actionbar/actionbar", "vs/base/common/actions", "vs/platform/instantiation/common/instantiation", "vs/base/common/lifecycle", "vs/platform/contextview/browser/contextView", "vs/workbench/common/notifications", "vs/workbench/browser/parts/notifications/notificationsActions", "vs/platform/keybinding/common/keybinding", "vs/base/browser/ui/progressbar/progressbar", "vs/platform/notification/common/notification", "vs/base/common/arrays", "vs/base/common/codicons", "vs/base/browser/ui/dropdown/dropdownActionViewItem", "vs/base/browser/event", "vs/base/browser/touch", "vs/base/common/event"], function (require, exports, dom_1, opener_1, uri_1, nls_1, button_1, styler_1, themeService_1, actionbar_1, actions_1, instantiation_1, lifecycle_1, contextView_1, notifications_1, notificationsActions_1, keybinding_1, progressbar_1, notification_1, arrays_1, codicons_1, dropdownActionViewItem_1, event_1, touch_1, event_2) {
        ...
        static render(message, actionHandler) {
            ...
            for (const node of message.linkedText.nodes) {
                if (typeof node === 'string') {
                    ...
                    const anchor = (0, dom_1.$)('a', { href: node.href, title: title, }, node.label);
                    if (actionHandler) {
                        const onPointer = (e) => {
                            dom_1.EventHelper.stop(e, true);
                            actionHandler.callback(node.href);
                        };
                        const onClick = actionHandler.toDispose.add(new event_1.DomEmitter(anchor, 'click')).event;
                        ...
                        event_2.Event.any(onClick, onTap)(onPointer, null, actionHandler.toDispose);
                    }
    ...
    let NotificationRenderer = class NotificationRenderer {
        ...
        renderTemplate(container) {
            ...
            data.toDispose.add((0, styler_1.attachProgressBarStyler)(data.progress, this.themeService));
            ...
            if (notification.expanded && (0, arrays_1.isNonEmptyArray)(primaryActions)) {
                ...
                for (let i = 0; i < primaryActions.length; i++) {
                    ...
                    const button = this.inputDisposables.add(dropdownActions ?
                        buttonToolbar.addButtonWithDropdown(Object.assign(Object.assign({}, options), { contextMenuProvider: this.contextMenuService, actions: dropdownActions, actionRunner })) :
                    ...
                    this.inputDisposables.add((0, styler_1.attachButtonStyler)(button, this.themeService));
                }
            }
        }
