...
define(["require", "exports", "vs/base/common/async", "vs/base/common/decorators", "vs/base/common/event", "vs/base/common/lifecycle", "vs/base/common/uri", "vs/editor/common/languages", "vs/platform/extensions/common/extensions", "vs/workbench/api/common/extHostTypeConverters", "vs/workbench/api/common/extHostTypes", "vs/workbench/services/extensions/common/extensions", "./extHost.protocol"], function (require, exports, async_1, decorators_1, event_1, lifecycle_1, uri_1, languages, extensions_1, extHostTypeConverter, types, extensions_2, extHost_protocol_1) {
    "use strict";
    ...
    function createExtHostComments(mainContext, commands, documents) {
        ...
        class ExtHostCommentThread {
            ...
            get state() {
                (0, extensions_2.checkProposedApiEnabled)(this.extensionDescription, 'commentsResolvedState');
                return this._state;
            }
            set state(newState) {
                (0, extensions_2.checkProposedApiEnabled)(this.extensionDescription, 'commentsResolvedState');
            ...
            eventuallyUpdateCommentThread() {
                ...
                if (modified('contextValue')) {
                     ...
                     * undefined -> no change
                     */
                    formattedModifications.contextValue = (_a = this.contextValue) !== null && _a !== void 0 ? _a : null;
                }
        ...
        function convertToDTOComment(thread, vscodeComment, commentsMap) {
            ...
            return {
                ...
                timestamp: (_a = vscodeComment.timestamp) === null || _a === void 0 ? void 0 : _a.toJSON()
            };
        }
