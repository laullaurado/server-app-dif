...
define(["require", "exports", "vs/nls", "vs/editor/browser/editorExtensions", "vs/base/common/lifecycle", "vs/workbench/browser/codeeditor", "vs/platform/instantiation/common/instantiation", "vs/platform/configuration/common/configuration", "vs/platform/notification/common/notification", "vs/editor/browser/widget/embeddedCodeEditorWidget"], function (require, exports, nls, editorExtensions_1, lifecycle_1, codeeditor_1, instantiation_1, configuration_1, notification_1, embeddedCodeEditorWidget_1) {
    "use strict";
    ...
    let DiffEditorHelperContribution = class DiffEditorHelperContribution extends lifecycle_1.Disposable {
        constructor(_diffEditor, _instantiationService, _configurationService, _notificationService) {
            ...
            if (!(this._diffEditor instanceof embeddedCodeEditorWidget_1.EmbeddedDiffEditorWidget)) {
        ...
        _setState(newState) {
            ...
            if (this._state === 1 /* WidgetState.HintWhitespace */) {
                this._helperWidget = this._instantiationService.createInstance(codeeditor_1.FloatingClickWidget, this._diffEditor.getModifiedEditor(), nls.localize('hintWhitespace', "Show Whitespace Differences"), null);
