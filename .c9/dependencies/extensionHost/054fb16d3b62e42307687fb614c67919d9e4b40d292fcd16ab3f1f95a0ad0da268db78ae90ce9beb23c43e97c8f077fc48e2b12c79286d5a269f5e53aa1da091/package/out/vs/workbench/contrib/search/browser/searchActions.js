...
define(["require", "exports", "vs/base/browser/dom", "vs/base/common/actions", "vs/base/common/keybindings", "vs/base/common/platform", "vs/nls", "vs/platform/clipboard/common/clipboardService", "vs/platform/commands/common/commands", "vs/platform/configuration/common/configuration", "vs/platform/keybinding/common/keybinding", "vs/platform/label/common/label", "vs/platform/list/browser/listService", "vs/platform/theme/common/themeService", "vs/workbench/common/views", "vs/workbench/contrib/search/browser/searchIcons", "vs/workbench/contrib/search/common/constants", "vs/workbench/contrib/search/common/replace", "vs/workbench/contrib/search/common/searchHistoryService", "vs/workbench/contrib/search/common/searchModel", "vs/workbench/contrib/searchEditor/browser/constants", "vs/workbench/contrib/searchEditor/browser/searchEditorInput", "vs/workbench/services/editor/common/editorService", "vs/workbench/services/search/common/search", "vs/platform/uriIdentity/common/uriIdentity"], function (require, exports, DOM, actions_1, keybindings_1, platform_1, nls, clipboardService_1, commands_1, configuration_1, keybinding_1, label_1, listService_1, themeService_1, views_1, searchIcons_1, Constants, replace_1, searchHistoryService_1, searchModel_1, constants_1, searchEditorInput_1, editorService_1, search_1, uriIdentity_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.focusSearchListCommand = exports.clearHistoryCommand = exports.copyAllCommand = exports.copyMatchCommand = exports.copyPathCommand = exports.ReplaceAction = exports.ReplaceAllInFolderAction = exports.ReplaceAllAction = exports.RemoveAction = exports.AbstractSearchAndReplaceAction = exports.FocusPreviousSearchResultAction = exports.FocusNextSearchResultAction = exports.collapseDeepestExpandedLevel = exports.refreshSearch = exports.cancelSearch = exports.clearSearchResults = exports.expandAll = exports.ToggleSearchOnTypeAction = exports.CloseReplaceAction = exports.ReplaceInFilesAction = exports.FindInFilesCommand = exports.FindOrReplaceInFilesAction = exports.FocusPreviousInputAction = exports.FocusNextInputAction = exports.togglePreserveCaseCommand = exports.toggleRegexCommand = exports.toggleWholeWordCommand = exports.toggleCaseSensitiveCommand = exports.getSearchView = exports.openSearchView = exports.appendKeyBindingLabel = exports.isSearchViewFocused = void 0;
    ...
    function appendKeyBindingLabel(label, inputKeyBinding, keyBindingService2) {
        if (typeof inputKeyBinding === 'number') {
            const keybinding = (0, keybindings_1.createKeybinding)(inputKeyBinding, platform_1.OS);
            if (keybinding) {
    ...
    const toggleCaseSensitiveCommand = (accessor) => {
    ...
    const toggleWholeWordCommand = (accessor) => {
        const searchView = getSearchView(accessor.get(views_1.IViewsService));
        if (searchView) {
    ...
    const toggleRegexCommand = (accessor) => {
        const searchView = getSearchView(accessor.get(views_1.IViewsService));
        if (searchView) {
    ...
    const togglePreserveCaseCommand = (accessor) => {
        const searchView = getSearchView(accessor.get(views_1.IViewsService));
        if (searchView) {
            searchView.togglePreserveCase();
        }
    };
    exports.togglePreserveCaseCommand = togglePreserveCaseCommand;
    ...
    const FindInFilesCommand = (accessor, args = {}) => {
        ...
        if (mode === 'view') {
            ...
            accessor.get(commands_1.ICommandService).executeCommand(constants_1.OpenEditorCommandId, convertArgs(args));
        }
    };
    ...
    exports.refreshSearch = refreshSearch;
    ...
    exports.collapseDeepestExpandedLevel = collapseDeepestExpandedLevel;
    ...
    let RemoveAction = class RemoveAction extends AbstractSearchAndReplaceAction {
        constructor(viewer, element, keyBindingService) {
            super(Constants.RemoveActionId, appendKeyBindingLabel(RemoveAction.LABEL, keyBindingService.lookupKeybinding(Constants.RemoveActionId), keyBindingService), themeService_1.ThemeIcon.asClassName(searchIcons_1.searchRemoveIcon));
            this.viewer = viewer;
        ...
        run() {
            ...
            if (nextFocusElement) {
                ...
                this.viewer.setFocus([nextFocusElement], (0, listService_1.getSelectionKeyboardEvent)());
                this.viewer.setSelection([nextFocusElement], (0, listService_1.getSelectionKeyboardEvent)());
            }
    ...
    let ReplaceAllAction = class ReplaceAllAction extends AbstractSearchAndReplaceAction {
        constructor(viewlet, fileMatch, keyBindingService) {
            super(Constants.ReplaceAllInFileActionId, appendKeyBindingLabel(ReplaceAllAction.LABEL, keyBindingService.lookupKeybinding(Constants.ReplaceAllInFileActionId), keyBindingService), themeService_1.ThemeIcon.asClassName(searchIcons_1.searchReplaceAllIcon));
        ...
        run() {
            ...
            return this.fileMatch.parent().replace(this.fileMatch).then(() => {
                if (nextFocusElement) {
                    tree.setFocus([nextFocusElement], (0, listService_1.getSelectionKeyboardEvent)());
                    tree.setSelection([nextFocusElement], (0, listService_1.getSelectionKeyboardEvent)());
                }
                tree.domFocus();
    ...
    let ReplaceAllInFolderAction = class ReplaceAllInFolderAction extends AbstractSearchAndReplaceAction {
        constructor(viewer, folderMatch, keyBindingService) {
            super(Constants.ReplaceAllInFolderActionId, appendKeyBindingLabel(ReplaceAllInFolderAction.LABEL, keyBindingService.lookupKeybinding(Constants.ReplaceAllInFolderActionId), keyBindingService), themeService_1.ThemeIcon.asClassName(searchIcons_1.searchReplaceAllIcon));
            this.viewer = viewer;
    ...
    let ReplaceAction = class ReplaceAction extends AbstractSearchAndReplaceAction {
        constructor(viewer, element, viewlet, replaceService, keyBindingService, editorService, configurationService, uriIdentityService) {
            super(Constants.ReplaceActionId, appendKeyBindingLabel(ReplaceAction.LABEL, keyBindingService.lookupKeybinding(Constants.ReplaceActionId), keyBindingService), themeService_1.ThemeIcon.asClassName(searchIcons_1.searchReplaceIcon));
            this.viewer = viewer;
            this.element = element;
            this.viewlet = viewlet;
        ...
        async run() {
            ...
            if (elementToFocus) {
                this.viewer.setFocus([elementToFocus], (0, listService_1.getSelectionKeyboardEvent)());
                this.viewer.setSelection([elementToFocus], (0, listService_1.getSelectionKeyboardEvent)());
            }
        ...
        hasSameParent(element) {
            return element && element instanceof searchModel_1.Match && this.uriIdentityService.extUri.isEqual(element.parent().resource, this.element.parent().resource);
        }
        hasToOpenFile() {
            const activeEditor = this.editorService.activeEditor;
            const file = activeEditor === null || activeEditor === void 0 ? void 0 : activeEditor.resource;
            if (file) {
    ...
    ReplaceAction.runQ = Promise.resolve();
    ...
    const copyPathCommand = async (accessor, fileMatch) => {
        if (!fileMatch) {
    ...
    const copyMatchCommand = async (accessor, match) => {
        if (!match) {
            const selection = getSelectedRow(accessor);
            if (!selection) {
                return;
    ...
    exports.copyMatchCommand = copyMatchCommand;
    ...
    const copyAllCommand = async (accessor) => {
        const viewsService = accessor.get(views_1.IViewsService);
        const clipboardService = accessor.get(clipboardService_1.IClipboardService);
        const labelService = accessor.get(label_1.ILabelService);
        const searchView = getSearchView(viewsService);
    ...
    exports.copyAllCommand = copyAllCommand;
    ...
    exports.clearHistoryCommand = clearHistoryCommand;
    ...
    exports.focusSearchListCommand = focusSearchListCommand;
});
