...
define(["require", "exports", "vs/base/common/dataTransfer", "vs/base/common/errors", "vs/base/common/event", "vs/base/common/lifecycle", "vs/base/common/marshalling", "vs/base/common/objects", "vs/base/common/uri", "vs/editor/common/languages/language", "vs/editor/common/languages/languageConfigurationRegistry", "vs/editor/common/services/languageFeatures", "vs/editor/common/services/semanticTokensDto", "vs/workbench/api/common/extHostTypeConverters", "vs/workbench/api/common/shared/dataTransferCache", "vs/workbench/contrib/callHierarchy/common/callHierarchy", "vs/workbench/contrib/search/common/search", "vs/workbench/contrib/typeHierarchy/common/typeHierarchy", "vs/workbench/services/extensions/common/extHostCustomers", "../common/extHost.protocol"], function (require, exports, dataTransfer_1, errors_1, event_1, lifecycle_1, marshalling_1, objects_1, uri_1, language_1, languageConfigurationRegistry_1, languageFeatures_1, semanticTokensDto_1, typeConvert, dataTransferCache_1, callh, search, typeh, extHostCustomers_1, extHost_protocol_1) {
    "use strict";
    ...
    let MainThreadLanguageFeatures = MainThreadLanguageFeatures_1 = class MainThreadLanguageFeatures extends lifecycle_1.Disposable {
        ...
        $registerPasteEditProvider(handle, selector, supportsCopy) {
            const provider = {
                prepareDocumentPaste: supportsCopy
                    ? async (model, selection, dataTransfer, token) => {
                    ...
                    : undefined,
                provideDocumentPasteEdits: async (model, selection, dataTransfer, token) => {
                    ...
                    if (!result) {
                        ...
                        return (0, extHost_protocol_1.reviveWorkspaceEditDto)(result);
                    }
                    else {
                        return result;
                    }
    ...
    class MainThreadDocumentOnDropEditProvider {
        constructor(handle, _proxy) {
            this.handle = handle;
            this._proxy = _proxy;
            this.dataTransfers = new dataTransferCache_1.DataTransferCache();
        }
