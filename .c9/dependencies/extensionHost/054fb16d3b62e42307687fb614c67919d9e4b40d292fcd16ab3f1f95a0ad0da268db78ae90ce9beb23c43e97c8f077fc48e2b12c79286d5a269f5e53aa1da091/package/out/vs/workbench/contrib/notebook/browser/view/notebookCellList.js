...
define(["require", "exports", "vs/base/browser/dom", "vs/base/browser/ui/list/list", "vs/base/common/event", "vs/base/common/lifecycle", "vs/base/common/platform", "vs/editor/common/core/range", "vs/editor/common/model/prefixSumComputer", "vs/platform/configuration/common/configuration", "vs/platform/keybinding/common/keybinding", "vs/platform/list/browser/listService", "vs/platform/theme/common/themeService", "vs/workbench/contrib/notebook/browser/notebookBrowser", "vs/workbench/contrib/notebook/common/notebookCommon", "vs/workbench/contrib/notebook/common/notebookRange", "vs/workbench/contrib/notebook/common/notebookContextKeys", "vs/base/common/numbers", "vs/base/browser/fastDomNode", "vs/workbench/contrib/notebook/browser/viewModel/markupCellViewModel"], function (require, exports, DOM, list_1, event_1, lifecycle_1, platform_1, range_1, prefixSumComputer_1, configuration_1, keybinding_1, listService_1, themeService_1, notebookBrowser_1, notebookCommon_1, notebookRange_1, notebookContextKeys_1, numbers_1, fastDomNode_1, markupCellViewModel_1) {
    "use strict";
    ...
    let NotebookCellList = class NotebookCellList extends listService_1.WorkbenchList {
        constructor(listUser, parentContainer, container, viewContext, delegate, renderers, contextKeyService, options, listService, themeService, configurationService, keybindingService) {
            ...
            this._localDisposableStore.add(this.view.onMouseDblClick(() => {
                ...
                if (focus && focus.cellKind === notebookCommon_1.CellKind.Markup && !focus.isInputCollapsed && !((_a = this._viewModel) === null || _a === void 0 ? void 0 : _a.options.isReadOnly)) {
        ...
        scrollToBottom() {
            ...
            const scrollTop = this.getViewScrollTop();
            const wrapperBottom = this.getViewScrollBottom();
            const topInsertToolbarHeight = this._viewContext.notebookOptions.computeTopInsertToolbarHeight((_a = this.viewModel) === null || _a === void 0 ? void 0 : _a.viewType);
        ...
        async _revealLineInViewAsync(viewIndex, line) {
            return this._revealRangeInternalAsync(viewIndex, new range_1.Range(line, 1, line, 1), 0 /* CellRevealType.Line */);
        }
        ...
        async _revealLineInCenterAsync(viewIndex, line) {
            return this._revealRangeInCenterInternalAsync(viewIndex, new range_1.Range(line, 1, line, 1), 0 /* CellRevealType.Line */);
        }
        ...
        async _revealLineInCenterIfOutsideViewportAsync(viewIndex, line) {
            return this._revealRangeInCenterIfOutsideViewportInternalAsync(viewIndex, new range_1.Range(line, 1, line, 1), 0 /* CellRevealType.Line */);
        }
    ...
    class ListViewInfoAccessor extends lifecycle_1.Disposable {
        ...
        getCellsInRange(range) {
            var _a, _b;
            return (_b = (_a = this.list.viewModel) === null || _a === void 0 ? void 0 : _a.getCellsInRange(range)) !== null && _b !== void 0 ? _b : [];
        }
        ...
        getVisibleRangesPlusViewportAboveAndBelow() {
            var _a, _b;
            return (_b = (_a = this.list) === null || _a === void 0 ? void 0 : _a.getVisibleRangesPlusViewportAboveAndBelow()) !== null && _b !== void 0 ? _b : [];
        }
        triggerScroll(event) {
