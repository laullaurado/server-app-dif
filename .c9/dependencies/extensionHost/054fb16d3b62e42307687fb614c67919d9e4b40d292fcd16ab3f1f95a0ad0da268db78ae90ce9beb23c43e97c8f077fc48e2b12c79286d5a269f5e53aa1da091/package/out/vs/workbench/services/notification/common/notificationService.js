    ...
    let NotificationService = class NotificationService extends lifecycle_1.Disposable {
        ...
        notify(notification) {
            ...
            if (notification.neverShowAgain) {
                const scope = notification.neverShowAgain.scope === notification_1.NeverShowAgainScope.WORKSPACE ? 1 /* StorageScope.WORKSPACE */ : 0 /* StorageScope.GLOBAL */;
        ...
        prompt(severity, message, choices, options) {
            ...
            if (options === null || options === void 0 ? void 0 : options.neverShowAgain) {
                const scope = options.neverShowAgain.scope === notification_1.NeverShowAgainScope.WORKSPACE ? 1 /* StorageScope.WORKSPACE */ : 0 /* StorageScope.GLOBAL */;
