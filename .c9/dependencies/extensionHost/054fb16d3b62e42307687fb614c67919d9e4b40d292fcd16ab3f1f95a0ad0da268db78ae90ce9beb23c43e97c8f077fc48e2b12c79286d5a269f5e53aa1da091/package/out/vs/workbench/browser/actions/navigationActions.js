...
define(["require", "exports", "vs/nls", "vs/platform/registry/common/platform", "vs/base/common/actions", "vs/workbench/services/editor/common/editorGroupsService", "vs/workbench/services/layout/browser/layoutService", "vs/platform/actions/common/actions", "vs/workbench/common/actions", "vs/workbench/services/editor/common/editorService", "vs/workbench/services/panecomposite/browser/panecomposite"], function (require, exports, nls_1, platform_1, actions_1, editorGroupsService_1, layoutService_1, actions_2, actions_3, editorService_1, panecomposite_1) {
    "use strict";
    ...
    NavigateLeftAction.LABEL = (0, nls_1.localize)('navigateLeft', "Navigate to the View on the Left");
    ...
    NavigateRightAction.LABEL = (0, nls_1.localize)('navigateRight', "Navigate to the View on the Right");
    ...
    NavigateUpAction.LABEL = (0, nls_1.localize)('navigateUp', "Navigate to the View Above");
    ...
    NavigateDownAction.LABEL = (0, nls_1.localize)('navigateDown', "Navigate to the View Below");
    ...
    function focusNextOrPreviousPart(layoutService, editorService, next) {
        ...
        const editorFocused = ((_a = editorService.activeEditorPane) === null || _a === void 0 ? void 0 : _a.hasFocus()) || layoutService.hasFocus("workbench.parts.editor" /* Parts.EDITOR_PART */);
    ...
    FocusNextPart.LABEL = (0, nls_1.localize)('focusNextPart', "Focus Next Part");
    ...
    FocusPreviousPart.LABEL = (0, nls_1.localize)('focusPreviousPart', "Focus Previous Part");
    ...
    actionsRegistry.registerWorkbenchAction(actions_2.SyncActionDescriptor.from(FocusNextPart, { primary: 64 /* KeyCode.F6 */ }), 'View: Focus Next Part', actions_3.CATEGORIES.View.value);
    actionsRegistry.registerWorkbenchAction(actions_2.SyncActionDescriptor.from(FocusPreviousPart, { primary: 1024 /* KeyMod.Shift */ | 64 /* KeyCode.F6 */ }), 'View: Focus Previous Part', actions_3.CATEGORIES.View.value);
});
