...
define(["require", "exports", "vs/base/common/arrays", "vs/base/common/event", "vs/base/common/json", "vs/base/common/lifecycle", "vs/editor/common/core/range", "vs/editor/common/core/selection", "vs/nls", "vs/platform/configuration/common/configuration", "vs/platform/configuration/common/configurationRegistry", "vs/platform/keybinding/common/keybinding", "vs/platform/registry/common/platform", "vs/workbench/common/editor/editorModel", "vs/workbench/services/preferences/common/preferences", "vs/base/common/types", "vs/workbench/services/configuration/common/configuration", "vs/workbench/services/preferences/common/preferencesValidation"], function (require, exports, arrays_1, event_1, json_1, lifecycle_1, range_1, selection_1, nls, configuration_1, configurationRegistry_1, keybinding_1, platform_1, editorModel_1, preferences_1, types_1, configuration_2, preferencesValidation_1) {
    "use strict";
    ...
    class AbstractSettingsModel extends editorModel_1.EditorModel {
        ...
        compareTwoNullableNumbers(a, b) {
            const aOrMax = a !== null && a !== void 0 ? a : Number.MAX_SAFE_INTEGER;
            const bOrMax = b !== null && b !== void 0 ? b : Number.MAX_SAFE_INTEGER;
            if (aOrMax < bOrMax) {
                return -1;
            }
                    ...
                    for (const setting of section.settings) {
                        ...
                        if (groupMatched || settingMatchResult) {
                            filterMatches.push({
                                ...
                                matchType: (_a = settingMatchResult === null || settingMatchResult === void 0 ? void 0 : settingMatchResult.matchType) !== null && _a !== void 0 ? _a : preferences_1.SettingMatchType.None,
                                score: (_b = settingMatchResult === null || settingMatchResult === void 0 ? void 0 : settingMatchResult.score) !== null && _b !== void 0 ? _b : 0
                            });
                        }
                    }
                }
            ...
            onObjectProperty: (name, offset, length) => {
                ...
                if (previousParents.length === settingsPropertyIndex + 1 || (previousParents.length === settingsPropertyIndex + 2 && overrideSetting !== null)) {
                    ...
                    const setting = {
                        ...
                        descriptionRanges: [],
                        overrides: [],
                        overrideOf: (0, types_1.withNullAsUndefined)(overrideSetting)
                    };
    ...
    class DefaultSettings extends lifecycle_1.Disposable {
        ...
        parseConfig(config, result, configurations, settingsGroup, seenSettings) {
            ...
            if (title) {
                if (!settingsGroup) {
                    settingsGroup = result.find(g => { var _a, _b; return g.title === title && ((_a = g.extensionInfo) === null || _a === void 0 ? void 0 : _a.id) === ((_b = config.extensionInfo) === null || _b === void 0 ? void 0 : _b.id); });
                    if (!settingsGroup) {
        ...
        parseSettings(config) {
            ...
            const categoryLabel = ((_a = config.extensionInfo) === null || _a === void 0 ? void 0 : _a.id) === config.id ? config.title : config.id;
            ...
            for (const key in settingsObject) {
                ...
                if (this.matchesScope(prop)) {
                    ...
                    let listItemType;
                    if (prop.type === 'array' && prop.items && !(0, types_1.isArray)(prop.items) && prop.items.type) {
                        if (prop.items.enum) {
                            listItemType = 'enum';
                        }
                        else if (!(0, types_1.isArray)(prop.items.type)) {
                    ...
                    let enumDescriptions = (_b = prop.enumDescriptions) !== null && _b !== void 0 ? _b : prop.markdownEnumDescriptions;
                    let enumDescriptionsAreMarkdown = !prop.enumDescriptions;
                    if (listItemType === 'enum' && !(0, types_1.isArray)(prop.items)) {
                        enumToUse = prop.items.enum;
                        enumDescriptions = (_c = prop.items.enumDescriptions) !== null && _c !== void 0 ? _c : prop.items.markdownEnumDescriptions;
        ...
        matchesScope(property) {
            ...
            if (this.target === 5 /* ConfigurationTarget.WORKSPACE_FOLDER */) {
                return configuration_2.FOLDER_SCOPES.indexOf(property.scope) !== -1;
            }
            if (this.target === 4 /* ConfigurationTarget.WORKSPACE */) {
    ...
    class SettingsContentBuilder {
        ...
        pushSettingDescription(setting, indent) {
            ...
            const deprecationMessageLines = (_b = (_a = setting.deprecationMessage) === null || _a === void 0 ? void 0 : _a.split(/\n/g)) !== null && _b !== void 0 ? _b : [];
