...
define(["require", "exports", "vs/base/common/event", "vs/workbench/common/editor", "vs/workbench/common/editor/editorInput", "vs/workbench/common/editor/sideBySideEditorInput", "vs/platform/instantiation/common/instantiation", "vs/platform/configuration/common/configuration", "vs/base/common/lifecycle", "vs/platform/registry/common/platform", "vs/base/common/arrays"], function (require, exports, event_1, editor_1, editorInput_1, sideBySideEditorInput_1, instantiation_1, configuration_1, lifecycle_1, platform_1, arrays_1) {
    ...
    let EditorGroupModel = class EditorGroupModel extends lifecycle_1.Disposable {
        ...
        openEditor(candidate, options) {
            const makeSticky = (options === null || options === void 0 ? void 0 : options.sticky) || (typeof (options === null || options === void 0 ? void 0 : options.index) === 'number' && this.isSticky(options.index));
            const makePinned = (options === null || options === void 0 ? void 0 : options.pinned) || (options === null || options === void 0 ? void 0 : options.sticky);
            const makeActive = (options === null || options === void 0 ? void 0 : options.active) || !this.activeEditor || (!makePinned && this.matches(this.preview, this.activeEditor));
        ...
        registerEditorListeners(editor) {
            ...
            listeners.add(this.onDidModelChange(event => {
                var _a;
                if (event.kind === 4 /* GroupModelChangeKind.EDITOR_CLOSE */ && ((_a = event.editor) === null || _a === void 0 ? void 0 : _a.matches(editor))) {
        ...
        replaceEditor(toReplace, replaceWith, replaceIndex, openNext = true) {
            ...
            if (closeResult) {
                const event = Object.assign({ kind: 4 /* GroupModelChangeKind.EDITOR_CLOSE */ }, closeResult);
                this._onDidModelChange.fire(event);
            }
        }
        ...
        indexOf(candidate, editors = this.editors, options) {
            ...
            for (let i = 0; i < editors.length; i++) {
                ...
                if (this.matches(editor, candidate, options)) {
                    ...
                    if ((options === null || options === void 0 ? void 0 : options.supportSideBySide) && editor instanceof sideBySideEditorInput_1.SideBySideEditorInput && !(candidate instanceof sideBySideEditorInput_1.SideBySideEditorInput)) {
                        index = i;
                    }
                    else {
                        index = i;
        ...
        matches(editor, candidate, options) {
            ...
            if (options === null || options === void 0 ? void 0 : options.strictEquals) {
                return strictEquals;
            }
