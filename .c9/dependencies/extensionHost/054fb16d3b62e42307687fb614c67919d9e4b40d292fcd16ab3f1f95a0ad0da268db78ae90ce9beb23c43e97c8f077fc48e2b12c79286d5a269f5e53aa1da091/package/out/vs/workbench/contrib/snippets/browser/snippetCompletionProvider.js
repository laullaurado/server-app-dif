...
define(["require", "exports", "vs/base/common/htmlContent", "vs/base/common/strings", "vs/editor/common/core/range", "vs/editor/common/languages/language", "vs/editor/contrib/snippet/browser/snippetParser", "vs/nls", "vs/workbench/contrib/snippets/browser/snippets.contribution", "vs/base/common/filters", "vs/base/common/stopwatch", "vs/editor/common/languages/languageConfigurationRegistry", "vs/editor/common/core/wordHelper"], function (require, exports, htmlContent_1, strings_1, range_1, language_1, snippetParser_1, nls_1, snippets_contribution_1, filters_1, stopwatch_1, languageConfigurationRegistry_1, wordHelper_1) {
    "use strict";
    ...
    let SnippetCompletionProvider = class SnippetCompletionProvider {
        ...
        async provideCompletionItems(model, position, context) {
            ...
            const triggerCharacterLow = (_b = (_a = context.triggerCharacter) === null || _a === void 0 ? void 0 : _a.toLowerCase()) !== null && _b !== void 0 ? _b : '';
