 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/workbench/contrib/terminal/browser/links/terminalLinkHelpers"], function (require, exports, assert, terminalLinkHelpers_1) {
    "use strict";
    ...
    suite('Workbench - Terminal Link Helpers', () => {
        suite('convertLinkRangeToBuffer', () => {
            ...
            test('should convert ranges for several wide characters before and inside the link', () => {
                ...
                const bufferRange = (0, terminalLinkHelpers_1.convertLinkRangeToBuffer)(lines, 11, { startColumn: 15, startLineNumber: 1, endColumn: 31, endLineNumber: 1 }, 0);
                // This test ensures that the start offset is applies to the end before it's counted
                assert.deepStrictEqual(bufferRange, {
                    start: { x: 4 + 4, y: 2 },
                    end: { x: 2, y: 4 }
