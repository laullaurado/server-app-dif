 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/base/common/lifecycle", "vs/base/common/uri", "vs/editor/browser/services/bulkEditService", "vs/editor/common/services/model", "vs/editor/common/languages/language", "vs/editor/common/services/resolverService", "vs/platform/configuration/common/configuration", "vs/platform/configuration/test/common/testConfigurationService", "vs/platform/theme/common/themeService", "vs/platform/theme/test/common/testThemeService", "vs/platform/undoRedo/common/undoRedo", "vs/workbench/contrib/notebook/browser/controller/cellOperations", "vs/workbench/contrib/notebook/browser/viewModel/eventDispatcher", "vs/workbench/contrib/notebook/browser/viewModel/notebookViewModelImpl", "vs/workbench/contrib/notebook/browser/viewModel/viewContext", "vs/workbench/contrib/notebook/common/model/notebookTextModel", "vs/workbench/contrib/notebook/common/notebookCommon", "vs/workbench/contrib/notebook/common/notebookOptions", "vs/workbench/contrib/notebook/test/browser/testNotebookEditor", "vs/workbench/contrib/notebook/common/notebookExecutionStateService"], function (require, exports, assert, lifecycle_1, uri_1, bulkEditService_1, model_1, language_1, resolverService_1, configuration_1, testConfigurationService_1, themeService_1, testThemeService_1, undoRedo_1, cellOperations_1, eventDispatcher_1, notebookViewModelImpl_1, viewContext_1, notebookTextModel_1, notebookCommon_1, notebookOptions_1, testNotebookEditor_1, notebookExecutionStateService_1) {
    "use strict";
    ...
    suite('NotebookViewModel', () => {
        ...
        test('ctor', function () {
            const notebook = new notebookTextModel_1.NotebookTextModel('notebook', uri_1.URI.parse('test'), [], {}, { transientCellMetadata: {}, transientDocumentMetadata: {}, transientOutputs: false }, undoRedoService, modelService, languageService);
            const model = new testNotebookEditor_1.NotebookEditorTestModel(notebook);
            const viewContext = new viewContext_1.ViewContext(new notebookOptions_1.NotebookOptions(instantiationService.get(configuration_1.IConfigurationService), instantiationService.get(notebookExecutionStateService_1.INotebookExecutionStateService)), new eventDispatcher_1.NotebookEventDispatcher());
            const viewModel = new notebookViewModelImpl_1.NotebookViewModel('notebook', model.notebook, viewContext, null, { isReadOnly: false }, instantiationService, bulkEditService, undoRedoService, textModelService);
    ...
    suite('NotebookViewModel Decorations', () => {
        test('tracking range', async function () {
            await (0, testNotebookEditor_1.withTestNotebook)([
                ...
                (0, cellOperations_1.insertCellAtIndex)(viewModel, 0, 'var d = 6;', 'javascript', notebookCommon_1.CellKind.Code, {}, [], true, true);
                assert.deepStrictEqual(viewModel.getTrackedRange(trackedId), {
                    start: 2,
                    end: 3
                });
                ...
                (0, cellOperations_1.insertCellAtIndex)(viewModel, 3, 'var d = 7;', 'javascript', notebookCommon_1.CellKind.Code, {}, [], true, true);
                assert.deepStrictEqual(viewModel.getTrackedRange(trackedId), {
                    start: 1,
                    end: 3
                });
