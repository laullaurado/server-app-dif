 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/base/common/event", "vs/platform/instantiation/test/common/instantiationServiceMock", "vs/workbench/services/lifecycle/common/lifecycle", "vs/platform/notification/common/notification", "vs/platform/notification/test/common/testNotificationService", "vs/platform/storage/common/storage", "vs/platform/telemetry/common/telemetry", "vs/platform/telemetry/common/telemetryUtils", "vs/workbench/contrib/experiments/browser/experimentalPrompt", "vs/workbench/contrib/experiments/common/experimentService", "vs/workbench/contrib/experiments/test/electron-browser/experimentService.test", "vs/workbench/test/browser/workbenchTestServices", "vs/editor/test/browser/editorTestServices", "vs/platform/commands/common/commands"], function (require, exports, assert, event_1, instantiationServiceMock_1, lifecycle_1, notification_1, testNotificationService_1, storage_1, telemetry_1, telemetryUtils_1, experimentalPrompt_1, experimentService_1, experimentService_test_1, workbenchTestServices_1, editorTestServices_1, commands_1) {
    "use strict";
    ...
    suite('Experimental Prompts', () => {
        ...
        setup(() => {
            ...
            commandService = instantiationService.createInstance(editorTestServices_1.TestCommandService);
            instantiationService.stub(commands_1.ICommandService, commandService);
        });
        teardown(() => {
        ...
        test('runs experiment command', () => {
            ...
            const stub = instantiationService.stub(commands_1.ICommandService, 'executeCommand', () => undefined);
            instantiationService.stub(notification_1.INotificationService, {
            ...
            experimentalPrompt = instantiationService.createInstance(experimentalPrompt_1.ExperimentalPrompts);
            onExperimentEnabledEvent.fire(Object.assign(Object.assign({}, experiment), { action: {
                    type: experimentService_1.ExperimentActionType.Prompt,
                    properties: {
                        promptText,
                        commands: [
        ...
        test('Test getPromptText', () => {
            ...
            assert.strictEqual(experimentalPrompt_1.ExperimentalPrompts.getLocalizedText(simpleTextCase.promptText, 'any-language'), simpleTextCase.promptText);
            const multipleLocalePromptText = multipleLocaleCase.promptText;
            assert.strictEqual(experimentalPrompt_1.ExperimentalPrompts.getLocalizedText(multipleLocaleCase.promptText, 'en'), multipleLocalePromptText['en']);
            assert.strictEqual(experimentalPrompt_1.ExperimentalPrompts.getLocalizedText(multipleLocaleCase.promptText, 'de'), multipleLocalePromptText['de']);
            assert.strictEqual(experimentalPrompt_1.ExperimentalPrompts.getLocalizedText(multipleLocaleCase.promptText, 'en-au'), multipleLocalePromptText['en-au']);
            assert.strictEqual(experimentalPrompt_1.ExperimentalPrompts.getLocalizedText(multipleLocaleCase.promptText, 'en-gb'), multipleLocalePromptText['en']);
            assert.strictEqual(experimentalPrompt_1.ExperimentalPrompts.getLocalizedText(multipleLocaleCase.promptText, 'fr'), multipleLocalePromptText['en']);
            assert.strictEqual(experimentalPrompt_1.ExperimentalPrompts.getLocalizedText(englishUSTextCase.promptText, 'fr'), englishUSTextCase.promptText['en-us']);
            assert.strictEqual(!!experimentalPrompt_1.ExperimentalPrompts.getLocalizedText(noEnglishTextCase.promptText, 'fr'), false);
        });
    });
});
