...
define(["require", "exports", "vs/nls", "vs/base/common/actions", "vs/base/common/errors", "vs/base/common/lifecycle", "vs/platform/instantiation/common/instantiation", "vs/base/browser/ui/actionbar/actionbar", "vs/workbench/browser/parts/compositeBarActions", "vs/base/browser/dom", "vs/base/browser/mouseEvent", "vs/platform/contextview/browser/contextView", "vs/base/browser/ui/widget", "vs/base/common/types", "vs/base/common/event", "vs/workbench/browser/dnd", "vs/base/browser/touch"], function (require, exports, nls_1, actions_1, errors_1, lifecycle_1, instantiation_1, actionbar_1, compositeBarActions_1, dom_1, mouseEvent_1, contextView_1, widget_1, types_1, event_1, dnd_1, touch_1) {
    ...
    class CompositeDragAndDrop {
        ...
        getTargetIndex(targetId, before2d) {
            ...
            const before = this.targetContainerLocation === 1 /* ViewContainerLocation.Panel */ ? before2d === null || before2d === void 0 ? void 0 : before2d.horizontallyBefore : before2d === null || before2d === void 0 ? void 0 : before2d.verticallyBefore;
    ...
    let CompositeBar = class CompositeBar extends widget_1.Widget {
        ...
        create(parent) {
            ...
            this.compositeSwitcherBar = this._register(new actionbar_1.ActionBar(actionBarDiv, {
                actionViewItemProvider: action => {
                    ...
                    return item && this.instantiationService.createInstance(compositeBarActions_1.CompositeActionViewItem, { draggable: true, colors: this.options.colors, icon: this.options.icon, hoverOptions: this.options.activityHoverOptions }, action, item.pinnedAction, compositeId => this.options.getContextMenuActionsForComposite(compositeId), () => this.getContextMenuActions(), this.options.dndHandler, this);
                },
        ...
        updateCompositeSwitcher() {
            ...
            while (size > limit && compositesToShow.length) {
                const removedComposite = compositesToShow.length > 1 && compositesToShow[compositesToShow.length - 1] === ((_a = this.model.activeItem) === null || _a === void 0 ? void 0 : _a.id) ?
        ...
        getOverflowingComposites() {
            ...
            return this.model.visibleItems.filter(c => overflowingIds.includes(c.id)).map(item => { var _a; return { id: item.id, name: ((_a = this.getAction(item.id)) === null || _a === void 0 ? void 0 : _a.label) || item.name }; });
        }
        showContextMenu(e) {
