...
define(["require", "exports", "vs/base/common/async", "vs/base/common/color", "vs/base/common/decorators", "vs/base/common/event", "vs/base/common/lifecycle", "vs/base/common/strings", "vs/platform/telemetry/common/telemetry", "vs/workbench/contrib/terminal/common/terminal"], function (require, exports, async_1, color_1, decorators_1, event_1, lifecycle_1, strings_1, telemetry_1, terminal_1) {
    ...
    class BackspacePrediction {
        ...
        matches(input) {
            var _a;
            if ((_a = this._appliedAt) === null || _a === void 0 ? void 0 : _a.isLastChar) {
    ...
    class PredictionTimeline {
        ...
        peekEnd() {
            var _a;
            return (_a = this._expected[this._expected.length - 1]) === null || _a === void 0 ? void 0 : _a.p;
        }
        /**
        ...
        peekStart() {
            var _a;
            return (_a = this._expected[0]) === null || _a === void 0 ? void 0 : _a.p;
        }
        /**
    ...
    class TypeAheadStyle {
        ...
        _stopTracking() {
            var _a;
            (_a = this._csiHandler) === null || _a === void 0 ? void 0 : _a.dispose();
    ...
    let TypeAheadAddon = class TypeAheadAddon extends lifecycle_1.Disposable {
        constructor(_processManager, _config, _telemetryService) {
            ...
            this._terminalTitle = '';
            this._register((0, lifecycle_1.toDisposable)(() => { var _a; return (_a = this._clearPredictionDebounce) === null || _a === void 0 ? void 0 : _a.dispose(); }));
        }
        activate(terminal) {
            ...
            this._register(this._timeline.onPredictionSucceeded(p => {
                var _a;
                if (((_a = this._lastRow) === null || _a === void 0 ? void 0 : _a.charState) === 1 /* CharPredictState.HasPendingChar */ && (0, exports.isTenativeCharacterPrediction)(p) && p.inner.appliedAt) {
        ...
        _deferClearingPredictions() {
            ...
            (_a = this._clearPredictionDebounce) === null || _a === void 0 ? void 0 : _a.dispose();
            if (this._timeline.length === 0 || ((_b = this._timeline.peekStart()) === null || _b === void 0 ? void 0 : _b.clearAfterTimeout) === false) {
            ...
            this._clearPredictionDebounce = (0, async_1.disposableTimeout)(() => {
                ...
                if (((_b = this._lastRow) === null || _b === void 0 ? void 0 : _b.charState) === 1 /* CharPredictState.HasPendingChar */) {
        ...
        _sendLatencyStats(stats) {
             ...
             */
            this._telemetryService.publicLog('terminalLatencyStats', Object.assign(Object.assign({}, stats.latency), { predictionAccuracy: stats.accuracy }));
        }
        _onUserData(data) {
            var _a, _b, _c, _d;
            if (((_a = this._timeline) === null || _a === void 0 ? void 0 : _a.terminal.buffer.active.type) !== 'normal') {
                return;
            }
            ...
            if (actualY !== ((_d = this._lastRow) === null || _d === void 0 ? void 0 : _d.y)) {
