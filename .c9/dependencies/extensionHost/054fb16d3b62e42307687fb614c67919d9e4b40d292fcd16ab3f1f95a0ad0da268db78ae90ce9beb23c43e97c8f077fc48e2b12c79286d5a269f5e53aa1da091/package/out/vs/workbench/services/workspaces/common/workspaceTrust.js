...
define(["require", "exports", "vs/base/common/event", "vs/base/common/lifecycle", "vs/base/common/linkedList", "vs/base/common/network", "vs/base/common/uri", "vs/platform/configuration/common/configuration", "vs/platform/instantiation/common/extensions", "vs/platform/remote/common/remoteAuthorityResolver", "vs/platform/remote/common/remoteHosts", "vs/platform/workspace/common/virtualWorkspace", "vs/platform/storage/common/storage", "vs/platform/workspace/common/workspace", "vs/platform/workspace/common/workspaceTrust", "vs/workbench/common/memento", "vs/workbench/services/environment/common/environmentService", "vs/platform/uriIdentity/common/uriIdentity", "vs/base/common/resources", "vs/base/common/platform"], function (require, exports, event_1, lifecycle_1, linkedList_1, network_1, uri_1, configuration_1, extensions_1, remoteAuthorityResolver_1, remoteHosts_1, virtualWorkspace_1, storage_1, workspace_1, workspaceTrust_1, memento_1, environmentService_1, uriIdentity_1, resources_1, platform_1) {
    "use strict";
    ...
    class CanonicalWorkspace {
        ...
        get configuration() {
            var _a;
            return (_a = this.canonicalConfiguration) !== null && _a !== void 0 ? _a : this.originalWorkspace.configuration;
        }
        get id() {
    ...
    let WorkspaceTrustManagementService = class WorkspaceTrustManagementService extends lifecycle_1.Disposable {
        constructor(configurationService, remoteAuthorityResolverService, storageService, uriIdentityService, environmentService, workspaceService, workspaceTrustEnablementService) {
            super();
            this.configurationService = configurationService;
            ...
            this._storedTrustState = new WorkspaceTrustMemento(platform_1.isWeb && this.workspaceService.getWorkbenchState() === 1 /* WorkbenchState.EMPTY */ ? undefined : this.storageService);
        ...
        loadTrustInfo() {
            const infoAsString = this.storageService.get(this.storageKey, 0 /* StorageScope.GLOBAL */);
            let result;
            try {
                if (infoAsString) {
        ...
        async saveTrustInfo() {
            this.storageService.store(this.storageKey, JSON.stringify(this._trustStateInfo), 0 /* StorageScope.GLOBAL */, 1 /* StorageTarget.MACHINE */);
            this._onDidChangeTrustedFolders.fire();
            await this.updateWorkspaceTrust();
        }
        getWorkspaceUris() {
        ...
        calculateWorkspaceTrust() {
            ...
            if (this.environmentService.remoteAuthority && ((_b = (_a = this._remoteAuthority) === null || _a === void 0 ? void 0 : _a.options) === null || _b === void 0 ? void 0 : _b.isTrusted)) {
        ...
        isTrustedByRemote(uri) {
            ...
            return ((0, resources_1.isEqualAuthority)((0, remoteHosts_1.getRemoteAuthority)(uri), this._remoteAuthority.authority.authority)) && !!((_a = this._remoteAuthority.options) === null || _a === void 0 ? void 0 : _a.isTrusted);
        }
        set isTrusted(value) {
        ...
        isWorkspaceTrustForced() {
            ...
            if (this.environmentService.remoteAuthority && this._remoteAuthority && ((_a = this._remoteAuthority.options) === null || _a === void 0 ? void 0 : _a.isTrusted) !== undefined) {
                return true;
            }
    ...
    let WorkspaceTrustRequestService = class WorkspaceTrustRequestService extends lifecycle_1.Disposable {
        ...
        resolveWorkspaceTrustRequest(trusted) {
            if (this._workspaceTrustRequestResolver) {
                this._workspaceTrustRequestResolver(trusted !== null && trusted !== void 0 ? trusted : this.workspaceTrustManagementService.isWorkspaceTrusted());
    ...
    class WorkspaceTrustMemento {
        ...
        get acceptsOutOfWorkspaceFiles() {
            var _a;
            return (_a = this._mementoObject[this._acceptsOutOfWorkspaceFilesKey]) !== null && _a !== void 0 ? _a : false;
        }
        set acceptsOutOfWorkspaceFiles(value) {
