...
define(["require", "exports", "assert", "sinon", "vs/base/common/event", "vs/base/common/lifecycle", "vs/base/common/network", "vs/base/common/path", "vs/base/common/platform", "vs/base/common/types", "vs/base/common/uri", "vs/editor/common/core/selection", "vs/editor/common/editorCommon", "vs/platform/configuration/test/common/testConfigurationService", "vs/platform/workspace/test/common/testWorkspace", "vs/workbench/services/configurationResolver/browser/baseConfigurationResolverService", "vs/workbench/services/environment/electron-sandbox/environmentService", "vs/workbench/test/browser/workbenchTestServices", "vs/workbench/test/common/workbenchTestServices", "vs/workbench/test/electron-browser/workbenchTestServices"], function (require, exports, assert, sinon_1, event_1, lifecycle_1, network_1, path_1, platform, types_1, uri_1, selection_1, editorCommon_1, testConfigurationService_1, testWorkspace_1, baseConfigurationResolverService_1, environmentService_1, workbenchTestServices_1, workbenchTestServices_2, workbenchTestServices_3) {
    ...
    suite('Configuration Resolver Service', () => {
        ...
        setup(() => {
            ...
            configurationResolverService = new TestConfigurationResolverService(nullContext, Promise.resolve(environmentService.userEnv), editorService, new MockInputsConfigurationService(), mockCommandService, new workbenchTestServices_2.TestContextService(containingWorkspace), quickInputService, labelService, pathService, extensionService);
        });
        teardown(() => {
        ...
        test('substitute one configuration variable', async () => {
            ...
            let service = new TestConfigurationResolverService(nullContext, Promise.resolve(environmentService.userEnv), new TestEditorServiceWithActiveEditor(), configurationService, mockCommandService, new workbenchTestServices_2.TestContextService(), quickInputService, labelService, pathService, extensionService);
        ...
        test('resolveWithEnvironment', async () => {
            ...
            const resolvedResult = await configurationResolverService.resolveWithEnvironment(Object.assign({}, env), undefined, configuration);
    ...
    class MockPathService {
        ...
        userHome(options) {
            ...
            return (options === null || options === void 0 ? void 0 : options.preferLocal) ? uri : Promise.resolve(uri);
        }
    ...
    class MockWorkbenchEnvironmentService extends environmentService_1.NativeWorkbenchEnvironmentService {
        constructor(userEnv) {
            super(Object.assign(Object.assign({}, workbenchTestServices_3.TestNativeWindowConfiguration), { userEnv }), workbenchTestServices_2.TestProductService);
