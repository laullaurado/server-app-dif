 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/browser/ui/button/button", "vs/base/common/lifecycle", "vs/platform/theme/common/styler"], function (require, exports, button_1, lifecycle_1, styler_1) {
    "use strict";
        ...
        setActions(menu) {
            ...
            for (const group of groups) {
                ...
                for (const action of actions) {
                    const button = new button_1.Button(this.container, { secondary: !isPrimary });
                    isPrimary = false;
                    this._buttonElements.push(button.element);
                    this._toDispose.add(button);
                    this._toDispose.add((0, styler_1.attachButtonStyler)(button, this.themeService));
