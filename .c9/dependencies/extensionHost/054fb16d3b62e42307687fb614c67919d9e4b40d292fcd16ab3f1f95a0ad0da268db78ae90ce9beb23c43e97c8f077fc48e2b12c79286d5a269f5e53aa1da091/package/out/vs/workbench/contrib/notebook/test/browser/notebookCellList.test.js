 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/base/common/lifecycle", "vs/platform/configuration/common/configuration", "vs/workbench/contrib/notebook/common/notebookCommon", "vs/workbench/contrib/notebook/common/notebookExecutionStateService", "vs/workbench/contrib/notebook/common/notebookOptions", "vs/workbench/contrib/notebook/test/browser/testNotebookEditor"], function (require, exports, assert, lifecycle_1, configuration_1, notebookCommon_1, notebookExecutionStateService_1, notebookOptions_1, testNotebookEditor_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    suite('NotebookCellList', () => {
        let disposables;
        let instantiationService;
        let notebookDefaultOptions;
        let topInsertToolbarHeight;
        suiteSetup(() => {
            disposables = new lifecycle_1.DisposableStore();
            instantiationService = (0, testNotebookEditor_1.setupInstantiationService)(disposables);
            notebookDefaultOptions = new notebookOptions_1.NotebookOptions(instantiationService.get(configuration_1.IConfigurationService), instantiationService.get(notebookExecutionStateService_1.INotebookExecutionStateService));
        ...
        test('visibleRanges should be exclusive of end', async function () {
            await (0, testNotebookEditor_1.withTestNotebook)([], async (editor, viewModel) => {
                const cellList = (0, testNotebookEditor_1.createNotebookCellList)(instantiationService);
                cellList.attachViewModel(viewModel);
                // render height 210, it can render 3 full cells and 1 partial cell
