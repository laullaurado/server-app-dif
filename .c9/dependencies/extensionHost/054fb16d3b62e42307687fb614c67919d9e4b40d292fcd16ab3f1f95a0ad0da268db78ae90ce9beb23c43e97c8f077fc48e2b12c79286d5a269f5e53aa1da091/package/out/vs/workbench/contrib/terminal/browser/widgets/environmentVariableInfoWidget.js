...
define(["require", "exports", "vs/base/browser/ui/widget", "vs/base/common/htmlContent", "vs/base/common/async", "vs/platform/configuration/common/configuration", "vs/base/browser/dom", "vs/workbench/services/hover/browser/hover", "vs/platform/theme/common/themeService"], function (require, exports, widget_1, htmlContent_1, async_1, configuration_1, dom, hover_1, themeService_1) {
    "use strict";
    ...
    let EnvironmentVariableInfoWidget = class EnvironmentVariableInfoWidget extends widget_1.Widget {
        ...
        attach(container) {
            ...
            this._domNode.classList.add('terminal-env-var-info', ...themeService_1.ThemeIcon.asClassNameArray(this._info.getIcon()));
            if (this.requiresAction) {
                this._domNode.classList.add('requires-action');
            }
            container.appendChild(this._domNode);
            const scheduler = new async_1.RunOnceScheduler(() => this._showHover(), this._configurationService.getValue('workbench.hover.delay'));
        ...
        _showHover(focus) {
            ...
            if (!this._hoverOptions) {
                ...
                this._hoverOptions = {
                    ...
                    content: new htmlContent_1.MarkdownString(this._info.getInfo()),
                    actions
                };
            }
