 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "sinon", "vs/base/common/event", "vs/workbench/api/common/extHostTreeViews", "vs/workbench/api/common/extHostCommands", "vs/workbench/api/common/extHost.protocol", "vs/workbench/api/test/common/testRPCProtocol", "vs/platform/instantiation/test/common/instantiationServiceMock", "vs/workbench/api/browser/mainThreadCommands", "vs/base/test/common/mock", "vs/workbench/common/views", "vs/platform/log/common/log", "vs/workbench/services/extensions/common/extensions", "vs/base/test/common/timeTravelScheduler"], function (require, exports, assert, sinon, event_1, extHostTreeViews_1, extHostCommands_1, extHost_protocol_1, testRPCProtocol_1, instantiationServiceMock_1, mainThreadCommands_1, mock_1, views_1, log_1, extensions_1, timeTravelScheduler_1) {
    "use strict";
    ...
    suite('ExtHostTreeView', function () {
        ...
        test('construct node tree', () => {
            return testObject.$getChildren('testNodeTreeProvider')
                .then(elements => {
                const actuals = elements === null || elements === void 0 ? void 0 : elements.map(e => e.handle);
                assert.deepStrictEqual(actuals, ['0/0:a', '0/0:b']);
                return Promise.all([
                    testObject.$getChildren('testNodeTreeProvider', '0/0:a')
                        .then(children => {
                        const actuals = children === null || children === void 0 ? void 0 : children.map(e => e.handle);
                        assert.deepStrictEqual(actuals, ['0/0:a/0:aa', '0/0:a/0:ab']);
                        return Promise.all([
                            testObject.$getChildren('testNodeTreeProvider', '0/0:a/0:aa').then(children => assert.strictEqual(children === null || children === void 0 ? void 0 : children.length, 0)),
                            testObject.$getChildren('testNodeTreeProvider', '0/0:a/0:ab').then(children => assert.strictEqual(children === null || children === void 0 ? void 0 : children.length, 0))
                        ]);
                    }),
                    testObject.$getChildren('testNodeTreeProvider', '0/0:b')
                        ...
                        return Promise.all([
                            testObject.$getChildren('testNodeTreeProvider', '0/0:b/0:ba').then(children => assert.strictEqual(children === null || children === void 0 ? void 0 : children.length, 0)),
                            testObject.$getChildren('testNodeTreeProvider', '0/0:b/0:bb').then(children => assert.strictEqual(children === null || children === void 0 ? void 0 : children.length, 0))
                        ]);
                    })
                ]);
            });
            ...
            return testObject.$getChildren('testNodeWithIdTreeProvider')
                ...
                return Promise.all([
                    testObject.$getChildren('testNodeWithIdTreeProvider', '1/a')
                        ...
                        return Promise.all([
                            testObject.$getChildren('testNodeWithIdTreeProvider', '1/aa').then(children => assert.strictEqual(children === null || children === void 0 ? void 0 : children.length, 0)),
                            testObject.$getChildren('testNodeWithIdTreeProvider', '1/ab').then(children => assert.strictEqual(children === null || children === void 0 ? void 0 : children.length, 0))
                        ]);
                    }),
                    testObject.$getChildren('testNodeWithIdTreeProvider', '1/b')
                        ...
                        return Promise.all([
                            testObject.$getChildren('testNodeWithIdTreeProvider', '1/ba').then(children => assert.strictEqual(children === null || children === void 0 ? void 0 : children.length, 0)),
                            testObject.$getChildren('testNodeWithIdTreeProvider', '1/bb').then(children => assert.strictEqual(children === null || children === void 0 ? void 0 : children.length, 0))
                        ]);
                    })
                ]);
            });
        ...
        test('generate unique handles from labels by escaping them', (done) => {
            ...
            target.onRefresh.event(() => {
                testObject.$getChildren('testNodeTreeProvider')
                    .then(elements => {
                    assert.deepStrictEqual(elements === null || elements === void 0 ? void 0 : elements.map(e => e.handle), ['0/0:a//0:b']);
                    done();
                });
            });
            onDidChangeTreeNode.fire(undefined);
        ...
        test('getChildren is not returned from cache if refreshed', (done) => {
            ...
            target.onRefresh.event(() => {
                testObject.$getChildren('testNodeTreeProvider')
                    .then(elements => {
                    assert.deepStrictEqual(elements === null || elements === void 0 ? void 0 : elements.map(e => e.handle), ['0/0:c']);
                    done();
                });
            });
            onDidChangeTreeNode.fire(undefined);
        ...
        test('getChildren is returned from cache if not refreshed', () => {
            ...
            return testObject.$getChildren('testNodeTreeProvider')
                .then(elements => {
                assert.deepStrictEqual(elements === null || elements === void 0 ? void 0 : elements.map(e => e.handle), ['0/0:a', '0/0:b']);
            });
        });
        ...
        function loadCompleteTree(treeId, element) {
            return testObject.$getChildren(treeId, element)
                .then(elements => elements === null || elements === void 0 ? void 0 : elements.map(e => loadCompleteTree(treeId, e.handle)))
                .then(() => null);
        }
