...
define(["require", "exports", "vs/base/common/performance", "vs/base/common/uri", "vs/workbench/api/common/extHost.protocol", "vs/workbench/api/common/extHostConfiguration", "vs/workbench/services/extensions/common/extensions", "vs/platform/extensions/common/extensions", "vs/workbench/api/common/extHostRpcService", "vs/workbench/api/common/extHostInitDataService", "vs/platform/instantiation/common/instantiation", "vs/workbench/api/common/extHostExtensionService", "vs/base/common/process", "vs/platform/log/common/log", "vs/base/common/strings"], function (require, exports, performance, uri_1, extHost_protocol_1, extHostConfiguration_1, extensions_1, extensions_2, extHostRpcService_1, extHostInitDataService_1, instantiation_1, extHostExtensionService_1, process_1, log_1, strings_1) {
     ...
     */
    NodeModuleAliasingModuleFactory.aliased = new Map([
    ...
    let KeytarNodeModuleFactory = class KeytarNodeModuleFactory {
        ...
        load(_request, parent) {
            var _a;
            const ext = this._extensionPaths.findSubstr(parent);
            this._mainThreadTelemetry.$publicLog2('shimming.keytar', { extension: (_a = ext === null || ext === void 0 ? void 0 : ext.identifier.value) !== null && _a !== void 0 ? _a : 'unknown_extension' });
            return this._impl;
        }
        alternativeModuleName(name) {
