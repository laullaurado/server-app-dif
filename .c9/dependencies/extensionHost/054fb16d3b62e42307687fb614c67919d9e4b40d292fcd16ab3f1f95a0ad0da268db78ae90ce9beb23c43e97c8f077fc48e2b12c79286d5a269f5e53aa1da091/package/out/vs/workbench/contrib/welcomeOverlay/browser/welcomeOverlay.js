...
define(["require", "exports", "vs/base/browser/dom", "vs/platform/registry/common/platform", "vs/platform/keybinding/common/keybinding", "vs/workbench/contrib/quickaccess/browser/commandsQuickAccess", "vs/workbench/services/editor/common/editorService", "vs/platform/layout/browser/layoutService", "vs/nls", "vs/base/common/actions", "vs/workbench/common/actions", "vs/platform/actions/common/actions", "vs/platform/commands/common/commands", "vs/base/common/lifecycle", "vs/platform/contextkey/common/contextkey", "vs/platform/instantiation/common/instantiation", "vs/platform/theme/common/themeService", "vs/platform/theme/common/colorRegistry", "vs/base/common/color", "vs/base/common/codicons", "vs/css!./media/welcomeOverlay"], function (require, exports, dom, platform_1, keybinding_1, commandsQuickAccess_1, editorService_1, layoutService_1, nls_1, actions_1, actions_2, actions_3, commands_1, lifecycle_1, contextkey_1, instantiation_1, themeService_1, colorRegistry_1, color_1, codicons_1) {
    ...
    const keys = [
        {
            id: 'explorer',
            arrow: '\u2190',
            label: (0, nls_1.localize)('welcomeOverlay.explorer', "File explorer"),
            command: 'workbench.view.explorer'
        },
        {
            id: 'search',
            arrow: '\u2190',
            label: (0, nls_1.localize)('welcomeOverlay.search', "Search across files"),
            command: 'workbench.view.search'
        },
        {
            id: 'git',
            arrow: '\u2190',
            label: (0, nls_1.localize)('welcomeOverlay.git', "Source code management"),
            command: 'workbench.view.scm'
        },
        {
            id: 'debug',
            arrow: '\u2190',
            label: (0, nls_1.localize)('welcomeOverlay.debug', "Launch and debug"),
            command: 'workbench.view.debug'
        },
        {
            id: 'extensions',
            arrow: '\u2190',
            label: (0, nls_1.localize)('welcomeOverlay.extensions', "Manage extensions"),
        ...
        // },
        {
            id: 'problems',
            arrow: '\u2939',
            label: (0, nls_1.localize)('welcomeOverlay.problems', "View errors and warnings"),
            command: 'workbench.actions.view.problems'
        },
        {
            id: 'terminal',
            label: (0, nls_1.localize)('welcomeOverlay.terminal', "Toggle integrated terminal"),
        ...
        // },
        {
            id: 'commandPalette',
            arrow: '\u2196',
            label: (0, nls_1.localize)('welcomeOverlay.commandPalette', "Find and run all commands"),
        ...
        },
        {
            ...
            arrow: '\u2935',
            arrowLast: true,
            label: (0, nls_1.localize)('welcomeOverlay.notifications', "Show notifications"),
    ...
    WelcomeOverlayAction.LABEL = (0, nls_1.localize)('welcomeOverlay', "User Interface Overview");
    ...
    HideWelcomeOverlayAction.LABEL = (0, nls_1.localize)('hideWelcomeOverlay', "Hide Interface Overview");
    ...
    platform_1.Registry.as(actions_2.Extensions.WorkbenchActions)
        .registerWorkbenchAction(actions_3.SyncActionDescriptor.from(WelcomeOverlayAction), 'Help: User Interface Overview', actions_2.CATEGORIES.Help.value);
    platform_1.Registry.as(actions_2.Extensions.WorkbenchActions)
        .registerWorkbenchAction(actions_3.SyncActionDescriptor.from(HideWelcomeOverlayAction, { primary: 9 /* KeyCode.Escape */ }, OVERLAY_VISIBLE), 'Help: Hide Interface Overview', actions_2.CATEGORIES.Help.value);
    // theming
