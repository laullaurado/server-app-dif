    ...
    let AnythingQuickAccessProvider = class AnythingQuickAccessProvider extends pickerQuickAccess_1.PickerQuickAccessProvider {
                ...
                rememberEditorViewState() {
                    ...
                    if (activeEditorPane) {
                        this.editorViewState = {
                            ...
                            state: (0, types_1.withNullAsUndefined)((_a = (0, editorBrowser_1.getIEditor)(activeEditorPane.getControl())) === null || _a === void 0 ? void 0 : _a.saveViewState())
                        };
                    }
                }
        ...
        get configuration() {
            ...
            return {
                ...
                includeSymbols: searchConfig === null || searchConfig === void 0 ? void 0 : searchConfig.quickOpen.includeSymbols,
                includeHistory: searchConfig === null || searchConfig === void 0 ? void 0 : searchConfig.quickOpen.includeHistory,
                historyFilterSortOrder: searchConfig === null || searchConfig === void 0 ? void 0 : searchConfig.quickOpen.history.filterSortOrder,
        ...
        decorateAndRevealSymbolRange(pick) {
            ...
            if (!this.uriIdentityService.extUri.isEqual(pick.resource, activeEditor === null || activeEditor === void 0 ? void 0 : activeEditor.resource)) {
        ...
        _getPicks(originalFilter, disposables, token) {
            var _a, _b;
            ...
            if (picks && activePick) {
                ...
                const activePickIsNoResultsInEditorSymbols = activePick === AnythingQuickAccessProvider.NO_RESULTS_PICK && filter.indexOf(gotoSymbolQuickAccess_1.GotoSymbolQuickAccessProvider.PREFIX) >= 0;
        ...
        doGetPicks(filter, options, disposables, token) {
            ...
            return {
                ...
                picks: (this.pickState.isQuickNavigating || historyEditorPicks.length === 0) ?
                    historyEditorPicks :
                    [
                        { type: 'separator', label: (0, nls_1.localize)('recentlyOpenedSeparator', "recently opened") },
                        ...historyEditorPicks
                    ],
        ...
        async getAdditionalPicks(query, excludes, token) {
            ...
            const sortedAnythingPicks = (0, arrays_1.top)([...filePicks, ...symbolPicks], (anyPickA, anyPickB) => (0, fuzzyScorer_1.compareItemsByFuzzyScore)(anyPickA, anyPickB, query, true, quickInput_1.quickPickItemScorerAccessor, this.pickState.scorerCache), AnythingQuickAccessProvider.MAX_RESULTS);
            // Perform filtering
        ...
        createAnythingPick(resourceOrEditor, configuration) {
            ...
            return {
                ...
                description,
                iconClasses: (0, getIconClasses_1.getIconClasses)(this.modelService, this.languageService, resource).concat(extraClasses),
                buttons: (() => {
        ...
        async openAnything(resourceOrEditor, options) {
            ...
            const editorOptions = {
                ...
                pinned: ((_a = options.keyMods) === null || _a === void 0 ? void 0 : _a.ctrlCmd) || options.forcePinned || this.configuration.openEditorPinned,
                selection: options.range ? range_1.Range.collapseToStart(options.range) : undefined
            };
            const targetGroup = ((_b = options.keyMods) === null || _b === void 0 ? void 0 : _b.alt) || (this.configuration.openEditorPinned && ((_c = options.keyMods) === null || _c === void 0 ? void 0 : _c.ctrlCmd)) || options.forceOpenSideBySide ? editorService_1.SIDE_GROUP : editorService_1.ACTIVE_GROUP;
            ...
            // Open editor (untyped)
                ...
                if (uri_1.URI.isUri(resourceOrEditor)) {
                    ...
                    resourceEditorInput = Object.assign(Object.assign({}, resourceOrEditor), { options: Object.assign(Object.assign({}, resourceOrEditor.options), editorOptions) });
                }
