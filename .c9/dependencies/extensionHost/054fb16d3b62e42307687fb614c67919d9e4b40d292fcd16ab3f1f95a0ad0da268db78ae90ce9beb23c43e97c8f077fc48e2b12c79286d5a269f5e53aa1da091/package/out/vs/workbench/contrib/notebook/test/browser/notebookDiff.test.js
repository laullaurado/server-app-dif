 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/base/common/buffer", "vs/base/common/diff/diff", "vs/base/common/mime", "vs/platform/configuration/test/common/testConfigurationService", "vs/workbench/contrib/notebook/browser/diff/eventDispatcher", "vs/workbench/contrib/notebook/browser/diff/notebookTextDiffEditor", "vs/workbench/contrib/notebook/common/notebookCommon", "vs/workbench/contrib/notebook/test/browser/testNotebookEditor"], function (require, exports, assert, buffer_1, diff_1, mime_1, testConfigurationService_1, eventDispatcher_1, notebookTextDiffEditor_1, notebookCommon_1, testNotebookEditor_1) {
    "use strict";
    ...
    suite('NotebookCommon', () => {
        ...
        test('diff different source', async () => {
            await (0, testNotebookEditor_1.withTestNotebookDiffModel)([
                ...
                const diffViewModels = notebookTextDiffEditor_1.NotebookTextDiffEditor.computeDiff(accessor, configurationService, model, eventDispatcher, {
        ...
        test('diff insert', async () => {
            await (0, testNotebookEditor_1.withTestNotebookDiffModel)([
                ...
                const eventDispatcher = new eventDispatcher_1.NotebookDiffEditorEventDispatcher();
                const diffResult = notebookTextDiffEditor_1.NotebookTextDiffEditor.computeDiff(accessor, configurationService, model, eventDispatcher, {
                    cellsDiff: {
                        changes: [{
                                originalStart: 0,
                                originalLength: 0,
