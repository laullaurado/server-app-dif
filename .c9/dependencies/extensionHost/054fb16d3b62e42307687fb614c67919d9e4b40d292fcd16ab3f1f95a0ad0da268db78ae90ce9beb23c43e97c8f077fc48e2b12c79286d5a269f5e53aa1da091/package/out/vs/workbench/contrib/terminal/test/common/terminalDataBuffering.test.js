 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/base/common/event", "vs/platform/terminal/common/terminalDataBuffering"], function (require, exports, assert, event_1, terminalDataBuffering_1) {
    "use strict";
    ...
    suite('Workbench - TerminalDataBufferer', () => {
        ...
        setup(async () => {
            counter = {};
            data = {};
            bufferer = new terminalDataBuffering_1.TerminalDataBufferer((id, e) => {
                if (!(id in counter)) {
                    counter[id] = 0;
                }
                counter[id]++;
