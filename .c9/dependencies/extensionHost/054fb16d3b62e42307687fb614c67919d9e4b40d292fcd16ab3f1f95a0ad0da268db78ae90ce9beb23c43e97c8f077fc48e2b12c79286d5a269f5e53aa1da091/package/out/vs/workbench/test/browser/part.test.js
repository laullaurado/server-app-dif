 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/workbench/browser/part", "vs/base/common/types", "vs/platform/theme/test/common/testThemeService", "vs/base/browser/dom", "vs/workbench/test/browser/workbenchTestServices", "vs/workbench/test/common/workbenchTestServices"], function (require, exports, assert, part_1, types_1, testThemeService_1, dom_1, workbenchTestServices_1, workbenchTestServices_2) {
    "use strict";
    ...
    suite('Workbench parts', () => {
        ...
        class MyPart extends SimplePart {
            constructor(expectedParent) {
                super('myPart', { hasTitle: true }, new testThemeService_1.TestThemeService(), new workbenchTestServices_2.TestStorageService(), new workbenchTestServices_1.TestLayoutService());
        ...
        class MyPart2 extends SimplePart {
            constructor() {
                super('myPart2', { hasTitle: true }, new testThemeService_1.TestThemeService(), new workbenchTestServices_2.TestStorageService(), new workbenchTestServices_1.TestLayoutService());
            }
            createTitleArea(parent) {
        ...
        class MyPart3 extends SimplePart {
            constructor() {
                super('myPart2', { hasTitle: false }, new testThemeService_1.TestThemeService(), new workbenchTestServices_2.TestStorageService(), new workbenchTestServices_1.TestLayoutService());
            }
            createTitleArea(parent) {
                return null;
            }
        ...
        test('Creation', () => {
            ...
            // Memento
            let memento = part.getMemento(0 /* StorageScope.GLOBAL */, 1 /* StorageTarget.MACHINE */);
            assert(memento);
            memento.foo = 'bar';
            memento.bar = [1, 2, 3];
            part.saveState();
            ...
            part = new MyPart(b);
            memento = part.getMemento(0 /* StorageScope.GLOBAL */, 1 /* StorageTarget.MACHINE */);
            assert(memento);
