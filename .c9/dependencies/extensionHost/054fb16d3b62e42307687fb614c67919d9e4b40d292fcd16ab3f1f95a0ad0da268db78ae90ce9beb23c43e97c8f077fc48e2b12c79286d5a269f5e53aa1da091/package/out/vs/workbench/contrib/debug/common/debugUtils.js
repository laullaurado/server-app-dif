 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/common/strings", "vs/base/common/uri", "vs/base/common/path", "vs/base/common/objects", "vs/base/common/network"], function (require, exports, strings_1, uri_1, path_1, objects_1, network_1) {
    "use strict";
    ...
    async function saveAllBeforeDebugStart(configurationService, editorService) {
        ...
        if (saveBeforeStartConfig !== 'none') {
            ...
            if (saveBeforeStartConfig === 'allEditorsInActiveGroup') {
                ...
                if (activeEditor && ((_a = activeEditor.input.resource) === null || _a === void 0 ? void 0 : _a.scheme) === network_1.Schemas.untitled) {
