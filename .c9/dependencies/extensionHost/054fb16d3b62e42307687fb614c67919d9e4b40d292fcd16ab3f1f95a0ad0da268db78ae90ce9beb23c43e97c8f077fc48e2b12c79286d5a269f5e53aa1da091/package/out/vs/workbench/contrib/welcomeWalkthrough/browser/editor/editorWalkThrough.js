...
define(["require", "exports", "vs/nls", "vs/workbench/services/editor/common/editorService", "vs/base/common/actions", "vs/platform/instantiation/common/instantiation", "vs/workbench/contrib/welcomeWalkthrough/browser/walkThroughInput", "vs/base/common/network", "vs/platform/editor/common/editor", "vs/workbench/contrib/welcomeWalkthrough/browser/editor/vs_code_editor_walkthrough"], function (require, exports, nls_1, editorService_1, actions_1, instantiation_1, walkThroughInput_1, network_1, editor_1) {
    ...
    let EditorWalkThroughAction = class EditorWalkThroughAction extends actions_1.Action {
        ...
        run() {
            ...
            return this.editorService.openEditor(input, { pinned: true, override: editor_1.EditorResolution.DISABLED })
                .then(() => void (0));
        }
    };
    EditorWalkThroughAction.ID = 'workbench.action.showInteractivePlayground';
    EditorWalkThroughAction.LABEL = (0, nls_1.localize)('editorWalkThrough', "Interactive Editor Playground");
