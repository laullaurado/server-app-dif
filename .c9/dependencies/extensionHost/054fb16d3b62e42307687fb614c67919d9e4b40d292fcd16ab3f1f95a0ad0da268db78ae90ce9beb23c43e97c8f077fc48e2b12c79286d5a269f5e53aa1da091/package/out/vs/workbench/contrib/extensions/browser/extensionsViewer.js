            ...
            super('ExtensionsTree', container, delegate, renderers, dataSource, {
                ...
                accessibilityProvider: {
                    getAriaLabel(extensionData) {
                        ...
                        return (0, nls_1.localize)('extension.arialabel', "{0}, {1}, {2}, {3}", extension.displayName, extension.version, extension.publisherDisplayName, extension.description);
                    },
                    getWidgetAriaLabel() {
