...
define(["require", "exports", "net", "minimist", "vs/base/common/performance", "vs/base/common/errors", "vs/base/parts/ipc/common/ipc.net", "vs/base/parts/ipc/node/ipc.net", "vs/platform/product/common/product", "vs/workbench/services/extensions/common/extensionHostProtocol", "vs/workbench/api/common/extensionHostMain", "vs/base/common/buffer", "vs/base/node/pfs", "vs/base/node/extpath", "vs/base/common/async", "vs/editor/common/config/editorOptions", "vs/workbench/api/node/uriTransformer", "vs/workbench/api/common/extHost.common.services", "vs/workbench/api/node/extHost.node.services"], function (require, exports, net, minimist, performance, errors_1, ipc_net_1, ipc_net_2, product_1, extensionHostProtocol_1, extensionHostMain_1, buffer_1, pfs_1, extpath_1, async_1, editorOptions_1, uriTransformer_1) {
    ...
    function _createExtHostProtocol() {
        if (process.env.VSCODE_WILL_SEND_MESSAGE_PORT) {
            return new Promise((resolve, reject) => {
                ...
                if (global.vscodePorts) {
                    const ports = global.vscodePorts;
                    delete global.vscodePorts;
                    withPorts(ports);
                }
                else {
                    global.vscodePortsCallback = withPorts;
                }
            });
        }
            ...
            return new Promise((resolve, reject) => {
                const socket = net.createConnection(pipeName, () => {
                    ...
                    const protocol = new ipc_net_1.PersistentProtocol(new ipc_net_2.NodeSocket(socket, 'extHost-renderer'));
                    protocol.sendResume();
                    resolve(protocol);
                });
    ...
    async function startExtensionHostProcess() {
        ...
        const hostUtils = new class NodeHost {
            ...
            exists(path) { return pfs_1.Promises.exists(path); }
