    ...
    (0, testUtils_1.flakySuite)('TextSearch-integration', function () {
        ...
        test('Search with context matches', () => {
            ...
            return doSearchTest(config, 4).then(results => {
                ...
                assert.strictEqual(results[0].results[0].lineNumber, 25);
                ...
                assert.strictEqual(results[2].results[0].lineNumber, 27);
                assert.strictEqual(results[2].results[0].text, '        compiler.emit();');
                assert.strictEqual(results[3].results[0].lineNumber, 28);
        ...
        suite('error messages', () => {
            test('invalid encoding', () => {
                const config = {
                    type: 2 /* QueryType.Text */,
                    folderQueries: [
                        Object.assign(Object.assign({}, TEST_ROOT_FOLDER), { fileEncoding: 'invalidEncoding' })
                    ],
