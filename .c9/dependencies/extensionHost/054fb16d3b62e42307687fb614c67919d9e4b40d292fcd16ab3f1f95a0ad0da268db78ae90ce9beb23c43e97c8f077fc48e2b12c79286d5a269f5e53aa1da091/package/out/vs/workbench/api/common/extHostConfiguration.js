        ...
        getConfiguration(section, scope, extensionDescription) {
            ...
            function parseConfigurationTarget(arg) {
                ...
                if (typeof arg === 'boolean') {
                    return arg ? 1 /* ConfigurationTarget.USER */ : 4 /* ConfigurationTarget.WORKSPACE */;
                }
                switch (arg) {
                    case extHostTypes_1.ConfigurationTarget.Global: return 1 /* ConfigurationTarget.USER */;
                    case extHostTypes_1.ConfigurationTarget.Workspace: return 4 /* ConfigurationTarget.WORKSPACE */;
                    case extHostTypes_1.ConfigurationTarget.WorkspaceFolder: return 5 /* ConfigurationTarget.WORKSPACE_FOLDER */;
                }
            }
            const result = {
                has(key) {
                ...
                inspect: (key) => {
                    ...
                    if (config) {
                        return {
                            key,
                            defaultValue: (_b = (_a = config.policy) === null || _a === void 0 ? void 0 : _a.value) !== null && _b !== void 0 ? _b : (_c = config.default) === null || _c === void 0 ? void 0 : _c.value,
                            globalValue: (_d = config.user) === null || _d === void 0 ? void 0 : _d.value,
                            workspaceValue: (_e = config.workspace) === null || _e === void 0 ? void 0 : _e.value,
                            workspaceFolderValue: (_f = config.workspaceFolder) === null || _f === void 0 ? void 0 : _f.value,
                            defaultLanguageValue: (_g = config.default) === null || _g === void 0 ? void 0 : _g.override,
                            globalLanguageValue: (_h = config.user) === null || _h === void 0 ? void 0 : _h.override,
                            workspaceLanguageValue: (_j = config.workspace) === null || _j === void 0 ? void 0 : _j.override,
                            workspaceFolderLanguageValue: (_k = config.workspaceFolder) === null || _k === void 0 ? void 0 : _k.override,
