        ...
        self.XMLHttpRequest = class extends XMLHttpRequest {
            open(method, url, async, username, password) {
                (async () => {
                    ...
                    super.open(method, url, async !== null && async !== void 0 ? async : true, username, password);
                })();
            }
        };
    }
    ...
    if (self.Worker) {
        ...
        Worker = function (stringUrl, options) {
            ...
            const bootstrapFnSource = (function bootstrapFn(workerUrl) {
                ...
                self.XMLHttpRequest = class extends XMLHttpRequest {
                    open(method, url, async, username, password) {
                        return super.open(method, asWorkerBrowserUrl(url), async !== null && async !== void 0 ? async : true, username, password);
                    }
                };
