...
define(["require", "exports", "vs/nls", "vs/base/common/codicons", "vs/platform/theme/common/iconRegistry", "vs/workbench/contrib/notebook/common/notebookCommon", "vs/workbench/contrib/welcomeGettingStarted/common/media/theme_picker", "vs/workbench/contrib/welcomeGettingStarted/common/media/notebookProfile"], function (require, exports, nls_1, codicons_1, iconRegistry_1, notebookCommon_1) {
    ...
    exports.startEntries = [
        {
            ...
            description: (0, nls_1.localize)('gettingStarted.newFile.description', "Open a new untitled file, notebook, or custom editor."),
        ...
        },
        {
            ...
            title: (0, nls_1.localize)('gettingStarted.topLevelVideoTutorials.title', "Watch Video Tutorials"),
            description: (0, nls_1.localize)('gettingStarted.topLevelVideoTutorials.description', "Watch our series of short & practical video tutorials for VS Code's key features."),
            icon: codicons_1.Codicon.playCircle,
    ...
    exports.walkthroughs = [
        ...
        {
            id: 'SetupWeb',
            title: (0, nls_1.localize)('gettingStarted.setupWeb.title', "Get Started with VS Code in the Web"),
            description: (0, nls_1.localize)('gettingStarted.setupWeb.description', "Discover the best customizations to make VS Code in the Web yours."),
            isFeatured: true,
            icon: setupIcon,
            when: 'isWeb',
            next: 'Beginner',
            content: {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        description: (0, nls_1.localize)('gettingStarted.menuBar.description.interpolated', "The full menu bar is available in the dropdown menu to make room for your code. Toggle its apperance for faster access. \n{0}", Button((0, nls_1.localize)('toggleMenuBar', "Toggle Menu Bar"), 'command:workbench.action.toggleMenuBar')),
                        when: 'isWeb',
                        media: {
            ...
            content: {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        description: (0, nls_1.localize)('gettingStarted.installGit.description.interpolated', "Install Git to track changes in your projects.\n{0}", Button((0, nls_1.localize)('installGit', "Install Git"), 'https://aka.ms/vscode-install-git')),
                        when: 'git.missing',
                        media: {
