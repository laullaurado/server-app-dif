 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/common/resources", "vs/editor/common/core/range", "vs/platform/markers/common/markers", "vs/base/common/arrays", "vs/base/common/map", "vs/base/common/event", "vs/base/common/hash", "vs/base/common/types", "vs/base/common/strings"], function (require, exports, resources_1, range_1, markers_1, arrays_1, map_1, event_1, hash_1, types_1, strings_1) {
    "use strict";
    ...
    class MarkersModel {
        ...
        getResourceMarkers(resource) {
            return (0, types_1.withUndefinedAsNull)(this.resourcesByUri.get(resources_1.extUri.getComparisonKey(resource, true)));
        }
