...
define(["require", "exports", "vs/nls", "vs/base/common/arrays", "vs/base/common/strings", "vs/base/common/platform", "vs/base/common/filters", "vs/platform/registry/common/platform", "vs/base/common/keybindingLabels", "vs/platform/actions/common/actions", "vs/workbench/common/actions", "vs/workbench/common/editor/editorModel", "vs/platform/keybinding/common/keybinding", "vs/platform/keybinding/common/resolvedKeybindingItem", "vs/workbench/services/keybinding/browser/unboundCommands"], function (require, exports, nls_1, arrays_1, strings, platform_1, filters_1, platform_2, keybindingLabels_1, actions_1, actions_2, editorModel_1, keybinding_1, resolvedKeybindingItem_1, unboundCommands_1) {
    ...
    const SOURCE_DEFAULT = (0, nls_1.localize)('default', "Default");
    ...
    let KeybindingsEditorModel = class KeybindingsEditorModel extends editorModel_1.EditorModel {
        ...
        fetch(searchValue, sortByPrecedence = false) {
            ...
            if (commandIdMatches && commandIdMatches[1]) {
                return keybindingItems.filter(k => k.command === commandIdMatches[1])
                    .map(keybindingItem => ({ id: KeybindingsEditorModel.getId(keybindingItem), keybindingItem, templateId: exports.KEYBINDING_ENTRY_TEMPLATE_ID }));
            }
        ...
        async resolve(actionLabels = new Map()) {
            ...
            this._keybindingItemsSortedByPrecedence = (0, arrays_1.distinct)(this._keybindingItemsSortedByPrecedence, keybindingItem => KeybindingsEditorModel.getId(keybindingItem));
