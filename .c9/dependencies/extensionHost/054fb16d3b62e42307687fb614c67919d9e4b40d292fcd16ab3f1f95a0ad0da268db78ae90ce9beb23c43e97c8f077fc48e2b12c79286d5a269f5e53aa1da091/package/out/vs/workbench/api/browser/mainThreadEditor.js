        ...
        generateDelta(oldProps, selectionChangeSource) {
            ...
            if (!oldProps || !MainThreadTextEditorProperties._selectionsEqual(oldProps.selections, this.selections)) {
                delta.selections = {
                    ...
                    source: (0, types_1.withNullAsUndefined)(selectionChangeSource)
                };
            }
