...
define(["require", "exports", "vs/base/common/async", "vs/base/browser/dom", "vs/base/common/actions", "vs/platform/contextview/browser/contextView", "vs/workbench/contrib/markers/browser/messages", "vs/platform/theme/common/themeService", "vs/platform/theme/common/styler", "vs/base/common/lifecycle", "vs/base/browser/ui/actionbar/actionbar", "vs/platform/theme/common/colorRegistry", "vs/nls", "vs/platform/instantiation/common/instantiation", "vs/platform/history/browser/contextScopedHistoryWidget", "vs/platform/contextkey/common/contextkey", "vs/base/common/event", "vs/base/common/codicons", "vs/base/browser/ui/actionbar/actionViewItems", "vs/base/browser/ui/dropdown/dropdownActionViewItem", "vs/platform/theme/common/iconRegistry", "vs/platform/keybinding/common/keybinding", "vs/platform/history/browser/historyWidgetKeybindingHint", "vs/workbench/contrib/markers/common/markers"], function (require, exports, async_1, DOM, actions_1, contextView_1, messages_1, themeService_1, styler_1, lifecycle_1, actionbar_1, colorRegistry_1, nls_1, instantiation_1, contextScopedHistoryWidget_1, contextkey_1, event_1, codicons_1, actionViewItems_1, dropdownActionViewItem_1, iconRegistry_1, keybinding_1, historyWidgetKeybindingHint_1, markers_1) {
    ...
    const filterIcon = (0, iconRegistry_1.registerIcon)('markers-view-filter', codicons_1.Codicon.filter, (0, nls_1.localize)('filterIcon', 'Icon for the filter configuration in the markers view.'));
    let MarkersFilterActionViewItem = class MarkersFilterActionViewItem extends actionViewItems_1.BaseActionViewItem {
        constructor(action, markersView, instantiationService, contextViewService, themeService, contextKeyService, keybindingService) {
            super(null, action);
            ...
            this.focusContextKey = markers_1.MarkersContextKeys.MarkerViewFilterFocusContextKey.bindTo(contextKeyService);
        ...
        updateBadge() {
            if (this.filterBadge) {
                ...
                this.filterBadge.textContent = (0, nls_1.localize)('showing filtered problems', "Showing {0} of {1}", filtered, total);
                this.adjustInputBox();
            }
        }
        adjustInputBox() {
