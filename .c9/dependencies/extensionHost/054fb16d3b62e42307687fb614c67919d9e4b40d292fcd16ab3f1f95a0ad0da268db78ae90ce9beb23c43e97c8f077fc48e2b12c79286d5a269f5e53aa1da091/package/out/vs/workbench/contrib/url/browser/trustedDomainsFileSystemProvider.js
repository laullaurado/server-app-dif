...
`;
    ...
    let TrustedDomainsFileSystemProvider = class TrustedDomainsFileSystemProvider {
        ...
        async readFile(resource) {
            let trustedDomainsContent = this.storageService.get(trustedDomains_1.TRUSTED_DOMAINS_CONTENT_STORAGE_KEY, 0 /* StorageScope.GLOBAL */);
        ...
        writeFile(resource, content, opts) {
            try {
                ...
                this.storageService.store(trustedDomains_1.TRUSTED_DOMAINS_CONTENT_STORAGE_KEY, trustedDomainsContent, 0 /* StorageScope.GLOBAL */, 0 /* StorageTarget.USER */);
                this.storageService.store(trustedDomains_1.TRUSTED_DOMAINS_STORAGE_KEY, JSON.stringify(trustedDomains) || '', 0 /* StorageScope.GLOBAL */, 0 /* StorageTarget.USER */);
            }
            catch (err) { }
