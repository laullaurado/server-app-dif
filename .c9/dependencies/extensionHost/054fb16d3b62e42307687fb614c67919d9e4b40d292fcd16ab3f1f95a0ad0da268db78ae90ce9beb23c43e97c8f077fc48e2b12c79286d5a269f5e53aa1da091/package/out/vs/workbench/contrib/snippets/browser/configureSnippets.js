...
define(["require", "exports", "vs/nls", "vs/platform/environment/common/environment", "vs/editor/common/languages/language", "vs/base/common/path", "vs/platform/actions/common/actions", "vs/platform/opener/common/opener", "vs/base/common/uri", "vs/workbench/contrib/snippets/browser/snippets.contribution", "vs/platform/quickinput/common/quickInput", "vs/platform/workspace/common/workspace", "vs/platform/files/common/files", "vs/workbench/services/textfile/common/textfiles", "vs/base/common/extpath", "vs/base/common/resources"], function (require, exports, nls, environment_1, language_1, path_1, actions_1, opener_1, uri_1, snippets_contribution_1, quickInput_1, workspace_1, files_1, textfiles_1, extpath_1, resources_1) {
    ...
    async function computePicks(snippetService, envService, languageService) {
        const existing = [];
        const future = [];
        const seen = new Set();
    ...
    (0, actions_1.registerAction2)(class ConfigureSnippets extends actions_1.Action2 {
        constructor() {
            super({
                ...
                menu: [
                    ...
                    { id: actions_1.MenuId.MenubarPreferencesMenu, group: '3_snippets', order: 1 },
                    { id: actions_1.MenuId.GlobalActivity, group: '3_snippets', order: 1 },
                ]
            });
        }
