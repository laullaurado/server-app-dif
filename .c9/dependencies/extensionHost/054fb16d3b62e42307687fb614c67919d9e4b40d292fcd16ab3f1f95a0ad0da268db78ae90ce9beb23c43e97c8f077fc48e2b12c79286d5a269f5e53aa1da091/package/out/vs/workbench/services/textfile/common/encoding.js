...
define(["require", "exports", "vs/base/common/stream", "vs/base/common/buffer"], function (require, exports, stream_1, buffer_1) {
    ...
    })(DecodeStreamErrorKind = exports.DecodeStreamErrorKind || (exports.DecodeStreamErrorKind = {}));
    ...
    class DecoderStream {
        ...
        static async create(encoding) {
            ...
            if (encoding !== exports.UTF8) {
                const iconv = await new Promise((resolve_1, reject_1) => { require(['@vscode/iconv-lite-umd'], resolve_1, reject_1); });
        ...
        return new Promise((resolve, reject) => {
            ...
            const createDecoder = async () => {
                try {
                    ...
                    sourceListener === null || sourceListener === void 0 ? void 0 : sourceListener.dispose();
                    target.destroy();
                    reject(error);
                }
            };
            sourceListener = (0, stream_1.listenStream)(source, {
                onData: async (chunk) => {
    ...
    async function toEncodeReadable(readable, encoding, options) {
        const iconv = await new Promise((resolve_2, reject_2) => { require(['@vscode/iconv-lite-umd'], resolve_2, reject_2); });
    ...
    async function encodingExists(encoding) {
        const iconv = await new Promise((resolve_3, reject_3) => { require(['@vscode/iconv-lite-umd'], resolve_3, reject_3); });
