...
define(["require", "exports", "assert", "vs/workbench/api/common/extHostDocumentsAndEditors", "vs/workbench/api/test/common/testRPCProtocol", "vs/base/common/lifecycle", "vs/platform/log/common/log", "vs/base/test/common/mock", "vs/workbench/api/common/extHost.protocol", "vs/workbench/api/common/extHostNotebook", "vs/workbench/contrib/notebook/common/notebookCommon", "vs/base/common/uri", "vs/workbench/api/common/extHostDocuments", "vs/workbench/api/common/extHostCommands", "vs/workbench/services/extensions/common/extensions", "vs/base/common/resources", "vs/base/common/uuid", "vs/base/common/event", "vs/workbench/api/common/extHostNotebookDocuments", "vs/workbench/services/extensions/common/proxyIdentifier", "vs/base/common/buffer"], function (require, exports, assert, extHostDocumentsAndEditors_1, testRPCProtocol_1, lifecycle_1, log_1, mock_1, extHost_protocol_1, extHostNotebook_1, notebookCommon_1, uri_1, extHostDocuments_1, extHostCommands_1, extensions_1, resources_1, uuid_1, event_1, extHostNotebookDocuments_1, proxyIdentifier_1, buffer_1) {
    ...
    suite('NotebookCell#Document', function () {
        ...
        setup(async function () {
            ...
            extHostNotebooks = new extHostNotebook_1.ExtHostNotebookController(rpcProtocol, new extHostCommands_1.ExtHostCommands(rpcProtocol, new log_1.NullLogService()), extHostDocumentsAndEditors, extHostDocuments, extHostStoragePaths);
