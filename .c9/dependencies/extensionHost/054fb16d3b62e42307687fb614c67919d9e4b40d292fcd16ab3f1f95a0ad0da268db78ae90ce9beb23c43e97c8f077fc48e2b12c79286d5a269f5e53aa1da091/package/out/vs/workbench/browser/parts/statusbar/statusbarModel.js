 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/common/lifecycle", "vs/workbench/services/statusbar/browser/statusbar", "vs/base/browser/dom", "vs/base/common/event", "vs/platform/registry/common/platform", "vs/workbench/services/profiles/common/profileStorageRegistry", "vs/nls"], function (require, exports, lifecycle_1, statusbar_1, dom_1, event_1, platform_1, profileStorageRegistry_1, nls_1) {
    "use strict";
    ...
    class StatusbarViewModel extends lifecycle_1.Disposable {
        constructor(storageService) {
            ...
            platform_1.Registry.as(profileStorageRegistry_1.Extensions.ProfileStorageRegistry)
                .registerKeys([{
                    ...
                    description: (0, nls_1.localize)('statusbar.hidden', "Status bar entries visibility customizations"),
                }]);
        }
        ...
        restoreState() {
            const hiddenRaw = this.storageService.get(StatusbarViewModel.HIDDEN_ENTRIES_KEY, 0 /* StorageScope.GLOBAL */);
            if (hiddenRaw) {
                try {
        ...
        onDidStorageValueChange(event) {
            if (event.key === StatusbarViewModel.HIDDEN_ENTRIES_KEY && event.scope === 0 /* StorageScope.GLOBAL */) {
        ...
        saveState() {
            if (this.hidden.size > 0) {
                this.storageService.store(StatusbarViewModel.HIDDEN_ENTRIES_KEY, JSON.stringify(Array.from(this.hidden.values())), 0 /* StorageScope.GLOBAL */, 0 /* StorageTarget.USER */);
            }
            else {
                this.storageService.remove(StatusbarViewModel.HIDDEN_ENTRIES_KEY, 0 /* StorageScope.GLOBAL */);
            }
        }
        sort() {
