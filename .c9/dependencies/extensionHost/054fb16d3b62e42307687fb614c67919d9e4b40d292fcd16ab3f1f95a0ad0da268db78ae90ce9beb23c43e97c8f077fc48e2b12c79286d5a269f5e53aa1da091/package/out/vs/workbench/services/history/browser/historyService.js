...
define(["require", "exports", "vs/nls", "vs/base/common/uri", "vs/workbench/common/editor", "vs/workbench/services/editor/common/editorService", "vs/workbench/services/history/common/history", "vs/platform/files/common/files", "vs/platform/workspace/common/workspace", "vs/base/common/lifecycle", "vs/platform/storage/common/storage", "vs/base/common/event", "vs/platform/configuration/common/configuration", "vs/workbench/services/editor/common/editorGroupsService", "vs/workbench/services/search/common/search", "vs/platform/instantiation/common/instantiation", "vs/workbench/services/layout/browser/layoutService", "vs/platform/contextkey/common/contextkey", "vs/base/common/arrays", "vs/platform/instantiation/common/extensions", "vs/base/browser/dom", "vs/platform/workspaces/common/workspaces", "vs/base/common/network", "vs/base/common/errors", "vs/base/common/async", "vs/workbench/common/resources", "vs/workbench/services/path/common/pathService", "vs/platform/uriIdentity/common/uriIdentity", "vs/workbench/services/lifecycle/common/lifecycle", "vs/platform/log/common/log"], function (require, exports, nls_1, uri_1, editor_1, editorService_1, history_1, files_1, workspace_1, lifecycle_1, storage_1, event_1, configuration_1, editorGroupsService_1, search_1, instantiation_1, layoutService_1, contextkey_1, arrays_1, extensions_1, dom_1, workspaces_1, network_1, errors_1, async_1, resources_1, pathService_1, uriIdentity_1, lifecycle_2, log_1) {
    ...
    let HistoryService = class HistoryService extends lifecycle_1.Disposable {
        ...
        registerMouseNavigationListener() {
            ...
            const handleMouseBackForwardSupport = () => {
                ...
                if (this.configurationService.getValue(HistoryService.MOUSE_NAVIGATION_SETTING)) {
                    mouseBackForwardSupportListener.add((0, dom_1.addDisposableListener)(this.layoutService.container, dom_1.EventType.MOUSE_DOWN, e => this.onMouseDown(e)));
                }
            };
        ...
        getStack(group = this.editorGroupService.activeGroup, editor = group.activeEditor) {
            ...
            switch (this.editorNavigationScope) {
                ...
                case 2 /* GoScope.EDITOR */: {
                    ...
                    let stack = (_a = stacksForGroup.get(editor)) === null || _a === void 0 ? void 0 : _a.stack;
                    if (!stack) {
                ...
                case 1 /* GoScope.EDITOR_GROUP */: {
                    let stack = (_b = this.editorGroupScopedNavigationStacks.get(group.id)) === null || _b === void 0 ? void 0 : _b.stack;
                    if (!stack) {
                        const disposable = new lifecycle_1.DisposableStore();
        ...
        handleActiveEditorChangeInNavigationStacks(group, editorPane) {
            this.getStack(group, editorPane === null || editorPane === void 0 ? void 0 : editorPane.input).handleActiveEditorChange(editorPane);
        }
        ...
        handleEditorGroupRemoveInNavigationStacks(group) {
            var _a;
            // Global
            (_a = this.defaultScopedEditorNavigationStack) === null || _a === void 0 ? void 0 : _a.remove(group.id);
            // Editor groups
        ...
        disposeEditorNavigationStacks() {
            var _a;
            // Global
            (_a = this.defaultScopedEditorNavigationStack) === null || _a === void 0 ? void 0 : _a.dispose();
            this.defaultScopedEditorNavigationStack = undefined;
            // Per Editor group
        ...
        async doNavigateInRecentlyUsedEditorsStack(editorIdentifier, groupId) {
            ...
            if (editorIdentifier) {
                ...
                const group = (_a = this.editorGroupService.getGroup(editorIdentifier.groupId)) !== null && _a !== void 0 ? _a : this.editorGroupService.activeGroup;
                try {
        ...
        async doReopenLastClosedEditor(lastClosedEditor) {
            ...
            if (!this.editorGroupService.activeGroup.contains(lastClosedEditor.editor)) {
                ...
                try {
                    editorPane = await this.editorService.openEditor(Object.assign(Object.assign({}, lastClosedEditor.editor), { options: Object.assign(Object.assign({}, lastClosedEditor.editor.options), options) }));
                }
                finally {
                    this.ignoreEditorCloseEvent = false;
                }
        ...
        handleActiveEditorChangeInHistory(editorPane) {
            ...
            const editor = editorPane === null || editorPane === void 0 ? void 0 : editorPane.input;
        ...
        loadHistory() {
            ...
            for (const editor of storedEditorHistory) {
                if (!handledEditors.has(`${editor.resource.toString()}/${(_a = editor.options) === null || _a === void 0 ? void 0 : _a.override}`)) {
            ...
            if (entriesRaw) {
                try {
                    ...
                    for (const entryParsed of entriesParsed) {
                        try {
                            entries.push(Object.assign(Object.assign({}, entryParsed.editor), { resource: typeof entryParsed.editor.resource === 'string' ?
        ...
        saveState() {
            ...
            for (const editor of this.history) {
                ...
                entries.push({
                    editor: Object.assign(Object.assign({}, editor), { resource: editor.resource.toString() })
                });
            }
    ...
    HistoryService.MOUSE_NAVIGATION_SETTING = 'workbench.editor.mouseBackForwardToNavigate';
    ...
    (0, extensions_1.registerSingleton)(history_1.IHistoryService, HistoryService);
    ...
    let EditorNavigationStack = class EditorNavigationStack extends lifecycle_1.Disposable {
        ...
        traceStack() {
            ...
            for (const entry of this.stack) {
                if (typeof ((_a = entry.selection) === null || _a === void 0 ? void 0 : _a.log) === 'function') {
                    entryLabels.push(`- group: ${entry.groupId}, editor: ${(_b = entry.editor.resource) === null || _b === void 0 ? void 0 : _b.toString()}, selection: ${entry.selection.log()}`);
                }
                else {
                    entryLabels.push(`- group: ${entry.groupId}, editor: ${(_c = entry.editor.resource) === null || _c === void 0 ? void 0 : _c.toString()}, selection: <none>`);
                }
            }
...
${entryLabels.join('\n')}
        ...
        trace(msg, editor = null, event) {
            ...
            if (editor !== null) {
                this.logService.trace(`[History stack ${filterLabel}-${scopeLabel}]: ${msg} (editor: ${(_a = editor === null || editor === void 0 ? void 0 : editor.resource) === null || _a === void 0 ? void 0 : _a.toString()}, event: ${this.traceEvent(event)})`);
            }
            else {
        ...
        notifyNavigation(editorPane, event) {
            this.trace('notifyNavigation()', editorPane === null || editorPane === void 0 ? void 0 : editorPane.input, event);
            const isSelectionAwareEditorPane = (0, editor_1.isEditorPaneWithSelection)(editorPane);
            const hasValidEditor = (editorPane === null || editorPane === void 0 ? void 0 : editorPane.group) && editorPane.input && !editorPane.input.isDisposed();
            ...
            if (this.navigating) {
                this.trace(`notifyNavigation() ignoring (navigating)`, editorPane === null || editorPane === void 0 ? void 0 : editorPane.input, event);
                if (isSelectionAwareEditorPane && hasValidEditor) {
                    this.trace('notifyNavigation() updating current selection state', editorPane === null || editorPane === void 0 ? void 0 : editorPane.input, event);
                    this.currentSelectionState = new EditorSelectionState({ groupId: editorPane.group.id, editor: editorPane.input }, editorPane.getSelection(), event === null || event === void 0 ? void 0 : event.reason);
                }
                else {
                    this.trace('notifyNavigation() dropping current selection state', editorPane === null || editorPane === void 0 ? void 0 : editorPane.input, event);
            ...
            // Normal navigation not part of stack navigation
                ...
                this.trace(`notifyNavigation() not ignoring`, editorPane === null || editorPane === void 0 ? void 0 : editorPane.input, event);
        ...
        onSelectionAwareEditorNavigation(groupId, editor, selection, event) {
            var _a;
            if (((_a = this.current) === null || _a === void 0 ? void 0 : _a.groupId) === groupId && !selection && this.editorHelper.matchesEditor(this.current.editor, editor)) {
            ...
            const stateCandidate = new EditorSelectionState({ groupId, editor }, selection, event === null || event === void 0 ? void 0 : event.reason);
        ...
        onNonSelectionAwareEditorNavigation(groupId, editor) {
            var _a;
            if (((_a = this.current) === null || _a === void 0 ? void 0 : _a.groupId) === groupId && this.editorHelper.matchesEditor(this.current.editor, editor)) {
        ...
        remove(arg1) {
            ...
            if (typeof arg1 === 'number') {
                (_a = this.mapGroupToDisposable.get(arg1)) === null || _a === void 0 ? void 0 : _a.dispose();
        ...
        isCurrentSelectionActive() {
            var _a, _b;
            if (!((_a = this.current) === null || _a === void 0 ? void 0 : _a.selection)) {
            ...
            if (((_b = pane.group) === null || _b === void 0 ? void 0 : _b.id) !== this.current.groupId) {
        ...
        doNavigate(location) {
            ...
            return this.editorService.openEditor(Object.assign(Object.assign({}, location.editor), { options: Object.assign(Object.assign({}, location.editor.options), options) }), location.groupId);
        }
        isNavigating() {
    ...
    let EditorHelper = class EditorHelper {
        ...
        preferResourceEditorInput(editor) {
            ...
            const hasValidResourceEditorInputScheme = (resource === null || resource === void 0 ? void 0 : resource.scheme) === network_1.Schemas.file ||
                (resource === null || resource === void 0 ? void 0 : resource.scheme) === network_1.Schemas.vscodeRemote ||
                (resource === null || resource === void 0 ? void 0 : resource.scheme) === network_1.Schemas.vscodeUserData ||
                (resource === null || resource === void 0 ? void 0 : resource.scheme) === this.pathService.defaultUriScheme;
        ...
        matchesFile(resource, arg2) {
            ...
            return this.uriIdentityService.extUri.isEqual(arg2 === null || arg2 === void 0 ? void 0 : arg2.resource, resource);
        }
        matchesEditorIdentifier(identifier, editorPane) {
            if (!(editorPane === null || editorPane === void 0 ? void 0 : editorPane.group)) {
                return false;
            }
