...
define(["require", "exports", "vs/base/browser/hash", "vs/platform/files/common/files", "vs/platform/workspace/common/workspace", "vs/workbench/services/environment/common/environmentService", "vs/workbench/services/textfile/common/textfiles", "vs/base/common/uri", "vs/base/common/network", "vs/platform/instantiation/common/extensions", "vs/workbench/contrib/tags/common/workspaceTags", "vs/workbench/contrib/tags/electron-sandbox/workspaceTags", "vs/platform/product/common/productService", "vs/base/common/strings", "vs/workbench/contrib/tags/common/javaWorkspaceTags"], function (require, exports, hash_1, files_1, workspace_1, environmentService_1, textfiles_1, uri_1, network_1, extensions_1, workspaceTags_1, workspaceTags_2, productService_1, strings_1, javaWorkspaceTags_1) {
    "use strict";
    ...
    let WorkspaceTagsService = class WorkspaceTagsService {
        constructor(fileService, contextService, environmentService, productService, textFileService) {
    ...
    (0, extensions_1.registerSingleton)(workspaceTags_1.IWorkspaceTagsService, WorkspaceTagsService, true);
});
