 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/base/common/path", "vs/base/common/platform", "vs/base/common/resources", "vs/base/common/uri", "vs/workbench/services/search/node/fileSearch", "vs/base/test/node/testUtils"], function (require, exports, assert, path, platform, resources_1, uri_1, fileSearch_1, testUtils_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    const TEST_FIXTURES = path.normalize((0, testUtils_1.getPathFromAmdModule)(require, './fixtures'));
    ...
    const ROOT_FOLDER_QUERY_36438 = [
        { folder: uri_1.URI.file(path.normalize((0, testUtils_1.getPathFromAmdModule)(require, './fixtures2/36438'))) }
    ];
    ...
    (0, testUtils_1.flakySuite)('FileSearchEngine', () => {
        ...
        test('Files: extraFiles only', function (done) {
            const engine = new fileSearch_1.Engine({
                ...
                folderQueries: [],
                extraFileResources: [
                    uri_1.URI.file(path.normalize(path.join((0, testUtils_1.getPathFromAmdModule)(require, './fixtures'), 'site.css'))),
                    uri_1.URI.file(path.normalize(path.join((0, testUtils_1.getPathFromAmdModule)(require, './fixtures'), 'examples', 'company.js'))),
                    uri_1.URI.file(path.normalize(path.join((0, testUtils_1.getPathFromAmdModule)(require, './fixtures'), 'index.html')))
                ],
                filePattern: '*.js'
            });
            let count = 0;
