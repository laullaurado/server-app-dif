 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/workbench/contrib/snippets/browser/snippetsFile", "vs/base/common/uri", "vs/editor/contrib/snippet/browser/snippetParser"], function (require, exports, assert, snippetsFile_1, uri_1, snippetParser_1) {
    "use strict";
    ...
    suite('Snippets', function () {
        ...
        test('SnippetFile#select', () => {
            ...
            file = new TestSnippetFile(uri_1.URI.file('somepath/foo.code-snippets'), [
                new snippetsFile_1.Snippet(['foo'], 'FooSnippet1', 'foo', '', 'snippet', 'test', 1 /* SnippetSource.User */),
                new snippetsFile_1.Snippet(['foo'], 'FooSnippet2', 'foo', '', 'snippet', 'test', 1 /* SnippetSource.User */),
                new snippetsFile_1.Snippet(['bar'], 'BarSnippet1', 'foo', '', 'snippet', 'test', 1 /* SnippetSource.User */),
                new snippetsFile_1.Snippet(['bar.comment'], 'BarSnippet2', 'foo', '', 'snippet', 'test', 1 /* SnippetSource.User */),
                new snippetsFile_1.Snippet(['bar.strings'], 'BarSnippet2', 'foo', '', 'snippet', 'test', 1 /* SnippetSource.User */),
                new snippetsFile_1.Snippet(['bazz', 'bazz'], 'BazzSnippet1', 'foo', '', 'snippet', 'test', 1 /* SnippetSource.User */),
            ]);
            bucket = [];
        ...
        test('SnippetFile#select - any scope', function () {
            let file = new TestSnippetFile(uri_1.URI.file('somepath/foo.code-snippets'), [
                new snippetsFile_1.Snippet([], 'AnySnippet1', 'foo', '', 'snippet', 'test', 1 /* SnippetSource.User */),
                new snippetsFile_1.Snippet(['foo'], 'FooSnippet1', 'foo', '', 'snippet', 'test', 1 /* SnippetSource.User */),
            ]);
            let bucket = [];
            file.select('foo', bucket);
        ...
        test('Snippet#needsClipboard', function () {
            function assertNeedsClipboard(body, expected) {
                let snippet = new snippetsFile_1.Snippet(['foo'], 'FooSnippet1', 'foo', '', body, 'test', 1 /* SnippetSource.User */);
