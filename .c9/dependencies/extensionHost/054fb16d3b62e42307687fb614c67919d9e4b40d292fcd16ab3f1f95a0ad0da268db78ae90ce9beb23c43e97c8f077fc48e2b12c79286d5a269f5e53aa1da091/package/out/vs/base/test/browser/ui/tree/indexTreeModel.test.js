 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/base/browser/ui/tree/indexTreeModel", "vs/base/common/async"], function (require, exports, assert, indexTreeModel_1, async_1) {
    "use strict";
    ...
    function toElements(node) {
        var _a;
        return ((_a = node.children) === null || _a === void 0 ? void 0 : _a.length) ? { e: node.element, children: node.children.map(toElements) } : node.element;
    }
