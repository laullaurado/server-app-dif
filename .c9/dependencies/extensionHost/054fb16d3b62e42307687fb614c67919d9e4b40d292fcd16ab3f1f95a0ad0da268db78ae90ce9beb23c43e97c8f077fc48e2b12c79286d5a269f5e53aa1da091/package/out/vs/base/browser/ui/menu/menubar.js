 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/browser/browser", "vs/base/browser/dom", "vs/base/browser/keyboardEvent", "vs/base/browser/mouseEvent", "vs/base/browser/touch", "vs/base/browser/ui/menu/menu", "vs/base/common/actions", "vs/base/common/arrays", "vs/base/common/async", "vs/base/common/codicons", "vs/base/common/event", "vs/base/common/keyCodes", "vs/base/common/lifecycle", "vs/base/common/platform", "vs/base/common/strings", "vs/base/common/types", "vs/nls", "vs/css!./menubar"], function (require, exports, browser, DOM, keyboardEvent_1, mouseEvent_1, touch_1, menu_1, actions_1, arrays_1, async_1, codicons_1, event_1, keyCodes_1, lifecycle_1, platform_1, strings, types_1, nls) {
    "use strict";
    ...
    class MenuBar extends lifecycle_1.Disposable {
        constructor(container, options = {}) {
            ...
            this.actionRunner = (_a = this.options.actionRunner) !== null && _a !== void 0 ? _a : this._register(new actions_1.ActionRunner());
        ...
        createOverflowMenu() {
            ...
            const titleElement = $('div.menubar-menu-title.toolbar-toggle-more' + codicons_1.Codicon.menuBarMore.cssSelector, { 'role': 'none', 'aria-hidden': true });
            buttonElement.appendChild(titleElement);
            ...
            this._register(DOM.addDisposableListener(buttonElement, DOM.EventType.KEY_UP, (e) => {
                ...
                if (!this.isCompact) {
                    ...
                    triggerKeys.push(this.options.compactMode === menu_1.Direction.Right ? 17 /* KeyCode.RightArrow */ : 15 /* KeyCode.LeftArrow */);
                }
        ...
        showCustomMenu(menuIndex, selectFirst = true) {
            ...
            let menuOptions = {
                ...
                ariaLabel: (0, types_1.withNullAsUndefined)(customMenu.buttonElement.getAttribute('aria-label')),
