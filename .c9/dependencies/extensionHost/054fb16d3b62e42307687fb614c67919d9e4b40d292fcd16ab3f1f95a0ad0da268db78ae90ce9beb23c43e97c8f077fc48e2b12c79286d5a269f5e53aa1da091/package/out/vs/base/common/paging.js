 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/common/arrays", "vs/base/common/cancellation", "vs/base/common/errors", "vs/base/common/types"], function (require, exports, arrays_1, cancellation_1, errors_1, types_1) {
    "use strict";
    ...
    class PagedModel {
        constructor(arg) {
            this.pages = [];
            this.pager = (0, types_1.isArray)(arg) ? singlePagePager(arg) : arg;
