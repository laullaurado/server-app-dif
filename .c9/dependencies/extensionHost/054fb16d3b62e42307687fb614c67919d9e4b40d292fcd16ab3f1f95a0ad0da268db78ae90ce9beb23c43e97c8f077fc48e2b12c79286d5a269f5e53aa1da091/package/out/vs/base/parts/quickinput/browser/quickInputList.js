...
define(["require", "exports", "vs/base/browser/dom", "vs/base/browser/keyboardEvent", "vs/base/browser/ui/actionbar/actionbar", "vs/base/browser/ui/iconLabel/iconLabel", "vs/base/browser/ui/keybindingLabel/keybindingLabel", "vs/base/common/actions", "vs/base/common/arrays", "vs/base/common/codicons", "vs/base/common/comparers", "vs/base/common/decorators", "vs/base/common/event", "vs/base/common/iconLabels", "vs/base/common/lifecycle", "vs/base/common/platform", "vs/base/common/types", "vs/base/parts/quickinput/browser/quickInputUtils", "vs/nls", "vs/css!./media/quickInput"], function (require, exports, dom, keyboardEvent_1, actionbar_1, iconLabel_1, keybindingLabel_1, actions_1, arrays_1, codicons_1, comparers_1, decorators_1, event_1, iconLabels_1, lifecycle_1, platform, types_1, quickInputUtils_1, nls_1) {
    "use strict";
        ...
        renderElement(element, index, data) {
            ...
            if (buttons && buttons.length) {
                data.actionBar.push(buttons.map((button, index) => {
                    ...
                    const action = new actions_1.Action(`id-${index}`, '', cssClasses, true, async () => {
