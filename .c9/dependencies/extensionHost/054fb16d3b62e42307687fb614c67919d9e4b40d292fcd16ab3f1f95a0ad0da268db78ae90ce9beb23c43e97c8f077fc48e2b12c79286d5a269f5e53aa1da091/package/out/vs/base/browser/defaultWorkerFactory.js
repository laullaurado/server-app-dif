    ...
    function getWorker(label) {
        ...
        if (platform_1.globals.MonacoEnvironment) {
            if (typeof platform_1.globals.MonacoEnvironment.getWorker === 'function') {
                return platform_1.globals.MonacoEnvironment.getWorker('workerMain.js', label);
            }
            if (typeof platform_1.globals.MonacoEnvironment.getWorkerUrl === 'function') {
                const workerUrl = platform_1.globals.MonacoEnvironment.getWorkerUrl('workerMain.js', label);
