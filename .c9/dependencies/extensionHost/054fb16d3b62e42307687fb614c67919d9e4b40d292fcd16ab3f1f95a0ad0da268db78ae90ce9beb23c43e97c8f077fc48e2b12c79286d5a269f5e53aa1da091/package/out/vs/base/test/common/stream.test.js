 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/base/common/async", "vs/base/common/buffer", "vs/base/common/stream"], function (require, exports, assert, async_1, buffer_1, stream_1) {
    "use strict";
    ...
    suite('Stream', () => {
        ...
        test('listenStream - dispose', () => {
            ...
            let end = false;
            let data = '';
            const disposable = (0, stream_1.listenStream)(stream, {
                onData: d => {
                    data = d;
                },
                onError: e => {
