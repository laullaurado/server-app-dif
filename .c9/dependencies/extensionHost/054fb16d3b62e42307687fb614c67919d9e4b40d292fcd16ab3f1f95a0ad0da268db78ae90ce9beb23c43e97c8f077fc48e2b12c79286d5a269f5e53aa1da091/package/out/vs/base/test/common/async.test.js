 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/base/common/async", "vs/base/common/cancellation", "vs/base/common/errors", "vs/base/common/event", "vs/base/common/uri"], function (require, exports, assert, async, cancellation_1, errors_1, event_1, uri_1) {
    "use strict";
    ...
    suite('Async', () => {
        ...
        suite('ThrottledWorker', () => {
            ...
            test('basics', async () => {
                ...
                const worker = new async.ThrottledWorker({
                    maxWorkChunkSize: 5,
