...
define(["require", "exports", "fs", "os", "util", "vs/base/common/async", "vs/base/common/extpath", "vs/base/common/normalization", "vs/base/common/path", "vs/base/common/platform", "vs/base/common/resources", "vs/base/common/uri"], function (require, exports, fs, os_1, util_1, async_1, extpath_1, normalization_1, path_1, platform_1, resources_1, uri_1) {
    ...
    exports.Promises = exports.writeFileSync = exports.SymlinkSupport = exports.whenDeleted = exports.readdirSync = exports.rimrafSync = exports.RimRafMode = void 0;
    //#region rimraf
    var RimRafMode;
    (function (RimRafMode) {
        /**
    ...
    async function rimrafMove(path) {
        try {
            const pathInTemp = (0, extpath_1.randomPath)((0, os_1.tmpdir)());
            try {
    ...
    async function move(source, target) {
        ...
        try {
            await exports.Promises.rename(source, target);
        }
        catch (error) {
