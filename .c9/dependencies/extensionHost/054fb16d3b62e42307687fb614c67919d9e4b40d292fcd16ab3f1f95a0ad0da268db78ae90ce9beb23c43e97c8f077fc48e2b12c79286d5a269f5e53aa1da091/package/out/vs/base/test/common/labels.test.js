 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/base/common/labels", "vs/base/common/platform", "vs/base/common/uri"], function (require, exports, assert, labels, platform_1, uri_1) {
    "use strict";
    ...
    suite('Labels', () => {
        ...
        (platform_1.isWindows ? test.skip : test)('getBaseLabel - unix', () => {
        ...
        (!platform_1.isWindows ? test.skip : test)('getBaseLabel - windows', () => {
