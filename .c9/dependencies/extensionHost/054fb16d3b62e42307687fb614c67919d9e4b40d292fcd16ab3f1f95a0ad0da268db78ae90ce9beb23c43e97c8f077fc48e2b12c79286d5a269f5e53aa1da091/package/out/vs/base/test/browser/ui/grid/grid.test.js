 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/base/browser/ui/grid/grid", "vs/base/common/event", "vs/base/common/objects", "./util"], function (require, exports, assert, grid_1, event_1, objects_1, util_1) {
    "use strict";
    ...
    suite('SerializableGrid', function () {
        ...
        test('createSerializedGrid - issue #85601, should not allow single children groups', () => {
            ...
            const grid = grid_1.SerializableGrid.deserialize(serializedGrid, deserializer);
