 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/base/browser/ui/splitview/splitview", "vs/base/common/event"], function (require, exports, assert, splitview_1, event_1) {
    "use strict";
    ...
    suite('Splitview', () => {
        ...
        test('high layout priority', () => {
            const view1 = new TestView(20, Number.POSITIVE_INFINITY);
            const view2 = new TestView(20, Number.POSITIVE_INFINITY, 2 /* LayoutPriority.High */);
            const view3 = new TestView(20, Number.POSITIVE_INFINITY);
            const splitview = new splitview_1.SplitView(container, { proportionalLayout: false });
            splitview.layout(200);
            splitview.addView(view1, splitview_1.Sizing.Distribute);
        ...
        test('low layout priority', () => {
            const view1 = new TestView(20, Number.POSITIVE_INFINITY);
            const view2 = new TestView(20, Number.POSITIVE_INFINITY);
            const view3 = new TestView(20, Number.POSITIVE_INFINITY, 1 /* LayoutPriority.Low */);
            const splitview = new splitview_1.SplitView(container, { proportionalLayout: false });
            splitview.layout(200);
            splitview.addView(view1, splitview_1.Sizing.Distribute);
            splitview.addView(view2, splitview_1.Sizing.Distribute);
