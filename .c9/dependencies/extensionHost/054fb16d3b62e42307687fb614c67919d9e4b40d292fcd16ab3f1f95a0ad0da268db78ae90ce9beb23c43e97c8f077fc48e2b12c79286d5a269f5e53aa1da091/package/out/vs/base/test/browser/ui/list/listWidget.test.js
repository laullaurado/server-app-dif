 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/base/browser/ui/list/listWidget", "vs/base/common/arrays", "vs/base/common/async"], function (require, exports, assert, listWidget_1, arrays_1, async_1) {
    "use strict";
    ...
    suite('ListWidget', function () {
        test('Page up and down', async function () {
            ...
            const listWidget = new listWidget_1.List('test', element, delegate, [renderer]);
