 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "electron", "vs/base/parts/ipc/electron-main/ipcMain", "vs/base/common/types", "vs/base/parts/contextmenu/common/contextmenu"], function (require, exports, electron_1, ipcMain_1, types_1, contextmenu_1) {
    "use strict";
    ...
    function registerContextMenuListener() {
        ipcMain_1.validatedIpcMain.on(contextmenu_1.CONTEXT_MENU_CHANNEL, (event, contextMenuId, items, onClickChannel, options) => {
            ...
            menu.popup({
                window: (0, types_1.withNullAsUndefined)(electron_1.BrowserWindow.fromWebContents(event.sender)),
