 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/base/common/fuzzyScorer", "vs/base/common/network", "vs/base/common/path", "vs/base/common/platform", "vs/base/common/uri"], function (require, exports, assert, fuzzyScorer_1, network_1, path_1, platform_1, uri_1) {
    "use strict";
    ...
    function _doScore(target, query, allowNonContiguousMatches) {
        ...
        return (0, fuzzyScorer_1.scoreFuzzy)(target, preparedQuery.normalized, preparedQuery.normalizedLowercase, allowNonContiguousMatches !== null && allowNonContiguousMatches !== void 0 ? allowNonContiguousMatches : !preparedQuery.expectContiguousMatch);
    }
