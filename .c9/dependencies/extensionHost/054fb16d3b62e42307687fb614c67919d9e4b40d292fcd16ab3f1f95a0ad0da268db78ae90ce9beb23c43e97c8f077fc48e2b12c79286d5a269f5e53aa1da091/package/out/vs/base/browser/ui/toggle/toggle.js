    ...
    class Toggle extends widget_1.Widget {
        constructor(opts) {
            ...
            if (this._opts.icon) {
                ...
                classes.push(...codicons_1.CSSIcon.asClassNameArray(this._icon));
            }
        ...
        setIcon(icon) {
            if (this._icon) {
                this.domNode.classList.remove(...codicons_1.CSSIcon.asClassNameArray(this._icon));
            }
            this._icon = icon;
            if (this._icon) {
                this.domNode.classList.add(...codicons_1.CSSIcon.asClassNameArray(this._icon));
            }
        }
        width() {
