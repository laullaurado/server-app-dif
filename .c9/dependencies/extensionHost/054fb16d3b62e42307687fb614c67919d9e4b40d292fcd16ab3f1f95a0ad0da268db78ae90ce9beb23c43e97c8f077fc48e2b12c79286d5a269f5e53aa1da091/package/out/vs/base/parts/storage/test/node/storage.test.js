 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "os", "vs/base/common/async", "vs/base/common/event", "vs/base/common/path", "vs/base/common/platform", "vs/base/common/uuid", "vs/base/node/pfs", "vs/base/parts/storage/common/storage", "vs/base/parts/storage/node/storage", "vs/base/test/common/timeTravelScheduler", "vs/base/test/node/testUtils"], function (require, exports, assert_1, os_1, async_1, event_1, path_1, platform_1, uuid_1, pfs_1, storage_1, storage_2, timeTravelScheduler_1, testUtils_1) {
    "use strict";
    ...
    (0, testUtils_1.flakySuite)('Storage Library', function () {
        ...
        test('basics', () => {
            return (0, timeTravelScheduler_1.runWithFakedTimers)({}, async function () {
                ...
                (0, assert_1.strictEqual)(changes.size, 3);
    ...
    (0, testUtils_1.flakySuite)('SQLite Storage Library', function () {
        ...
        test('very large item value', async function () {
            ...
            let uuid = (0, uuid_1.generateUuid)();
            let value = [];
            ...
            await storage.updateItems({ insert: items });
            let storedItems = await storage.getItems();
            (0, assert_1.strictEqual)(items.get('colorthemedata'), storedItems.get('colorthemedata'));
            (0, assert_1.strictEqual)(items.get('commandpalette.mru.cache'), storedItems.get('commandpalette.mru.cache'));
            (0, assert_1.strictEqual)(items.get('super.large.string'), storedItems.get('super.large.string'));
