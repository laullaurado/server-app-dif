define(["require", "exports", "assert", "vs/base/common/async", "vs/base/common/cancellation", "vs/base/common/errors", "vs/base/common/event", "vs/base/common/lifecycle", "vs/base/test/common/utils"], function (require, exports, assert, async_1, cancellation_1, errors_1, event_1, lifecycle_1, utils_1) {
    "use strict";
    ...
    suite('Event utils dispose', function () {
        let tracker = new utils_1.DisposableTracker();
        ...
        setup(() => {
            tracker = new utils_1.DisposableTracker();
        ...
        test('no leak with debounce-util', function () {
            const store = new lifecycle_1.DisposableStore();
            const emitter = new event_1.Emitter();
            const debounced = event_1.Event.debounce(emitter.event, (l) => 0, undefined, undefined, undefined, store);
