 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "child_process", "vs/base/common/objects", "vs/base/common/platform", "vs/base/node/processes", "vs/base/test/node/testUtils"], function (require, exports, assert, cp, objects, platform, processes, testUtils_1) {
    "use strict";
    ...
    function fork(id) {
        ...
        return cp.fork((0, testUtils_1.getPathFromAmdModule)(require, 'bootstrap-fork'), ['--type=processTests'], opts);
    }
    suite('Processes', () => {
