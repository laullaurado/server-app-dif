...
define(["require", "exports", "vs/base/common/keyCodes", "vs/base/common/keybindings"], function (require, exports, keyCodes_1, keybindings_1) {
    ...
    class KeybindingParser {
        ...
        static parseSimpleKeybinding(input) {
            ...
            return [new keybindings_1.SimpleKeybinding(mods.ctrl, mods.shift, mods.alt, mods.meta, keyCode), mods.remains];
        }
        static parseKeybinding(input, OS) {
            ...
            return new keybindings_1.ChordKeybinding(parts);
        }
        static parseSimpleUserBinding(input) {
            ...
            if (scanCodeMatch) {
                ...
                return [new keybindings_1.ScanCodeBinding(mods.ctrl, mods.shift, mods.alt, mods.meta, scanCode), mods.remains];
            }
            const keyCode = keyCodes_1.KeyCodeUtils.fromUserSettings(mods.key);
            return [new keybindings_1.SimpleKeybinding(mods.ctrl, mods.shift, mods.alt, mods.meta, keyCode), mods.remains];
        }
