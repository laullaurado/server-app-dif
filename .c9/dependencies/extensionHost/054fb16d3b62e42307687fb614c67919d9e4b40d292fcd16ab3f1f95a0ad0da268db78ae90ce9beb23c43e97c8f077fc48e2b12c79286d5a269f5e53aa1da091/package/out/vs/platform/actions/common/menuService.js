...
define(["require", "exports", "vs/base/common/async", "vs/base/common/event", "vs/base/common/lifecycle", "vs/platform/actions/common/actions", "vs/platform/commands/common/commands", "vs/platform/contextkey/common/contextkey"], function (require, exports, async_1, event_1, lifecycle_1, actions_1, commands_1, contextkey_1) {
    ...
    let Menu = class Menu {
        constructor(_id, _options, _commandService, _contextKeyService, _menuService) {
            ...
            const contextKeyListener = this._disposables.add(new lifecycle_1.DisposableStore());
            const startContextKeyListener = () => {
                const fireChangeSoon = new async_1.RunOnceScheduler(() => this._onDidChange.fire(this), _options.eventDebounceDelay);
