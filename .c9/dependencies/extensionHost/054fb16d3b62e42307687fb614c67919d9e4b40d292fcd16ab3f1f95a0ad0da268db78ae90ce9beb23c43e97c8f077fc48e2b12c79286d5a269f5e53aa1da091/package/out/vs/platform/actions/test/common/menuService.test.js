 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/base/common/lifecycle", "vs/platform/actions/common/actions", "vs/platform/actions/common/menuService", "vs/platform/commands/common/commands", "vs/platform/keybinding/test/common/mockKeybindingService"], function (require, exports, assert, lifecycle_1, actions_1, menuService_1, commands_1, mockKeybindingService_1) {
    "use strict";
    ...
    suite('MenuService', function () {
        ...
        setup(function () {
            ...
            testMenuId = new actions_1.MenuId('testo');
            disposables.clear();
        });
        teardown(function () {
            disposables.clear();
