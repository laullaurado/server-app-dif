...
"Div": {
    ...
    suite('SnippetsSync', () => {
        ...
        test('when snippets does not exist', async () => {
            ...
            const snippetsResource = testClient.instantiationService.get(environment_1.IEnvironmentService).snippetsHome;
        ...
        async function updateSnippet(name, content, client) {
            ...
            const snippetsResource = (0, resources_1.joinPath)(environmentService.snippetsHome, name);
        ...
        async function readSnippet(name, client) {
            const fileService = client.instantiationService.get(files_1.IFileService);
            const environmentService = client.instantiationService.get(environment_1.IEnvironmentService);
            const snippetsResource = (0, resources_1.joinPath)(environmentService.snippetsHome, name);
