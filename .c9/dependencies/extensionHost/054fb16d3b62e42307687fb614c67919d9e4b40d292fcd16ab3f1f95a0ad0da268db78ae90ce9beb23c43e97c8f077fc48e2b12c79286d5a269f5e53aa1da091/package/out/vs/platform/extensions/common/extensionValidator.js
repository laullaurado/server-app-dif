    ...
    function validateExtensionManifest(productVersion, productDate, extensionLocation, extensionManifest, extensionIsBuiltin) {
        ...
        if (typeof extensionManifest.activationEvents !== 'undefined') {
            ...
            if (typeof extensionManifest.main === 'undefined' && typeof extensionManifest.browser === 'undefined') {
                validations.push([severity_1.default.Error, nls.localize('extensionDescription.activationEvents2', "properties `{0}` and `{1}` must both be specified or must both be omitted", 'activationEvents', 'main')]);
                return validations;
            }
        }
        ...
        if (typeof extensionManifest.main !== 'undefined') {
            ...
            if (typeof extensionManifest.activationEvents === 'undefined') {
                validations.push([severity_1.default.Error, nls.localize('extensionDescription.main3', "properties `{0}` and `{1}` must both be specified or must both be omitted", 'activationEvents', 'main')]);
                return validations;
            }
        }
        if (typeof extensionManifest.browser !== 'undefined') {
            ...
            if (typeof extensionManifest.activationEvents === 'undefined') {
                validations.push([severity_1.default.Error, nls.localize('extensionDescription.browser3', "properties `{0}` and `{1}` must both be specified or must both be omitted", 'activationEvents', 'browser')]);
                return validations;
            }
        }
