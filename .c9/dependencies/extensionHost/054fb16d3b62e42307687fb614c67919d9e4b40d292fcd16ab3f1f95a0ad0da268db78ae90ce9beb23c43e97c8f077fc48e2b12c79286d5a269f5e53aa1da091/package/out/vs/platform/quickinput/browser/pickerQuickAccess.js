 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/common/async", "vs/base/common/cancellation", "vs/base/common/lifecycle"], function (require, exports, async_1, cancellation_1, lifecycle_1) {
    "use strict";
            ...
            const updatePickerItems = async () => {
                ...
                // Fast and Slow Picks
                    ...
                    await Promise.all([
                        ...
                        (async () => {
                            await (0, async_1.timeout)(PickerQuickAccessProvider.FAST_PICKS_RACE_DELAY);
