...
define(["require", "exports", "vs/base/common/async", "vs/base/common/decorators", "vs/base/common/event", "vs/platform/log/common/log"], function (require, exports, async_1, decorators_1, event_1, log_1) {
    "use strict";
    ...
    let CommandDetectionCapability = class CommandDetectionCapability {
        constructor(_terminal, _logService) {
            ...
            this._onBeforeCommandFinished = new event_1.Emitter();
            ...
            this._onCommandInvalidated = new event_1.Emitter();
            this.onCommandInvalidated = this._onCommandInvalidated.event;
            this._onCurrentCommandInvalidated = new event_1.Emitter();
        ...
        _clearCommandsInViewport() {
            ...
            for (let i = this._commands.length - 1; i >= 0; i--) {
                const line = (_a = this._commands[i].marker) === null || _a === void 0 ? void 0 : _a.line;
