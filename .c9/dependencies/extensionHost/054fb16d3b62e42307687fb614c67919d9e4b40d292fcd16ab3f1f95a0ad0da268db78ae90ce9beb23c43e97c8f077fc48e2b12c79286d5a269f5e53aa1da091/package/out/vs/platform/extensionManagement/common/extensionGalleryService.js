...
define(["require", "exports", "vs/base/common/arrays", "vs/base/common/cancellation", "vs/base/common/errors", "vs/base/common/objects", "vs/base/common/platform", "vs/base/common/process", "vs/base/common/types", "vs/base/common/uri", "vs/platform/configuration/common/configuration", "vs/platform/environment/common/environment", "vs/platform/extensionManagement/common/extensionManagement", "vs/platform/extensionManagement/common/extensionManagementUtil", "vs/platform/extensions/common/extensionValidator", "vs/platform/files/common/files", "vs/platform/log/common/log", "vs/platform/product/common/productService", "vs/platform/request/common/request", "vs/platform/externalServices/common/marketplace", "vs/platform/storage/common/storage", "vs/platform/telemetry/common/telemetry"], function (require, exports, arrays_1, cancellation_1, errors_1, objects_1, platform_1, process_1, types_1, uri_1, configuration_1, environment_1, extensionManagement_1, extensionManagementUtil_1, extensionValidator_1, files_1, log_1, productService_1, request_1, marketplace_1, storage_1, telemetry_1) {
    ...
    class Query {
        ...
        withSource(source) {
            return new Query(Object.assign(Object.assign({}, this.state), { source }));
        }
        get raw() {
    ...
    function getSponsorLink(version) {
        var _a, _b;
        return (_b = (_a = version.properties) === null || _a === void 0 ? void 0 : _a.find(p => p.key === PropertyType.SponsorLink)) === null || _b === void 0 ? void 0 : _b.value;
    }
    ...
    function getAllTargetPlatforms(rawGalleryExtension) {
        ...
        const isWebExtension = !!((_a = rawGalleryExtension.tags) === null || _a === void 0 ? void 0 : _a.includes(extensionManagement_1.WEB_EXTENSION_TAG));
    ...
    function sortExtensionVersions(versions, preferredTargetPlatform) {
        ...
        for (let index = 0; index < versions.length; index++) {
            ...
            if (version.version === ((_a = versions[index - 1]) === null || _a === void 0 ? void 0 : _a.version)) {
    ...
    let AbstractExtensionGalleryService = class AbstractExtensionGalleryService {
        constructor(storageService, requestService, logService, environmentService, telemetryService, fileService, productService, configurationService) {
            ...
            this.commonHeadersPromise = (0, marketplace_1.resolveMarketplaceHeaders)(productService.version, productService, this.environmentService, this.configurationService, this.fileService, storageService);
        }
        api(path = '') {
        ...
        async getExtensions(extensionInfos, arg1, arg2) {
            ...
            const { extensions } = await this.queryGalleryExtensions(query, { targetPlatform: (_a = options.targetPlatform) !== null && _a !== void 0 ? _a : CURRENT_TARGET_PLATFORM, includePreRelease: includePreReleases, versions, compatible: !!options.compatible }, token);
            if (options.source) {
        ...
        async queryGalleryExtensions(query, criteria, token) {
             ...
             */
            if ((_a = criteria.versions) === null || _a === void 0 ? void 0 : _a.length) {
            ...
            for (let index = 0; index < rawGalleryExtensions.length; index++) {
                ...
                const includePreRelease = (0, types_1.isBoolean)(criteria.includePreRelease) ? criteria.includePreRelease : !!((_b = criteria.includePreRelease.find(extensionIdentifierWithPreRelease => (0, extensionManagementUtil_1.areSameExtensions)(extensionIdentifierWithPreRelease, extensionIdentifier))) === null || _b === void 0 ? void 0 : _b.includePreRelease);
        ...
        async toGalleryExtensionWithCriteria(rawGalleryExtension, criteria) {
            var _a, _b, _c;
            const extensionIdentifier = { id: (0, extensionManagementUtil_1.getGalleryExtensionId)(rawGalleryExtension.publisher.publisherName, rawGalleryExtension.extensionName), uuid: rawGalleryExtension.extensionId };
            const version = (_b = (_a = criteria.versions) === null || _a === void 0 ? void 0 : _a.find(extensionIdentifierWithVersion => (0, extensionManagementUtil_1.areSameExtensions)(extensionIdentifierWithVersion, extensionIdentifier))) === null || _b === void 0 ? void 0 : _b.version;
            const includePreRelease = (0, types_1.isBoolean)(criteria.includePreRelease) ? criteria.includePreRelease : !!((_c = criteria.includePreRelease.find(extensionIdentifierWithPreRelease => (0, extensionManagementUtil_1.areSameExtensions)(extensionIdentifierWithPreRelease, extensionIdentifier))) === null || _c === void 0 ? void 0 : _c.includePreRelease);
        ...
        async reportStatistic(publisher, name, version, type) {
            ...
            const commonHeaders = await this.commonHeadersPromise;
            const headers = Object.assign(Object.assign({}, commonHeaders), { Accept });
            try {
