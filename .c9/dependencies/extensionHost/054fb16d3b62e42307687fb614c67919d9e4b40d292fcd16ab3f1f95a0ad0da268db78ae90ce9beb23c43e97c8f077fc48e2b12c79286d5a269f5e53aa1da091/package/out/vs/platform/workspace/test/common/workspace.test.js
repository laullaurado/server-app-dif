...
define(["require", "exports", "assert", "vs/base/common/path", "vs/base/common/platform", "vs/base/common/resources", "vs/base/common/uri", "vs/platform/workspace/common/workspace", "vs/platform/workspaces/common/workspaces"], function (require, exports, assert, path_1, platform_1, resources_1, uri_1, workspace_1, workspaces_1) {
    ...
    suite('Workspace', () => {
        ...
        test('getFolder returns the folder with given uri', () => {
            ...
            let testObject = new workspace_1.Workspace('', [new workspace_1.WorkspaceFolder({ uri: mainFolderUri, name: '', index: 0 }), expected, new workspace_1.WorkspaceFolder({ uri: uri_1.URI.file('/src/code'), name: '', index: 2 })], false, null, () => !platform_1.isLinux);
        ...
        test('getFolder returns the folder if the uri is sub', () => {
            ...
            let testObject = new workspace_1.Workspace('', [expected, new workspace_1.WorkspaceFolder({ uri: mainFolderUri, name: '', index: 1 }), new workspace_1.WorkspaceFolder({ uri: uri_1.URI.file('/src/code'), name: '', index: 2 })], false, null, () => !platform_1.isLinux);
        ...
        test('getFolder returns the closest folder if the uri is sub', () => {
            const expected = new workspace_1.WorkspaceFolder({ uri: testFolderUri, name: '', index: 2 });
            let testObject = new workspace_1.Workspace('', [new workspace_1.WorkspaceFolder({ uri: mainFolderUri, name: '', index: 0 }), new workspace_1.WorkspaceFolder({ uri: uri_1.URI.file('/src/code'), name: '', index: 1 }), expected], false, null, () => !platform_1.isLinux);
            const actual = testObject.getFolder(uri_1.URI.file((0, path_1.join)(fileFolder, 'test/a')));
            assert.strictEqual(actual, expected);
        });
        ...
        test('getFolder returns null if the uri is not sub', () => {
            let testObject = new workspace_1.Workspace('', [new workspace_1.WorkspaceFolder({ uri: testFolderUri, name: '', index: 0 }), new workspace_1.WorkspaceFolder({ uri: uri_1.URI.file('/src/code'), name: '', index: 1 })], false, null, () => !platform_1.isLinux);
