define(["require", "exports", "assert", "vs/base/common/keyCodes", "vs/base/common/keybindings", "vs/platform/keybinding/common/usLayoutResolvedKeybinding"], function (require, exports, assert, keyCodes_1, keybindings_1, usLayoutResolvedKeybinding_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    suite('KeybindingLabels', () => {
        function assertUSLabel(OS, keybinding, expected) {
            const usResolvedKeybinding = new usLayoutResolvedKeybinding_1.USLayoutResolvedKeybinding((0, keybindings_1.createKeybinding)(keybinding, OS), OS);
        ...
        test('Electron Accelerator label', () => {
            ...
            assertElectronAcceleratorLabel(1 /* OperatingSystem.Windows */, 94 /* KeyCode.Numpad1 */, null);
            assertElectronAcceleratorLabel(3 /* OperatingSystem.Linux */, 94 /* KeyCode.Numpad1 */, null);
            assertElectronAcceleratorLabel(2 /* OperatingSystem.Macintosh */, 94 /* KeyCode.Numpad1 */, null);
            // special
