 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "os", "vs/base/common/path", "vs/base/common/uri", "vs/platform/log/common/log", "vs/platform/workspaces/common/workspaces"], function (require, exports, assert, os_1, path_1, uri_1, log_1, workspaces_1) {
    "use strict";
    ...
    suite('History Storage', () => {
        ...
        test('open 1_55', () => {
            ...
            let windowsState = (0, workspaces_1.restoreRecentlyOpened)(JSON.parse(v1_55), new log_1.NullLogService());
            let expected = {
