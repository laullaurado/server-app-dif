...
define(["require", "exports", "vs/base/common/async", "vs/base/common/buffer", "vs/base/common/date", "vs/base/common/lifecycle", "vs/base/common/resources", "vs/platform/configuration/common/configuration", "vs/platform/environment/common/environment", "vs/platform/files/common/files", "vs/platform/userDataSync/common/userDataSync"], function (require, exports, async_1, buffer_1, date_1, lifecycle_1, resources_1, configuration_1, environment_1, files_1, userDataSync_1) {
    ...
    let UserDataSyncBackupStoreService = class UserDataSyncBackupStoreService extends lifecycle_1.Disposable {
        ...
        async getAllRefs(resource) {
            const folder = (0, resources_1.joinPath)(this.environmentService.userDataSyncHome, resource);
        ...
        async resolveContent(resource, ref) {
            ...
            if (ref) {
                const file = (0, resources_1.joinPath)(this.environmentService.userDataSyncHome, resource, ref);
        ...
        async backup(resourceKey, content) {
            const folder = (0, resources_1.joinPath)(this.environmentService.userDataSyncHome, resourceKey);
            const resource = (0, resources_1.joinPath)(folder, `${(0, date_1.toLocalISOString)(new Date()).replace(/-|:|\.\d+Z$/g, '')}.json`);
            try {
...
//# sourceMappingURL=userDataSyncBackupStoreService.js.map