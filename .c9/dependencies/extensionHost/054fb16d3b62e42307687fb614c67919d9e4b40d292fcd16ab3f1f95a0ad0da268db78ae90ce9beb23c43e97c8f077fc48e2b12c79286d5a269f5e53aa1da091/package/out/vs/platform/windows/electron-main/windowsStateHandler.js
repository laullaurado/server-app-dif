...
define(["require", "exports", "electron", "vs/base/common/lifecycle", "vs/base/common/platform", "vs/base/common/resources", "vs/base/common/uri", "vs/platform/configuration/common/configuration", "vs/platform/lifecycle/electron-main/lifecycleMainService", "vs/platform/log/common/log", "vs/platform/state/electron-main/state", "vs/platform/windows/electron-main/windows", "vs/platform/window/electron-main/window", "vs/platform/workspace/common/workspace"], function (require, exports, electron_1, lifecycle_1, platform_1, resources_1, uri_1, configuration_1, lifecycleMainService_1, log_1, state_1, windows_1, window_1, workspace_1) {
    ...
    let WindowsStateHandler = class WindowsStateHandler extends lifecycle_1.Disposable {
        constructor(windowsMainService, stateMainService, lifecycleMainService, logService, configurationService) {
            ...
            this._state = restoreWindowsState(this.stateMainService.getItem(WindowsStateHandler.windowsStateStorageKey));
        ...
        onBeforeCloseWindow(window) {
            ...
            // Any non extension host window with same workspace or folder
                ...
                this._state.openedWindows.forEach(openedWindow => {
                    var _a;
                    const sameWorkspace = (0, workspace_1.isWorkspaceIdentifier)(window.openedWorkspace) && ((_a = openedWindow.workspace) === null || _a === void 0 ? void 0 : _a.id) === window.openedWorkspace.id;
        ...
        getNewWindowState(configuration) {
            ...
            if (state.mode === 3 /* WindowMode.Fullscreen */ && !allowFullscreen) {
    ...
    WindowsStateHandler = __decorate([
        ...
        __param(1, state_1.IStateMainService),
