    ...
    suite('Extension Version Validator', () => {
        ...
        test('isValidVersion', () => {
            function testIsValidVersion(version, desiredVersion, expectedResult) {
                let actual = (0, extensionValidator_1.isValidVersion)(version, productVersion, desiredVersion);
        ...
        test('isValidExtensionVersion', () => {
            function testExtensionVersion(version, desiredVersion, isBuiltin, hasMain, expectedResult) {
                ...
                let reasons = [];
                let actual = (0, extensionValidator_1.isValidExtensionVersion)(version, productVersion, manifest, isBuiltin, reasons);
