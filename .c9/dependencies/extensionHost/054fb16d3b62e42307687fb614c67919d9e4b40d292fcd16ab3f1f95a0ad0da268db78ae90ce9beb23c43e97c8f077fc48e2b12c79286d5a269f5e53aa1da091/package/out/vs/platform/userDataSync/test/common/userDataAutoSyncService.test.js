 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/base/common/buffer", "vs/base/common/event", "vs/base/common/lifecycle", "vs/base/common/resources", "vs/base/test/common/timeTravelScheduler", "vs/platform/environment/common/environment", "vs/platform/files/common/files", "vs/platform/userDataSync/common/userDataAutoSyncService", "vs/platform/userDataSync/common/userDataSync", "vs/platform/userDataSync/common/userDataSyncMachines", "vs/platform/userDataSync/test/common/userDataSyncClient"], function (require, exports, assert, buffer_1, event_1, lifecycle_1, resources_1, timeTravelScheduler_1, environment_1, files_1, userDataAutoSyncService_1, userDataSync_1, userDataSyncMachines_1, userDataSyncClient_1) {
    "use strict";
    ...
    suite('UserDataAutoSyncService', () => {
        ...
        test('test auto sync with sync resource change triggers sync', async () => {
            await (0, timeTravelScheduler_1.runWithFakedTimers)({ useSetImmediate: true }, async () => {
                // Setup the client
