 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/editor/common/core/range", "vs/editor/common/viewModel", "vs/editor/test/browser/viewModel/testViewModel"], function (require, exports, assert, range_1, viewModel_1, testViewModel_1) {
    "use strict";
    ...
    suite('ViewModelDecorations', () => {
        test('getDecorationsViewportData', () => {
            ...
            (0, testViewModel_1.testViewModel)(text, opts, (viewModel, model) => {
                ...
                const inlineDecorations1 = viewModel.getViewLineRenderingData(new range_1.Range(1, viewModel.getLineMinColumn(1), 2, viewModel.getLineMaxColumn(2)), 1).inlineDecorations;
                ...
                const inlineDecorations2 = viewModel.getViewLineRenderingData(new range_1.Range(2, viewModel.getLineMinColumn(2), 3, viewModel.getLineMaxColumn(3)), 2).inlineDecorations;
                ...
                const inlineDecorations3 = viewModel.getViewLineRenderingData(new range_1.Range(2, viewModel.getLineMinColumn(2), 3, viewModel.getLineMaxColumn(3)), 3).inlineDecorations;
                // view line 3 (24 -> 36)
