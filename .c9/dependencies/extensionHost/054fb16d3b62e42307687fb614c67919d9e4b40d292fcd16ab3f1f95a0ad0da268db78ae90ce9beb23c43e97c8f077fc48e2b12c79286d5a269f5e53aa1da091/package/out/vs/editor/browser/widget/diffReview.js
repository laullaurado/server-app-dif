...
define(["require", "exports", "vs/nls", "vs/base/browser/dom", "vs/base/browser/fastDomNode", "vs/base/browser/ui/actionbar/actionbar", "vs/base/browser/ui/scrollbar/scrollableElement", "vs/base/common/actions", "vs/base/common/lifecycle", "vs/editor/browser/config/domFontInfo", "vs/editor/browser/editorExtensions", "vs/editor/browser/services/codeEditorService", "vs/editor/common/config/editorOptions", "vs/editor/common/tokens/lineTokens", "vs/editor/common/core/position", "vs/editor/common/core/editorColorRegistry", "vs/editor/common/viewLayout/viewLineRenderer", "vs/editor/common/viewModel", "vs/platform/contextkey/common/contextkey", "vs/platform/theme/common/colorRegistry", "vs/platform/theme/common/themeService", "vs/base/common/codicons", "vs/platform/theme/common/iconRegistry", "vs/editor/common/languages/language", "vs/css!./media/diffReview"], function (require, exports, nls, dom, fastDomNode_1, actionbar_1, scrollableElement_1, actions_1, lifecycle_1, domFontInfo_1, editorExtensions_1, codeEditorService_1, editorOptions_1, lineTokens_1, position_1, editorColorRegistry_1, viewLineRenderer_1, viewModel_1, contextkey_1, colorRegistry_1, themeService_1, codicons_1, iconRegistry_1, language_1) {
    "use strict";
    var _a;
    ...
    let DiffReview = class DiffReview extends lifecycle_1.Disposable {
        constructor(diffEditor, _languageService) {
            ...
            this._actionBar.push(new actions_1.Action('diffreview.close', nls.localize('label.close', "Close"), 'close-diff-review ' + themeService_1.ThemeIcon.asClassName(diffReviewCloseIcon), true, async () => this.hide()), { label: false, icon: true });
        ...
        _render() {
            ...
            (0, domFontInfo_1.applyFontInfo)(container, modifiedOptions.get(45 /* EditorOption.fontInfo */));
            ...
            const lineHeight = modifiedOptions.get(60 /* EditorOption.lineHeight */);
