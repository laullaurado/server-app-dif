...
define(["require", "exports", "assert", "vs/base/common/lifecycle", "vs/editor/common/core/editOperation", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/textModelEvents", "vs/editor/common/languages", "vs/editor/common/languages/languageConfigurationRegistry", "vs/editor/common/languages/nullTokenize", "vs/editor/test/common/testTextModel", "vs/editor/common/languages/language"], function (require, exports, assert, lifecycle_1, editOperation_1, position_1, range_1, textModelEvents_1, languages_1, languageConfigurationRegistry_1, nullTokenize_1, testTextModel_1, language_1) {
    "use strict";
    ...
    suite('Editor Model - Model Line Separators', () => {
        ...
        test('Bug 13333:Model should line break on lonely CR too', () => {
            let model = (0, testTextModel_1.createTextModel)('Hello\rWorld!\r\nAnother line');
