...
define(["require", "exports", "assert", "vs/base/common/lifecycle", "vs/editor/common/languages", "vs/editor/common/languages/language", "vs/editor/common/languages/textToHtmlTokenizer", "vs/editor/common/services/languagesRegistry", "vs/editor/test/common/core/testLineToken", "vs/editor/test/common/testTextModel"], function (require, exports, assert, lifecycle_1, languages_1, language_1, textToHtmlTokenizer_1, languagesRegistry_1, testLineToken_1, testTextModel_1) {
    "use strict";
    ...
    suite('Editor Modes - textToHtmlTokenizer', () => {
        ...
        test('TextToHtmlTokenizer 1', () => {
            ...
            let support = languages_1.TokenizationRegistry.get(mode.languageId);
            let actual = (0, textToHtmlTokenizer_1._tokenizeToString)('.abc..def...gh', new languagesRegistry_1.LanguageIdCodec(), support);
            let expected = [
                { className: 'mtk7', text: '.' },
        ...
        test('TextToHtmlTokenizer 2', () => {
            const mode = disposables.add(instantiationService.createInstance(Mode));
            let support = languages_1.TokenizationRegistry.get(mode.languageId);
            let actual = (0, textToHtmlTokenizer_1._tokenizeToString)('.abc..def...gh\n.abc..def...gh', new languagesRegistry_1.LanguageIdCodec(), support);
            let expected1 = [
                { className: 'mtk7', text: '.' },
                { className: 'mtk9', text: 'abc' },
                { className: 'mtk7', text: '..' },
