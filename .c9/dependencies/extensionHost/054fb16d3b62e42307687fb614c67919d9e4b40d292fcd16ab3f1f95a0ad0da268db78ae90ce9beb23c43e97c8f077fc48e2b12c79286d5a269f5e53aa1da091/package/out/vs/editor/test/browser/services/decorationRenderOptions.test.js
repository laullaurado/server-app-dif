 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/base/common/platform", "vs/base/common/uri", "vs/editor/test/browser/editorTestServices", "vs/platform/theme/test/common/testThemeService"], function (require, exports, assert, platform, uri_1, editorTestServices_1, testThemeService_1) {
    "use strict";
    ...
    suite('Decoration Render Options', () => {
        ...
        test('register and resolve decoration type', () => {
            let s = new editorTestServices_1.TestCodeEditorService(themeServiceMock);
        ...
        test('css properties', () => {
            const s = new editorTestServices_1.TestCodeEditorService(themeServiceMock);
        ...
        test('theme color', () => {
            ...
            const s = new editorTestServices_1.TestCodeEditorService(themeService);
            const styleSheet = s.globalStyleSheet;
            s.registerDecorationType('test', 'example', options);
