...
define(["require", "exports", "vs/base/browser/dom", "vs/base/browser/ui/aria/aria", "vs/base/browser/ui/scrollbar/scrollableElement", "vs/base/common/codicons", "vs/base/common/event", "vs/base/common/lifecycle", "vs/base/common/strings", "vs/base/common/types", "vs/editor/common/languages/language", "vs/editor/common/services/languageFeatures", "vs/editor/contrib/markdownRenderer/browser/markdownRenderer", "vs/editor/contrib/parameterHints/browser/parameterHintsModel", "vs/editor/contrib/parameterHints/browser/provideSignatureHelp", "vs/nls", "vs/platform/contextkey/common/contextkey", "vs/platform/opener/common/opener", "vs/platform/theme/common/colorRegistry", "vs/platform/theme/common/iconRegistry", "vs/platform/theme/common/theme", "vs/platform/theme/common/themeService", "vs/css!./parameterHints"], function (require, exports, dom, aria, scrollableElement_1, codicons_1, event_1, lifecycle_1, strings_1, types_1, language_1, languageFeatures_1, markdownRenderer_1, parameterHintsModel_1, provideSignatureHelp_1, nls, contextkey_1, opener_1, colorRegistry_1, iconRegistry_1, theme_1, themeService_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.editorHoverWidgetHighlightForeground = exports.ParameterHintsWidget = void 0;
    const $ = dom.$;
    ...
    let ParameterHintsWidget = class ParameterHintsWidget extends lifecycle_1.Disposable {
        ...
        createParameterHintDOMNodes() {
            ...
            const previous = dom.append(controls, $('.button' + themeService_1.ThemeIcon.asCSSSelector(parameterHintsPreviousIcon)));
            const overloads = dom.append(controls, $('.overloads'));
            const next = dom.append(controls, $('.button' + themeService_1.ThemeIcon.asCSSSelector(parameterHintsNextIcon)));
            ...
            updateFont();
            this._register(event_1.Event.chain(this.editor.onDidChangeConfiguration.bind(this.editor))
                .filter(e => e.hasChanged(45 /* EditorOption.fontInfo */))
                .on(updateFont, null));
    ...
    (0, themeService_1.registerThemingParticipant)((theme, collector) => {
        ...
        const parameterHighlightColor = theme.getColor(exports.editorHoverWidgetHighlightForeground);
