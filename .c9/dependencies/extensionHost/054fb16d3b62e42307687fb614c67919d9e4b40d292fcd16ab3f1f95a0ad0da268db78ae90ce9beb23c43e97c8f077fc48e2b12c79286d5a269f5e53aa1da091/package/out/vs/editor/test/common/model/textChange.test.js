 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/editor/common/core/textChange"], function (require, exports, assert, textChange_1) {
    "use strict";
    ...
    suite('TextChangeCompressor', () => {
        ...
        function getTextChanges(initialContent, edits) {
            let content = initialContent;
            let changes = new Array(edits.length);
            let deltaOffset = 0;
        ...
        function assertCompression(initialText, edit1, edit2) {
            ...
            let compressedTextChanges = (0, textChange_1.compressConsecutiveTextChanges)(chg1, chg2);
            // Check that the compression was correct
            let compressedDoTextEdits = compressedTextChanges.map((change) => {
                return {
            ...
            let compressedUndoTextEdits = compressedTextChanges.map((change) => {
                return {
