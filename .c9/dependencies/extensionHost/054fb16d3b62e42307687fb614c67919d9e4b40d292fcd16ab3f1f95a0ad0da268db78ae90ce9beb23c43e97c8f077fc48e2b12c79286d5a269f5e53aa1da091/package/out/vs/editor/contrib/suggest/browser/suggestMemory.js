...
define(["require", "exports", "vs/base/common/async", "vs/base/common/lifecycle", "vs/base/common/map", "vs/editor/common/languages", "vs/platform/configuration/common/configuration", "vs/platform/instantiation/common/extensions", "vs/platform/instantiation/common/instantiation", "vs/platform/storage/common/storage"], function (require, exports, async_1, lifecycle_1, map_1, languages_1, configuration_1, extensions_1, instantiation_1, storage_1) {
    "use strict";
        ...
        _withStrategy(model, pos) {
            ...
            if (((_a = this._strategy) === null || _a === void 0 ? void 0 : _a.name) !== mode) {
                ...
                try {
                    ...
                    const scope = share ? 0 /* StorageScope.GLOBAL */ : 1 /* StorageScope.WORKSPACE */;
