...
define(["require", "exports", "vs/base/browser/dom", "vs/base/common/actions", "vs/base/common/errors", "vs/base/common/lazy", "vs/base/common/lifecycle", "vs/editor/common/core/position", "vs/editor/common/services/languageFeatures", "vs/editor/contrib/codeAction/browser/codeAction", "vs/editor/contrib/codeAction/browser/types", "vs/platform/contextview/browser/contextView", "vs/platform/keybinding/common/keybinding"], function (require, exports, dom_1, actions_1, errors_1, lazy_1, lifecycle_1, position_1, languageFeatures_1, codeAction_1, types_1, contextView_1, keybinding_1) {
    "use strict";
    ...
    let CodeActionMenu = class CodeActionMenu extends lifecycle_1.Disposable {
        ...
        async show(trigger, codeActions, at, options) {
            ...
            const useShadowDOM = this._editor.getOption(116 /* EditorOption.useShadowDOM */);
        ...
        getMenuActions(trigger, actionsToShow, documentation) {
            ...
            if (allDocumentation.length) {
                result.push(new actions_1.Separator(), ...allDocumentation.map(command => toCodeActionAction(new codeAction_1.CodeActionItem({
                    title: command.title,
                    command: command,
                }, undefined))));
            }
