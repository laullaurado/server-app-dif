 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/editor/common/tokens/sparseMultilineTokens", "vs/editor/common/tokens/sparseTokensStore", "vs/editor/common/core/range", "vs/editor/common/core/position", "vs/editor/common/encodedTokenAttributes", "vs/editor/test/common/testTextModel", "vs/editor/common/tokens/lineTokens", "vs/editor/common/services/languagesRegistry", "vs/base/common/lifecycle", "vs/platform/instantiation/common/serviceCollection", "vs/editor/common/languages/languageConfigurationRegistry", "vs/platform/instantiation/common/descriptors"], function (require, exports, assert, sparseMultilineTokens_1, sparseTokensStore_1, range_1, position_1, encodedTokenAttributes_1, testTextModel_1, lineTokens_1, languagesRegistry_1, lifecycle_1, serviceCollection_1, languageConfigurationRegistry_1, descriptors_1) {
    "use strict";
    ...
    suite('TokensStore', () => {
        ...
        test('issue #147944: Language id "vs.editor.nullLanguage" is not configured nor known', () => {
            ...
            const instantiationService = (0, testTextModel_1.createModelServices)(disposables, new serviceCollection_1.ServiceCollection([
                languageConfigurationRegistry_1.ILanguageConfigurationService, new descriptors_1.SyncDescriptor(languageConfigurationRegistry_1.LanguageConfigurationService)
            ]));
            const model = (0, testTextModel_1.instantiateTextModel)(instantiationService, '--[[\n\n]]');
            model.tokenization.setSemanticTokens([
                sparseMultilineTokens_1.SparseMultilineTokens.create(1, new Uint32Array([
