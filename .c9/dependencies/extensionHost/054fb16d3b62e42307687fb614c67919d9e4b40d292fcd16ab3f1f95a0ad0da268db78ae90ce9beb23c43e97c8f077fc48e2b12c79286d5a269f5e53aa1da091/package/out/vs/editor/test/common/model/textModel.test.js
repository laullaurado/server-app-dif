 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/base/common/lifecycle", "vs/base/common/strings", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/languages/modesRegistry", "vs/editor/common/model/textModel", "vs/editor/test/common/testTextModel"], function (require, exports, assert, lifecycle_1, strings_1, position_1, range_1, modesRegistry_1, textModel_1, testTextModel_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    function testGuessIndentation(defaultInsertSpaces, defaultTabSize, expectedInsertSpaces, expectedTabSize, text, msg) {
        let m = (0, testTextModel_1.createTextModel)(text.join('\n'), undefined, {
    ...
    suite('Editor Model - TextModel', () => {
        ...
        test('validatePosition', () => {
            let m = (0, testTextModel_1.createTextModel)('line one\nline two');
        ...
        test('validatePosition around high-low surrogate pairs 1', () => {
            let m = (0, testTextModel_1.createTextModel)('a📚b');
            assert.deepStrictEqual(m.validatePosition(new position_1.Position(0, 0)), new position_1.Position(1, 1));
            assert.deepStrictEqual(m.validatePosition(new position_1.Position(0, 1)), new position_1.Position(1, 1));
        ...
        test('normalizeIndentation 1', () => {
            let model = (0, testTextModel_1.createTextModel)('', undefined, {
                insertSpaces: false
            });
    ...
    suite('TextModel.mightContainRTL', () => {
        test('nope', () => {
            let model = (0, testTextModel_1.createTextModel)('hello world!');
            assert.strictEqual(model.mightContainRTL(), false);
            model.dispose();
        });
        test('yes', () => {
            let model = (0, testTextModel_1.createTextModel)('Hello,\nזוהי עובדה מבוססת שדעתו');
    ...
    suite('TextModel.createSnapshot', () => {
        ...
        test('file with BOM', () => {
            let model = (0, testTextModel_1.createTextModel)(strings_1.UTF8_BOM_CHARACTER + 'Hello');
        ...
        test('regular file', () => {
            let model = (0, testTextModel_1.createTextModel)('My First Line\n\t\tMy Second Line\n    Third Line\n\n1');
            let snapshot = model.createSnapshot();
