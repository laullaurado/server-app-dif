define(["require", "exports", "assert", "vs/editor/common/config/editorOptions", "vs/editor/common/viewModel/monospaceLineBreaksComputer", "vs/editor/common/config/fontInfo", "vs/editor/common/modelLineProjectionData"], function (require, exports, assert, editorOptions_1, monospaceLineBreaksComputer_1, fontInfo_1, modelLineProjectionData_1) {
    "use strict";
    ...
    function getLineBreakData(factory, tabSize, breakAfter, columnsForFullWidthChar, wrappingIndent, text, previousLineBreakData) {
    ...
    function assertLineBreaks(factory, tabSize, breakAfter, annotatedText, wrappingIndent = 0 /* WrappingIndent.None */) {
