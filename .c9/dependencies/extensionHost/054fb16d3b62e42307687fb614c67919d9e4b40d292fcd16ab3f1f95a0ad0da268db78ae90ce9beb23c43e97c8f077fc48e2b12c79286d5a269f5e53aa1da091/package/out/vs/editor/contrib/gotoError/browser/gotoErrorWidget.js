    ...
    class MessageWidget {
        ...
        update(marker) {
            ...
            if ((0, arrays_1.isNonEmptyArray)(relatedInformation)) {
                ...
                relatedInformationNode.style.paddingTop = `${Math.floor(this._editor.getOption(60 /* EditorOption.lineHeight */) * 0.66)}px`;
                this._lines += 1;
            ...
            const fontInfo = this._editor.getOption(45 /* EditorOption.fontInfo */);
