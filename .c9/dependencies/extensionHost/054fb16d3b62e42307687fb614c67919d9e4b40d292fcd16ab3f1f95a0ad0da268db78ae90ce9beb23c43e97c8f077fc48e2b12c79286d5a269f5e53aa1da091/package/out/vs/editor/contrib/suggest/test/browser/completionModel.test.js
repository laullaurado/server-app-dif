define(["require", "exports", "assert", "vs/editor/common/config/editorOptions", "vs/editor/contrib/suggest/browser/completionModel", "vs/editor/contrib/suggest/browser/suggest", "vs/editor/contrib/suggest/browser/wordDistance"], function (require, exports, assert, editorOptions_1, completionModel_1, suggest_1, wordDistance_1) {
    ...
    suite('CompletionModel', function () {
        ...
        test('replaceIncomplete', () => {
            ...
            const model = new completionModel_1.CompletionModel([completeItem, incompleteItem], 2, { leadingLineContent: 'f', characterCountDelta: 0 }, wordDistance_1.WordDistance.None, editorOptions_1.EditorOptions.suggest.defaultValue, editorOptions_1.EditorOptions.snippetSuggestions.defaultValue, undefined);
