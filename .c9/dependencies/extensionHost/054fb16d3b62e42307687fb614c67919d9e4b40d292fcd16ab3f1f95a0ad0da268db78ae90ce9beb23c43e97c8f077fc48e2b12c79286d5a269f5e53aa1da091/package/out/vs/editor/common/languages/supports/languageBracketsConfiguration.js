 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/common/cache", "vs/base/common/errors"], function (require, exports, cache_1, errors_1) {
    "use strict";
        ...
        closes(other) {
            if (other.languageId === this.languageId) {
                if (other['config'] !== this.config) {
                    throw new errors_1.BugIndicatingError('Brackets from different language configuration cannot be used.');
                }
            }
