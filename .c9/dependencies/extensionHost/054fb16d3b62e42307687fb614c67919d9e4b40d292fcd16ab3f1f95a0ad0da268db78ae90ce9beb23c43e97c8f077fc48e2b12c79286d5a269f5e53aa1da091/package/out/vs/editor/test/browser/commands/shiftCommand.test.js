...
define(["require", "exports", "assert", "vs/editor/common/commands/shiftCommand", "vs/editor/common/core/range", "vs/editor/common/core/selection", "vs/editor/common/languages/languageConfigurationRegistry", "vs/editor/test/browser/testCommand", "vs/editor/test/common/testTextModel", "vs/editor/test/common/modes/supports/javascriptOnEnterRules", "vs/editor/test/common/modes/testLanguageConfigurationService", "vs/editor/common/languages/language", "vs/base/common/lifecycle"], function (require, exports, assert, shiftCommand_1, range_1, selection_1, languageConfigurationRegistry_1, testCommand_1, testTextModel_1, javascriptOnEnterRules_1, testLanguageConfigurationService_1, language_1, lifecycle_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.createSingleEditOp = void 0;
    /**
    ...
    DocBlockCommentMode = __decorate([
    ...
    suite('Editor Commands - ShiftCommand', () => {
        ...
        test('issue #1620: a) Line indent doesn\'t handle leading whitespace properly', () => {
            (0, testCommand_1.testCommand)([
                ...
                useTabStops: false,
                autoIndent: 4 /* EditorAutoIndentStrategy.Full */,
            }, new testLanguageConfigurationService_1.TestLanguageConfigurationService()), [
                '       Written | Numeric',
                '           one | 1',
                '           two | 2',
                '         three | 3',
        ...
        test('bug #16815:Shift+Tab doesn\'t go back to tabstop', () => {
            ...
            function _assertUnshiftCommand(tabSize, indentSize, insertSpaces, text, expected) {
                return (0, testTextModel_1.withEditorModel)(text, (model) => {
                    ...
                    let actual = (0, testCommand_1.getEditOperation)(model, op);
