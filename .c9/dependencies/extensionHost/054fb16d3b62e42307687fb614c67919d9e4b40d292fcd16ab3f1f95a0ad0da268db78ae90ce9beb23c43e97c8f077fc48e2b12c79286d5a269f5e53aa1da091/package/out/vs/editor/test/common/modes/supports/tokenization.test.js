 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/editor/common/languages/supports/tokenization"], function (require, exports, assert, tokenization_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    suite('Token theme matching', () => {
        test('gives higher priority to deeper matches', () => {
            let theme = tokenization_1.TokenTheme.createFromRawTokenTheme([
            ...
            let colorMap = new tokenization_1.ColorMap();
    ...
    suite('Token theme parsing', () => {
        test('can parse', () => {
            let actual = (0, tokenization_1.parseTokenTheme)([
                { token: '', foreground: 'F8F8F2', background: '272822' },
                { token: 'source', background: '100000' },
                { token: 'something', background: '100000' },
    ...
    suite('Token theme resolving', () => {
        test('strcmp works', () => {
            let actual = ['bar', 'z', 'zu', 'a', 'ab', ''].sort(tokenization_1.strcmp);
            let expected = ['', 'a', 'ab', 'bar', 'z', 'zu'];
            assert.deepStrictEqual(actual, expected);
        });
        test('always has defaults', () => {
            let actual = tokenization_1.TokenTheme.createFromParsedTokenTheme([], []);
            let colorMap = new tokenization_1.ColorMap();
