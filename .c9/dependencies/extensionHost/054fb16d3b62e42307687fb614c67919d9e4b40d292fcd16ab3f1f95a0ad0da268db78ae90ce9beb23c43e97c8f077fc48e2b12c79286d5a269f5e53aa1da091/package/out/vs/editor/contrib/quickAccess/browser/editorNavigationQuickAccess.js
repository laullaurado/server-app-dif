 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/common/functional", "vs/base/common/lifecycle", "vs/base/common/types", "vs/editor/browser/editorBrowser", "vs/editor/common/model", "vs/editor/common/core/editorColorRegistry", "vs/platform/theme/common/themeService"], function (require, exports, functional_1, lifecycle_1, types_1, editorBrowser_1, model_1, editorColorRegistry_1, themeService_1) {
    "use strict";
        ...
        doProvide(picker, token) {
            ...
            if (editor && this.canProvideWithTextEditor(editor)) {
                ...
                if (codeEditor) {
                    ...
                    let lastKnownEditorViewState = (0, types_1.withNullAsUndefined)(editor.saveViewState());
                    disposables.add(codeEditor.onDidChangeCursorPosition(() => {
                        lastKnownEditorViewState = (0, types_1.withNullAsUndefined)(editor.saveViewState());
                    }));
                    ...
                    disposables.add((0, functional_1.once)(token.onCancellationRequested)(() => { var _a; return (_a = context.restoreViewState) === null || _a === void 0 ? void 0 : _a.call(context); }));
                }
