...
define(["require", "exports", "vs/base/common/async", "vs/base/common/color", "vs/base/common/errors", "vs/base/common/lifecycle", "vs/base/common/stopwatch", "vs/base/common/strings", "vs/editor/browser/editorDom", "vs/editor/browser/editorExtensions", "vs/editor/common/core/range", "vs/editor/common/model/textModel", "vs/editor/common/services/languageFeatureDebounce", "vs/editor/common/services/languageFeatures", "vs/editor/contrib/colorPicker/browser/color", "vs/platform/configuration/common/configuration"], function (require, exports, async_1, color_1, errors_1, lifecycle_1, stopwatch_1, strings_1, editorDom_1, editorExtensions_1, range_1, textModel_1, languageFeatureDebounce_1, languageFeatures_1, color_2, configuration_1) {
    "use strict";
    ...
    let ColorDetector = class ColorDetector extends lifecycle_1.Disposable {
        ...
        beginCompute() {
            this._computePromise = (0, async_1.createCancelablePromise)(async (token) => {
                ...
                const colors = await (0, color_2.getColors)(this._languageFeaturesService.colorProvider, model, token);
