 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/editor/common/core/range", "vs/editor/common/model/mirrorTextModel", "vs/editor/test/common/model/editableTextModelTestUtils", "vs/editor/test/common/testTextModel"], function (require, exports, assert, range_1, mirrorTextModel_1, editableTextModelTestUtils_1, testTextModel_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    suite('EditorModel - EditableTextModel.applyEdits updates mightContainRTL', () => {
        function testApplyEdits(original, edits, before, after) {
            let model = (0, testTextModel_1.createTextModel)(original.join('\n'));
