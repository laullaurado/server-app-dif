        ...
        constructor(_viewZoneId, _marginDomNode, editor, diff, _contextMenuService, _clipboardService) {
            ...
            actions.push(new actions_1.Action('diff.clipboard.copyDeletedContent', isDeletion
                ...
                : (diff.originalEndLineNumber > diff.modifiedStartLineNumber
                    ...
                    : nls.localize('diff.clipboard.copyChangedLinesContent.single.label', "Copy changed line")), undefined, true, async () => {
            ...
            if (diff.originalEndLineNumber > diff.modifiedStartLineNumber) {
                copyLineAction = new actions_1.Action('diff.clipboard.copyDeletedLineContent', isDeletion
                    ...
                    : nls.localize('diff.clipboard.copyChangedLineContent.label', "Copy changed line ({0})", diff.originalStartLineNumber), undefined, true, async () => {
                    ...
                    if (lineContent === '') {
                        ...
                        await this._clipboardService.writeText(eof === 0 /* EndOfLineSequence.LF */ ? '\n' : '\r\n');
                    }
                    else {
            ...
            const readOnly = editor.getOption(82 /* EditorOption.readOnly */);
            if (!readOnly) {
