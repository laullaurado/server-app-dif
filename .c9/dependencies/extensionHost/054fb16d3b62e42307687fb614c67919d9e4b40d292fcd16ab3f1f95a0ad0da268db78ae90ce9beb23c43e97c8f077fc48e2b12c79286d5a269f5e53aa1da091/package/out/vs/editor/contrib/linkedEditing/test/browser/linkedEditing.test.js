 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/base/common/lifecycle", "vs/base/common/uri", "vs/editor/browser/coreCommands", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/core/wordHelper", "vs/editor/common/languages/languageConfigurationRegistry", "vs/editor/contrib/linkedEditing/browser/linkedEditing", "vs/editor/test/browser/testCodeEditor", "vs/editor/test/common/testTextModel", "vs/editor/common/services/languageFeatures", "vs/editor/contrib/wordOperations/browser/wordOperations", "vs/editor/contrib/linesOperations/browser/linesOperations", "vs/base/test/common/timeTravelScheduler"], function (require, exports, assert, lifecycle_1, uri_1, coreCommands_1, position_1, range_1, wordHelper_1, languageConfigurationRegistry_1, linkedEditing_1, testCodeEditor_1, testTextModel_1, languageFeatures_1, wordOperations_1, linesOperations_1, timeTravelScheduler_1) {
    "use strict";
