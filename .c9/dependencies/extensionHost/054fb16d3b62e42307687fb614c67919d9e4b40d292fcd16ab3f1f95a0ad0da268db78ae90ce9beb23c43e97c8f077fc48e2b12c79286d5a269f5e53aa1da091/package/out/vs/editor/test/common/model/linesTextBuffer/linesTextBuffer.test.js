 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/editor/common/core/range", "vs/editor/common/model/pieceTreeTextBuffer/pieceTreeTextBuffer", "vs/editor/common/model/textModel"], function (require, exports, assert, range_1, pieceTreeTextBuffer_1, textModel_1) {
    "use strict";
    ...
    suite('PieceTreeTextBuffer._getInverseEdits', () => {
        ...
        function assertInverseEdits(ops, expected) {
            let actual = pieceTreeTextBuffer_1.PieceTreeTextBuffer._getInverseEditRanges(ops);
    ...
    suite('PieceTreeTextBuffer._toSingleEditOperation', () => {
        ...
        function testToSingleEditOperation(original, edits, expected) {
            const textBuffer = (0, textModel_1.createTextBufferFactory)(original.join('\n')).create(1 /* DefaultEndOfLine.LF */).textBuffer;
