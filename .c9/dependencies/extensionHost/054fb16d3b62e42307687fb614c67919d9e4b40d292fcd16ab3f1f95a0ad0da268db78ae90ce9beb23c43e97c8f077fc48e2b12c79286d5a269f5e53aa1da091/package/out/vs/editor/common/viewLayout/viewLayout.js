...
define(["require", "exports", "vs/base/common/event", "vs/base/common/lifecycle", "vs/base/common/scrollable", "vs/editor/common/viewLayout/linesLayout", "vs/editor/common/viewModel", "vs/editor/common/viewModelEventDispatcher"], function (require, exports, event_1, lifecycle_1, scrollable_1, linesLayout_1, viewModel_1, viewModelEventDispatcher_1) {
    ...
    class ViewLayout extends lifecycle_1.Disposable {
        constructor(configuration, lineCount, scheduleAtNextAnimationFrame) {
            ...
            this._linesLayout = new linesLayout_1.LinesLayout(lineCount, options.get(60 /* EditorOption.lineHeight */), padding.top, padding.bottom);
        ...
        _configureSmoothScrollDuration() {
            this._scrollable.setSmoothScrollDuration(this._configuration.options.get(104 /* EditorOption.smoothScrolling */) ? SMOOTH_SCROLLING_TIME : 0);
        }
        // ---- begin view event handlers
        onConfigurationChanged(e) {
            const options = this._configuration.options;
            if (e.hasChanged(60 /* EditorOption.lineHeight */)) {
                this._linesLayout.setLineHeight(options.get(60 /* EditorOption.lineHeight */));
            }
            if (e.hasChanged(76 /* EditorOption.padding */)) {
                const padding = options.get(76 /* EditorOption.padding */);
            ...
            if (e.hasChanged(104 /* EditorOption.smoothScrolling */)) {
                this._configureSmoothScrollDuration();
            }
        }
        onFlushed(lineCount) {
        ...
        _getContentHeight(width, height, contentWidth) {
            ...
            if (options.get(95 /* EditorOption.scrollBeyondLastLine */)) {
                result += Math.max(0, height - options.get(60 /* EditorOption.lineHeight */) - options.get(76 /* EditorOption.padding */).bottom);
            }
            else {
        ...
        _computeContentWidth(maxLineWidth) {
            ...
            if (wrappingInfo.isViewportWrapping) {
                ...
                const extraHorizontalSpace = options.get(94 /* EditorOption.scrollBeyondLastColumn */) * fontInfo.typicalHalfwidthCharacterWidth;
