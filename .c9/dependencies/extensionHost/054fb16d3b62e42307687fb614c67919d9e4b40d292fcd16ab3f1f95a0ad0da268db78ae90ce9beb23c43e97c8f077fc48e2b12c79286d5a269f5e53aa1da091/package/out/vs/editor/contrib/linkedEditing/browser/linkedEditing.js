    ...
    let LinkedEditingContribution = class LinkedEditingContribution extends lifecycle_1.Disposable {
        constructor(editor, contextKeyService, languageFeaturesService, languageConfigurationService, languageFeatureDebounceService) {
            ...
            this._register(this._editor.onDidChangeConfiguration(e => {
                if (e.hasChanged(63 /* EditorOption.linkedEditing */) || e.hasChanged(83 /* EditorOption.renameOnType */)) {
        ...
        reinitialize(forceRefresh) {
            ...
            const isEnabled = model !== null && (this._editor.getOption(63 /* EditorOption.linkedEditing */) || this._editor.getOption(83 /* EditorOption.renameOnType */)) && this._providers.has(model);
