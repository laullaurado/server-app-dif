define(["require", "exports", "assert", "vs/base/common/strings", "vs/editor/common/core/editOperation", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/model/textModel", "vs/editor/contrib/folding/browser/foldingModel", "vs/editor/contrib/folding/browser/indentRangeProvider", "vs/editor/test/common/testTextModel"], function (require, exports, assert, strings_1, editOperation_1, position_1, range_1, textModel_1, foldingModel_1, indentRangeProvider_1, testTextModel_1) {
    ...
    TestDecorationProvider.collapsedDecoration = textModel_1.ModelDecorationOptions.register({
        description: 'test',
        stickiness: 1 /* TrackedRangeStickiness.NeverGrowsWhenTypingAtEdges */,
        linesDecorationsClassName: 'folding'
    });
    TestDecorationProvider.expandedDecoration = textModel_1.ModelDecorationOptions.register({
        description: 'test',
        stickiness: 1 /* TrackedRangeStickiness.NeverGrowsWhenTypingAtEdges */,
        linesDecorationsClassName: 'folding'
    });
    TestDecorationProvider.hiddenDecoration = textModel_1.ModelDecorationOptions.register({
        description: 'test',
        stickiness: 1 /* TrackedRangeStickiness.NeverGrowsWhenTypingAtEdges */,
        linesDecorationsClassName: 'folding'
    });
    suite('Folding Model', () => {
        ...
        test('getRegionAtLine', () => {
            ...
            try {
                let foldingModel = new foldingModel_1.FoldingModel(textModel, new TestDecorationProvider(textModel));
                let ranges = (0, indentRangeProvider_1.computeRanges)(textModel, false, { start: /^\/\/#region$/, end: /^\/\/#endregion$/ });
                foldingModel.update(ranges);
                let r1 = r(1, 10, false);
                let r2 = r(2, 8, false);
                let r3 = r(3, 7, false);
        ...
        test('setCollapseStateAtLevel', () => {
            ...
            try {
                let foldingModel = new foldingModel_1.FoldingModel(textModel, new TestDecorationProvider(textModel));
                let ranges = (0, indentRangeProvider_1.computeRanges)(textModel, false, { start: /^\s*\/\/#region$/, end: /^\s*\/\/#endregion$/ });
                foldingModel.update(ranges);
                let r1 = r(1, 2, false);
                let r2 = r(3, 15, false);
                let r3 = r(4, 11, false);
        ...
        test('setCollapseStateForMatchingLines', () => {
            ...
            try {
                ...
                let r5 = r(9, 11, false);
                assertRanges(foldingModel, [r1, r2, r3, r4, r5]);
                let regExp = new RegExp('^\\s*' + (0, strings_1.escapeRegExpCharacters)('/*'));
