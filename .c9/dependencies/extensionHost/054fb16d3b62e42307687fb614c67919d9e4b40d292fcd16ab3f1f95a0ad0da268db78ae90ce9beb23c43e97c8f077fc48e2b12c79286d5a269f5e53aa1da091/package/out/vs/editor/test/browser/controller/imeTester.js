 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/editor/browser/controller/textAreaInput", "vs/editor/browser/controller/textAreaState", "vs/editor/common/core/range", "vs/base/browser/dom", "vs/base/browser/browser", "vs/base/common/platform"], function (require, exports, textAreaInput_1, textAreaState_1, range_1, dom, browser, platform) {
    "use strict";
    ...
    function doCreateTest(description, inputStr, expectedStr) {
        ...
        let handler = new textAreaInput_1.TextAreaInput(textAreaInputHost, new textAreaInput_1.TextAreaWrapper(input), platform.OS, browser);
