 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/base/common/event", "vs/base/common/lifecycle", "vs/editor/browser/controller/textAreaInput", "vs/editor/browser/controller/textAreaState"], function (require, exports, assert, event_1, lifecycle_1, textAreaInput_1, textAreaState_1) {
    "use strict";
        ...
        async function simulateInteraction(recorded) {
            ...
            const host = {
                ...
                getScreenReaderContent: function (currentState) {
                    return new textAreaState_1.TextAreaState('', 0, 0, null, null);
                },
                deduceModelPosition: function (viewAnchorPosition, deltaOffset, lineFeedCnt) {
                    throw new Error('Function not implemented.');
                }
            };
            const wrapper = disposables.add(new class extends lifecycle_1.Disposable {
                constructor() {
                    super();
                    ...
                    this._onBeforeInput = this._register(new event_1.Emitter());
                    ...
                    this.onCut = event_1.Event.None;
                    this.onCopy = event_1.Event.None;
                    this.onPaste = event_1.Event.None;
                    this.onFocus = event_1.Event.None;
                    this.onBlur = event_1.Event.None;
                    this.onSyntheticTap = event_1.Event.None;
                    this._state = {
                ...
                setValue(reason, value) {
                    var _a;
                    if (((_a = this._currDispatchingEvent) === null || _a === void 0 ? void 0 : _a.type) === 'compositionstart') {
            ...
            const input = disposables.add(new textAreaInput_1.TextAreaInput(host, wrapper, recorded.env.OS, recorded.env.browser));
