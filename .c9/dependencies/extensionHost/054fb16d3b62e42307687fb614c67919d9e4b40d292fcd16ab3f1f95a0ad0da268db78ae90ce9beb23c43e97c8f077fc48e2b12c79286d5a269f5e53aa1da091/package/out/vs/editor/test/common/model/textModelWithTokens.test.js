 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/base/common/lifecycle", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/languages", "vs/editor/common/languages/languageConfigurationRegistry", "vs/editor/common/languages/nullTokenize", "vs/editor/common/languages/language", "vs/editor/test/common/core/testLineToken", "vs/editor/test/common/testTextModel"], function (require, exports, assert, lifecycle_1, position_1, range_1, languages_1, languageConfigurationRegistry_1, nullTokenize_1, language_1, testLineToken_1, testTextModel_1) {
    "use strict";
    ...
    suite('TextModelWithTokens regression tests', () => {
        test('microsoft/monaco-editor#122: Unhandled Exception: TypeError: Unable to get property \'replace\' of undefined or null reference', () => {
            ...
            let registration1 = languages_1.TokenizationRegistry.register(LANG_ID1, tokenizationSupport);
            let registration2 = languages_1.TokenizationRegistry.register(LANG_ID2, tokenizationSupport);
            let model = (0, testTextModel_1.createTextModel)('A model with\ntwo lines');
            ...
            function createViewLineToken(endIndex, foreground) {
                let metadata = ((foreground << 15 /* MetadataConsts.FOREGROUND_OFFSET */)) >>> 0;
    ...
    suite('TextModel.getLineIndentGuide', () => {
        function assertIndentGuides(lines, tabSize) {
            ...
            let model = disposables.add((0, testTextModel_1.instantiateTextModel)(instantiationService, text, languageId));
