 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/editor/common/core/wordCharacterClassifier", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/model", "vs/editor/common/model/textModelSearch", "vs/editor/common/core/wordHelper", "vs/editor/test/common/testTextModel"], function (require, exports, assert, wordCharacterClassifier_1, position_1, range_1, model_1, textModelSearch_1, wordHelper_1, testTextModel_1) {
    "use strict";
    ...
    suite('TextModelSearch', () => {
        ...
        function assertFindMatches(text, searchString, isRegex, matchCase, wordSeparators, _expected) {
            ...
            model.dispose();
            let model2 = (0, testTextModel_1.createTextModel)(text);
        ...
        test('findNextMatch without regex', () => {
            let model = (0, testTextModel_1.createTextModel)('line line one\nline two\nthree');
        ...
        test('findNextMatch with beginning boundary regex', () => {
            let model = (0, testTextModel_1.createTextModel)('line one\nline two\nthree');
        ...
        test('findNextMatch with ending boundary regex', () => {
            let model = (0, testTextModel_1.createTextModel)('one line line\ntwo line\nthree');
            let searchParams = new textModelSearch_1.SearchParams('line$', true, false, null);
            let actual = textModelSearch_1.TextModelSearch.findNextMatch(model, searchParams, new position_1.Position(1, 1), false);
        ...
        test('\\n matches \\r\\n', () => {
            let model = (0, testTextModel_1.createTextModel)('a\r\nb\r\nc\r\nd\r\ne\r\nf\r\ng\r\nh\r\ni');
        ...
        test('issue #74715. \\d* finds empty string and stops searching.', () => {
            let model = (0, testTextModel_1.createTextModel)('10.243.30.10');
