 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/common/strings", "vs/editor/common/core/range", "vs/editor/common/model"], function (require, exports, strings_1, range_1, model_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.generateRandomChunkWithLF = exports.generateRandomReplaces = exports.generateSequentialInserts = exports.generateRandomEdits = exports.getRandomString = exports.getRandomEOLSequence = exports.getRandomInt = void 0;
    ...
    function generateRandomEdits(chunks, editCnt) {
        ...
        for (const chunk of chunks) {
            let newLines = (0, strings_1.splitLines)(chunk);
            if (lines.length === 0) {
                lines.push(...newLines);
            }
            else {
        ...
        for (let i = 0; i < editCnt; i++) {
            ...
            ops.push(new model_1.ValidAnnotatedEditOperation(null, new range_1.Range(line, startColumn, line, endColumn), text, false, false, false));
    ...
    function generateSequentialInserts(chunks, editCnt) {
        ...
        for (let i = 0; i < editCnt; i++) {
            ...
            ops.push(new model_1.ValidAnnotatedEditOperation(null, new range_1.Range(line, column, line, column), text, false, false, false));
        }
        return ops;
    }
    ...
    function generateRandomReplaces(chunks, editCnt, searchStringLen, replaceStringLen) {
        ...
        for (let i = 0; i < chunkCnt; i++) {
            ...
            ops.push(new model_1.ValidAnnotatedEditOperation(null, new range_1.Range(line, startColumn, line, endColumn), replaceString, false, false, false));
    ...
    function generateRandomChunkWithLF(minLength, maxLength) {
        ...
        let r = '';
        for (let i = 0; i < length; i++) {
            let randomI = getRandomInt(0, 122 /* CharCode.z */ - 97 /* CharCode.a */ + 1);
            if (randomI === 0 && Math.random() < 0.3) {
                r += '\n';
            }
            else {
                r += String.fromCharCode(randomI + 97 /* CharCode.a */ - 1);
            }
        }
        return r;
    }
