...
define(["require", "exports", "vs/base/browser/dom", "vs/base/browser/mouseEvent", "vs/base/common/async", "vs/base/common/lifecycle", "vs/base/common/platform", "vs/editor/browser/controller/mouseTarget", "vs/editor/browser/editorDom", "vs/editor/common/config/editorZoom", "vs/editor/common/core/position", "vs/editor/common/core/selection", "vs/editor/common/viewEventHandler"], function (require, exports, dom, mouseEvent_1, async_1, lifecycle_1, platform, mouseTarget_1, editorDom_1, editorZoom_1, position_1, selection_1, viewEventHandler_1) {
    ...
    class MouseHandler extends viewEventHandler_1.ViewEventHandler {
        constructor(context, viewController, viewHelper) {
            ...
            this._height = this._context.configuration.options.get(132 /* EditorOption.layoutInfo */).height;
            ...
            const onMouseWheel = (browserEvent) => {
                ...
                if (!this._context.configuration.options.get(69 /* EditorOption.mouseWheelZoom */)) {
                    return;
                }
        ...
        onConfigurationChanged(e) {
            if (e.hasChanged(132 /* EditorOption.layoutInfo */)) {
                // layout change
                const height = this._context.configuration.options.get(132 /* EditorOption.layoutInfo */).height;
        ...
        _onMouseDown(e, pointerId) {
            ...
            const selectOnLineNumbers = this._context.configuration.options.get(99 /* EditorOption.selectOnLineNumbers */);
