...
define(["require", "exports", "vs/base/common/async", "vs/base/common/cancellation", "vs/base/common/color", "vs/base/common/lifecycle", "vs/editor/common/core/range", "vs/editor/contrib/colorPicker/browser/color", "vs/editor/contrib/colorPicker/browser/colorDetector", "vs/editor/contrib/colorPicker/browser/colorPickerModel", "vs/editor/contrib/colorPicker/browser/colorPickerWidget", "vs/platform/theme/common/themeService"], function (require, exports, async_1, cancellation_1, color_1, lifecycle_1, range_1, color_2, colorDetector_1, colorPickerModel_1, colorPickerWidget_1, themeService_1) {
    "use strict";
    ...
    let ColorHoverParticipant = class ColorHoverParticipant {
        ...
        renderHoverParts(context, hoverParts) {
            ...
            const widget = disposables.add(new colorPickerWidget_1.ColorPickerWidget(context.fragment, model, this._editor.getOption(130 /* EditorOption.pixelRatio */), this._themeService));
