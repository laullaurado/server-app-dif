 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/editor/common/commands/trimTrailingWhitespaceCommand", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/core/selection", "vs/editor/test/browser/testCommand", "vs/editor/test/common/testTextModel"], function (require, exports, assert, trimTrailingWhitespaceCommand_1, position_1, range_1, selection_1, testCommand_1, testTextModel_1) {
    "use strict";
    ...
    function assertTrimTrailingWhitespaceCommand(text, expected) {
        return (0, testTextModel_1.withEditorModel)(text, (model) => {
            let op = new trimTrailingWhitespaceCommand_1.TrimTrailingWhitespaceCommand(new selection_1.Selection(1, 1, 1, 1), []);
    ...
    function assertTrimTrailingWhitespace(text, cursors, expected) {
        return (0, testTextModel_1.withEditorModel)(text, (model) => {
            let actual = (0, trimTrailingWhitespaceCommand_1.trimTrailingWhitespace)(model, cursors);
            assert.deepStrictEqual(actual, expected);
        });
    }
