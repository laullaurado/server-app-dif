 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/editor/browser/coreCommands", "vs/editor/common/core/editOperation", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/core/selection", "vs/editor/common/model/textModel", "vs/editor/common/languages", "vs/editor/common/languages/languageConfiguration", "vs/editor/common/languages/languageConfigurationRegistry", "vs/editor/common/languages/nullTokenize", "vs/editor/test/browser/testCodeEditor", "vs/editor/test/common/testTextModel", "vs/editor/test/common/modes/supports/javascriptOnEnterRules", "vs/editor/common/languages/language", "vs/base/common/lifecycle"], function (require, exports, assert, coreCommands_1, editOperation_1, position_1, range_1, selection_1, textModel_1, languages_1, languageConfiguration_1, languageConfigurationRegistry_1, nullTokenize_1, testCodeEditor_1, testTextModel_1, javascriptOnEnterRules_1, language_1, lifecycle_1) {
    "use strict";
    ...
    suite('Editor Controller - Cursor', () => {
        ...
        test('issue #144041: Cursor up/down works', () => {
            let model = (0, testTextModel_1.createTextModel)([
        ...
        test('setSelection / setPosition with source', () => {
            ...
            let model = (0, testTextModel_1.createTextModel)('Just text', LANGUAGE_ID);
