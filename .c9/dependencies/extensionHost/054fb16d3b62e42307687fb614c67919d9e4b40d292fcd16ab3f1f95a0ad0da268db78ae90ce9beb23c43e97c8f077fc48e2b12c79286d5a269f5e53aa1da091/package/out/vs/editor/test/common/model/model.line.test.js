 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/editor/common/tokens/lineTokens", "vs/editor/common/core/range", "vs/editor/common/model/utils", "vs/editor/test/common/core/testLineToken", "vs/editor/test/common/testTextModel"], function (require, exports, assert, lineTokens_1, range_1, utils_1, testLineToken_1, testTextModel_1) {
    "use strict";
    ...
    function assertLineTokens(__actual, _expected) {
        ...
        let expected = testLineToken_1.TestLineTokenFactory.inflateArr(tmp);
    ...
    suite('ModelLine - getIndentLevel', () => {
        function assertIndentLevel(text, expected, tabSize = 4) {
            let actual = (0, utils_1.computeIndentLevel)(text, tabSize);
