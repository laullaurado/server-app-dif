...
define(["require", "exports", "vs/base/common/cancellation", "vs/base/common/filters", "vs/base/common/iterator", "vs/base/common/lifecycle", "vs/editor/browser/editorExtensions", "vs/editor/browser/services/codeEditorService", "vs/editor/common/core/range", "vs/editor/common/services/languageFeatures", "vs/editor/common/standalone/standaloneEnums", "vs/editor/contrib/suggest/browser/completionModel", "vs/editor/contrib/suggest/browser/suggest", "vs/editor/contrib/suggest/browser/suggestMemory", "vs/editor/contrib/suggest/browser/wordDistance", "vs/platform/clipboard/common/clipboardService", "vs/platform/instantiation/common/instantiation"], function (require, exports, cancellation_1, filters_1, iterator_1, lifecycle_1, editorExtensions_1, codeEditorService_1, range_1, languageFeatures_1, standaloneEnums_1, completionModel_1, suggest_1, suggestMemory_1, wordDistance_1, clipboardService_1, instantiation_1) {
    "use strict";
    ...
    let SuggestInlineCompletions = class SuggestInlineCompletions {
        ...
        async provideInlineCompletions(model, position, context, token) {
            ...
            if (!triggerCharacterInfo && ((_a = this._lastResult) === null || _a === void 0 ? void 0 : _a.canBeReused(model, position.lineNumber, wordInfo))) {
                ...
                const completionModel = new completionModel_1.CompletionModel(completions.items, position.column, new completionModel_1.LineContext(leadingLineContents, 0), wordDistance_1.WordDistance.None, this._getEditorOption(107 /* EditorOption.suggest */, model), this._getEditorOption(102 /* EditorOption.snippetSuggestions */, model), { boostFullMatch: false, firstMatchCanBeWeak: false }, clipboardText);
