...
define(["require", "exports", "assert", "vs/base/common/lifecycle", "vs/editor/common/core/selection", "vs/editor/common/languages", "vs/editor/common/languages/languageConfigurationRegistry", "vs/editor/common/languages/nullTokenize", "vs/editor/common/languages/language", "vs/editor/contrib/comment/browser/lineCommentCommand", "vs/editor/test/browser/testCommand", "vs/platform/instantiation/common/instantiation", "vs/editor/test/common/modes/testLanguageConfigurationService"], function (require, exports, assert, lifecycle_1, selection_1, languages_1, languageConfigurationRegistry_1, nullTokenize_1, language_1, lineCommentCommand_1, testCommand_1, instantiation_1, testLanguageConfigurationService_1) {
    "use strict";
    ...
    suite('Editor Contrib - Line Comment Command', () => {
        ...
        test('_analyzeLines', () => {
            ...
            r = lineCommentCommand_1.LineCommentCommand._analyzeLines(0 /* Type.Toggle */, true, createSimpleModel([
                ...
                '    c',
                '\t\td'
            ]), createBasicLinePreflightData(['//', 'rem', '!@#', '!@#']), 1, true, false, new testLanguageConfigurationService_1.TestLanguageConfigurationService());
            if (!r.supported) {
