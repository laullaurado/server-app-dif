 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/common/diff/diff", "vs/base/common/strings", "vs/editor/common/core/range", "vs/editor/contrib/inlineCompletions/browser/ghostText"], function (require, exports, diff_1, strings, range_1, ghostText_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.inlineCompletionToGhostText = exports.normalizedInlineCompletionsEquals = exports.minimizeInlineCompletion = void 0;
    function minimizeInlineCompletion(model, inlineCompletion) {
        ...
        return {
            range: range_1.Range.fromPositions(start, end),
    ...
    exports.minimizeInlineCompletion = minimizeInlineCompletion;
    ...
    exports.normalizedInlineCompletionsEquals = normalizedInlineCompletionsEquals;
    /**
    ...
    */
    function inlineCompletionToGhostText(inlineCompletion, textModel, mode, cursorPosition, previewSuffixLength = 0) {
        ...
        if (suggestionTouchesIndentation) {
            ...
            const rangeThatDoesNotReplaceIndentation = range_1.Range.fromPositions(inlineCompletion.range.getStartPosition().delta(0, replacedIndentation.length), inlineCompletion.range.getEndPosition());
        ...
        return new ghostText_1.GhostText(lineNumber, parts, 0);
    }
    exports.inlineCompletionToGhostText = inlineCompletionToGhostText;
...
//# sourceMappingURL=inlineCompletionToGhostText.js.map