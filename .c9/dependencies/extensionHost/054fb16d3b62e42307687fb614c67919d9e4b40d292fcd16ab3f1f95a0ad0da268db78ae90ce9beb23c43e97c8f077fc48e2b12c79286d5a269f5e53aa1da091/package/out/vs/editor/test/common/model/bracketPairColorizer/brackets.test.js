...
define(["require", "exports", "assert", "vs/base/common/lifecycle", "vs/editor/common/model/bracketPairsTextModelPart/bracketPairsTree/brackets", "vs/editor/common/model/bracketPairsTextModelPart/bracketPairsTree/smallImmutableSet", "vs/editor/test/common/modes/testLanguageConfigurationService"], function (require, exports, assert, lifecycle_1, brackets_1, smallImmutableSet_1, testLanguageConfigurationService_1) {
    ...
    suite('Bracket Pair Colorizer - Brackets', () => {
        test('Basic', () => {
            ...
            const languageConfigService = new testLanguageConfigurationService_1.TestLanguageConfigurationService();
