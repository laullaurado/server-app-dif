    ...
    class FindWidget extends widget_1.Widget {
        constructor(codeEditor, controller, state, contextViewProvider, keybindingService, contextKeyService, themeService, storageService, notificationService) {
            ...
            this._register(this._codeEditor.onDidChangeConfiguration((e) => {
                if (e.hasChanged(82 /* EditorOption.readOnly */)) {
                    if (this._codeEditor.getOption(82 /* EditorOption.readOnly */)) {
                ...
                if (e.hasChanged(36 /* EditorOption.find */)) {
                    const addExtraSpaceOnTop = this._codeEditor.getOption(36 /* EditorOption.find */).addExtraSpaceOnTop;
            ...
            if (this._codeEditor.getOption(36 /* EditorOption.find */).addExtraSpaceOnTop) {
        ...
        _onStateChanged(e) {
            ...
            if (e.isReplaceRevealed) {
                if (this._state.isReplaceRevealed) {
                    if (!this._codeEditor.getOption(82 /* EditorOption.readOnly */) && !this._isReplaceVisible) {
        ...
        _updateButtons() {
            ...
            let canReplace = !this._codeEditor.getOption(82 /* EditorOption.readOnly */);
        ...
        _reveal() {
            ...
            if (!this._isVisible) {
                ...
                switch (this._codeEditor.getOption(36 /* EditorOption.find */).autoFindInSelection) {
                    case 'always':
                        this._toggleSelectionFind.checked = true;
                        break;
                    case 'never':
                ...
                if (this._codeEditor.getOption(36 /* EditorOption.find */).seedSearchStringFromSelection && selection) {
        ...
        _showViewZone(adjustScroll = true) {
            ...
            this._codeEditor.changeViewZones((accessor) => {
                if (this._viewZoneId !== undefined) {
                    ...
                    scrollAdjustment -= this._codeEditor.getOption(76 /* EditorOption.padding */).top;
