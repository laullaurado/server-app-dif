 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/editor/common/core/editOperation", "vs/editor/common/core/range", "vs/editor/common/textModelEvents", "vs/editor/test/common/testTextModel"], function (require, exports, assert, editOperation_1, range_1, textModelEvents_1, testTextModel_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    suite('Editor Model - Injected Text Events', () => {
        let thisModel;
        setup(() => {
            thisModel = (0, testTextModel_1.createTextModel)('First Line\nSecond Line');
        });
        teardown(() => {
            thisModel.dispose();
        });
