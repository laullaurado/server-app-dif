 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/editor/common/core/editOperation", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/test/common/testTextModel"], function (require, exports, assert, editOperation_1, position_1, range_1, testTextModel_1) {
    "use strict";
    ...
    suite('Editor Model - Model Decorations', () => {
        ...
        test('removeAllDecorationsWithOwnerId can be called after model dispose', () => {
            let model = (0, testTextModel_1.createTextModel)('asd');
            model.dispose();
    ...
    suite('deltaDecorations', () => {
        ...
        function testDeltaDecorations(text, decorations, newDecorations) {
            let model = (0, testTextModel_1.createTextModel)(text.join('\n'));
        ...
        test('issue #16922: Clicking on link doesn\'t seem to do anything', () => {
            ...
            let inRange = model.getDecorationsInRange(new range_1.Range(2, 6, 2, 6));
