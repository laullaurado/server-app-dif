 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/base/common/search", "vs/editor/contrib/find/browser/replacePattern"], function (require, exports, assert, search_1, replacePattern_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    suite('Replace Pattern test', () => {
        test('parse replace string', () => {
            let testParse = (input, expectedPieces) => {
                let actual = (0, replacePattern_1.parseReplaceString)(input);
        ...
        test('parse replace string with case modifiers', () => {
            ...
            function assertReplace(target, search, replaceString, expected) {
                let replacePattern = (0, replacePattern_1.parseReplaceString)(replaceString);
        ...
        test('issue #19740 Find and replace capture group/backreference inserts `undefined` instead of empty string', () => {
            let replacePattern = (0, replacePattern_1.parseReplaceString)('a{$1}');
