...
define(["require", "exports", "vs/base/browser/ui/aria/aria", "vs/base/common/arrays", "vs/base/common/async", "vs/base/common/cancellation", "vs/base/common/errors", "vs/base/common/lifecycle", "vs/editor/browser/editorExtensions", "vs/editor/common/core/range", "vs/editor/common/editorContextKeys", "vs/editor/common/model", "vs/editor/common/model/textModel", "vs/editor/common/languages", "vs/nls", "vs/platform/contextkey/common/contextkey", "vs/platform/theme/common/colorRegistry", "vs/platform/theme/common/themeService", "vs/editor/common/services/languageFeatures", "vs/platform/theme/common/theme"], function (require, exports, aria_1, arrays, async_1, cancellation_1, errors_1, lifecycle_1, editorExtensions_1, range_1, editorContextKeys_1, model_1, textModel_1, languages_1, nls, contextkey_1, colorRegistry_1, themeService_1, languageFeatures_1, theme_1) {
    "use strict";
    ...
    class WordHighlighter {
        constructor(editor, providers, contextKeyService) {
            ...
            this.occurrencesHighlight = this.editor.getOption(73 /* EditorOption.occurrencesHighlight */);
            ...
            this.toUnhook.add(editor.onDidChangeConfiguration((e) => {
                let newValue = this.editor.getOption(73 /* EditorOption.occurrencesHighlight */);
