 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/languages", "vs/editor/common/languages/nullTokenize", "vs/editor/common/viewModel/monospaceLineBreaksComputer", "vs/editor/common/viewModel/viewModelLines", "vs/editor/test/browser/config/testConfiguration", "vs/editor/test/common/testTextModel", "vs/editor/common/viewModel/modelLineProjection", "vs/editor/common/modelLineProjectionData"], function (require, exports, assert, position_1, range_1, languages, nullTokenize_1, monospaceLineBreaksComputer_1, viewModelLines_1, testConfiguration_1, testTextModel_1, modelLineProjection_1, modelLineProjectionData_1) {
    "use strict";
    ...
    suite('Editor ViewModel - SplitLinesCollection', () => {
        ...
        function withSplitLinesCollection(text, callback) {
            ...
            const wrappingInfo = config.options.get(133 /* EditorOption.wrappingInfo */);
            const fontInfo = config.options.get(45 /* EditorOption.fontInfo */);
            const wordWrapBreakAfterCharacters = config.options.get(120 /* EditorOption.wordWrapBreakAfterCharacters */);
            const wordWrapBreakBeforeCharacters = config.options.get(121 /* EditorOption.wordWrapBreakBeforeCharacters */);
            const wrappingIndent = config.options.get(125 /* EditorOption.wrappingIndent */);
            ...
            const linesCollection = new viewModelLines_1.ViewModelLinesFromProjectedModel(1, model, lineBreaksComputerFactory, lineBreaksComputerFactory, fontInfo, model.getOptions().tabSize, 'simple', wrappingInfo.wrappingColumn, wrappingIndent);
    ...
    suite('SplitLinesCollection', () => {
        ...
        test('getViewLinesData - with wrapping and injected text', () => {
            ...
            withSplitLinesCollection(model, 'wordWrapColumn', 30, (splitLinesCollection) => {
                ...
                assert.deepStrictEqual(data.map((d) => {
                    var _a;
                    return ({
                        inlineDecorations: (_a = d.inlineDecorations) === null || _a === void 0 ? void 0 : _a.map((d) => ({
        ...
        function withSplitLinesCollection(model, wordWrap, wordWrapColumn, callback) {
            ...
            const wrappingInfo = configuration.options.get(133 /* EditorOption.wrappingInfo */);
            const fontInfo = configuration.options.get(45 /* EditorOption.fontInfo */);
            const wordWrapBreakAfterCharacters = configuration.options.get(120 /* EditorOption.wordWrapBreakAfterCharacters */);
            const wordWrapBreakBeforeCharacters = configuration.options.get(121 /* EditorOption.wordWrapBreakBeforeCharacters */);
            const wrappingIndent = configuration.options.get(125 /* EditorOption.wrappingIndent */);
            const lineBreaksComputerFactory = new monospaceLineBreaksComputer_1.MonospaceLineBreaksComputerFactory(wordWrapBreakBeforeCharacters, wordWrapBreakAfterCharacters);
            const linesCollection = new viewModelLines_1.ViewModelLinesFromProjectedModel(1, model, lineBreaksComputerFactory, lineBreaksComputerFactory, fontInfo, model.getOptions().tabSize, 'simple', wrappingInfo.wrappingColumn, wrappingIndent);
