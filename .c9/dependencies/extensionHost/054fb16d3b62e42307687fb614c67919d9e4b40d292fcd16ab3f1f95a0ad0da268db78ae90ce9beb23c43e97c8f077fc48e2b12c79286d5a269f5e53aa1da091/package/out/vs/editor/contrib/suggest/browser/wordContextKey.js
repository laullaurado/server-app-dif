...
define(["require", "exports", "vs/platform/contextkey/common/contextkey"], function (require, exports, contextkey_1) {
    ...
    let WordContextKey = class WordContextKey {
        constructor(_editor, contextKeyService) {
            ...
            this._configListener = this._editor.onDidChangeConfiguration(e => e.hasChanged(112 /* EditorOption.tabCompletion */) && this._update());
            this._update();
        }
        dispose() {
            var _a;
        ...
        _update() {
            ...
            const enabled = this._editor.getOption(112 /* EditorOption.tabCompletion */) === 'on';
