 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "child_process", "fs", "os", "vs/base/common/event", "vs/base/common/path", "vs/base/common/platform", "vs/base/common/ports", "vs/base/common/types", "vs/base/node/pfs", "vs/base/node/ports", "vs/platform/files/node/watcher/nodejs/nodejsWatcherLib", "vs/platform/environment/node/argv", "vs/platform/environment/node/argvHelper", "vs/platform/environment/node/stdin", "vs/platform/environment/node/wait", "vs/platform/product/common/product", "vs/base/common/cancellation", "vs/base/common/extpath", "vs/platform/profiling/common/profiling"], function (require, exports, child_process_1, fs_1, os_1, event_1, path_1, platform_1, ports_1, types_1, pfs_1, ports_2, nodejsWatcherLib_1, argv_1, argvHelper_1, stdin_1, wait_1, product_1, cancellation_1, extpath_1, profiling_1) {
    "use strict";
    ...
    async function main(argv) {
        ...
        // Just Code
            ...
            if (!isMacOSBigSurOrNewer) {
                ...
                child = (0, child_process_1.spawn)('open', spawnArgs, Object.assign(Object.assign({}, options), { env: {} }));
            }
