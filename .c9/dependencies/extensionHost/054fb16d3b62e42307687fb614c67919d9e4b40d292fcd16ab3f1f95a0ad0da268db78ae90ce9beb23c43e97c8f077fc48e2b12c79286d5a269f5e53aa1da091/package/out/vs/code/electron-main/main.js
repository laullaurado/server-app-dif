...
define(["require", "exports", "electron", "fs", "vs/base/common/uri", "vs/base/common/arrays", "vs/base/common/async", "vs/base/common/errorMessage", "vs/base/common/errors", "vs/base/common/extpath", "vs/base/common/functional", "vs/base/common/labels", "vs/base/common/network", "vs/base/common/path", "vs/base/common/performance", "vs/base/common/platform", "vs/base/common/process", "vs/base/common/strings", "vs/base/node/pfs", "vs/base/parts/ipc/common/ipc", "vs/base/parts/ipc/node/ipc.net", "vs/code/electron-main/app", "vs/nls", "vs/platform/configuration/common/configuration", "vs/platform/configuration/common/configurationService", "vs/platform/diagnostics/node/diagnosticsService", "vs/platform/environment/electron-main/environmentMainService", "vs/platform/environment/node/argvHelper", "vs/platform/environment/node/wait", "vs/platform/files/common/files", "vs/platform/files/common/fileService", "vs/platform/files/node/diskFileSystemProvider", "vs/platform/instantiation/common/descriptors", "vs/platform/instantiation/common/instantiationService", "vs/platform/instantiation/common/serviceCollection", "vs/platform/lifecycle/electron-main/lifecycleMainService", "vs/platform/log/common/bufferLog", "vs/platform/log/common/log", "vs/platform/log/node/loggerService", "vs/platform/log/node/spdlogLog", "vs/platform/product/common/product", "vs/platform/product/common/productService", "vs/platform/protocol/electron-main/protocol", "vs/platform/protocol/electron-main/protocolMainService", "vs/platform/tunnel/common/tunnel", "vs/platform/tunnel/node/tunnelService", "vs/platform/request/common/request", "vs/platform/request/electron-main/requestMainService", "vs/platform/sign/common/sign", "vs/platform/sign/node/signService", "vs/platform/state/electron-main/state", "vs/platform/state/electron-main/stateMainService", "vs/platform/telemetry/common/telemetryUtils", "vs/platform/theme/electron-main/themeMainService", "vs/platform/policy/common/policy", "vs/platform/policy/node/nativePolicyService", "vs/platform/policy/common/filePolicyService", "vs/base/common/lifecycle", "vs/platform/update/common/update.config.contribution"], function (require, exports, electron_1, fs_1, uri_1, arrays_1, async_1, errorMessage_1, errors_1, extpath_1, functional_1, labels_1, network_1, path_1, performance_1, platform_1, process_1, strings_1, pfs_1, ipc_1, ipc_net_1, app_1, nls_1, configuration_1, configurationService_1, diagnosticsService_1, environmentMainService_1, argvHelper_1, wait_1, files_1, fileService_1, diskFileSystemProvider_1, descriptors_1, instantiationService_1, serviceCollection_1, lifecycleMainService_1, bufferLog_1, log_1, loggerService_1, spdlogLog_1, product_1, productService_1, protocol_1, protocolMainService_1, tunnel_1, tunnelService_1, request_1, requestMainService_1, sign_1, signService_1, state_1, stateMainService_1, telemetryUtils_1, themeMainService_1, policy_1, nativePolicyService_1, filePolicyService_1, lifecycle_1) {
    ...
    class CodeMain {
        ...
        async startup() {
            ...
            try {
                ...
                await instantiationService.invokeFunction(async (accessor) => {
                    ...
                    bufferLogService.logger = new spdlogLog_1.SpdLogLogger('main', (0, path_1.join)(environmentMainService.logsPath, 'main.log'), true, false, bufferLogService.getLevel());
                    // Lifecycle
                    (0, functional_1.once)(lifecycleMainService.onWillShutdown)(evt => {
                        fileService.dispose();
                        configurationService.dispose();
                        evt.join(pfs_1.Promises.unlink(environmentMainService.mainLockfile).catch(() => { }));
                    });
        ...
        createServices() {
            ...
            const logService = disposables.add(new log_1.MultiplexLogService([new log_1.ConsoleMainLogger((0, log_1.getLogLevel)(environmentMainService)), bufferLogService]));
            ...
            // Policy
            const policyService = platform_1.isWindows && productService.win32RegValueName ? disposables.add(new nativePolicyService_1.NativePolicyService(productService.win32RegValueName))
            ...
            // Configuration
            const configurationService = new configurationService_1.ConfigurationService(environmentMainService.settingsResource, fileService, policyService, logService);
            ...
            // State
            const stateMainService = new stateMainService_1.StateMainService(environmentMainService, logService, fileService);
            services.set(state_1.IStateMainService, stateMainService);
            // Request
            ...
            return [new instantiationService_1.InstantiationService(services, true), instanceEnvironment, environmentMainService, policyService, configurationService, stateMainService, bufferLogService, productService];
        }
        ...
        initServices(environmentMainService, policyService, configurationService, stateMainService) {
            return async_1.Promises.settled([
            ...
            try {
                ...
                try {
                    ...
                    if (!retry || platform_1.isWindows || error.code !== 'ECONNREFUSED') {
                        if (error.code === 'EPERM') {
                            this.showStartupWarningDialog((0, nls_1.localize)('secondInstanceAdmin', "A second instance of {0} is already running as administrator.", productService.nameShort), (0, nls_1.localize)('secondInstanceAdminDetail', "Please close the other instance and try again."), productService.nameLong);
                        }
                        throw error;
                    }
                ...
                if (!environmentMainService.args.wait && !environmentMainService.args.status) {
                    startupWarningDialogHandle = setTimeout(() => {
                        this.showStartupWarningDialog((0, nls_1.localize)('secondInstanceNoResponse', "Another instance of {0} is running but not responding", productService.nameShort), (0, nls_1.localize)('secondInstanceNoResponseDetail', "Please close all other instances and try again."), productService.nameLong);
                    }, 10000);
                }
        ...
        showStartupWarningDialog(message, detail, title) {
            ...
            electron_1.dialog.showMessageBoxSync({
                title,
                type: 'warning',
                buttons: [(0, labels_1.mnemonicButtonLabel)((0, nls_1.localize)({ key: 'close', comment: ['&& denotes a mnemonic'] }, "&&Close"))],
                message,
                detail,
                defaultId: 0,
                noLink: true
