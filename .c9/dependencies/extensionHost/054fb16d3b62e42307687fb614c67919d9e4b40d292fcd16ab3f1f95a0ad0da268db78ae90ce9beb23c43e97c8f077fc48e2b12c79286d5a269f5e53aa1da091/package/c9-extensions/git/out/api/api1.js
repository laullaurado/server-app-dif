...
class ApiRepository {
    ...
    add(paths) {
        return this._repository.add(paths.map(p => vscode_1.Uri.file(p)));
    }
    revert(paths) {
        return this._repository.revert(paths.map(p => vscode_1.Uri.file(p)));
    }
    clean(paths) {
...
function getStatus(status) {
    switch (status) {
        ...
        case 10 /* Status.ADDED_BY_US */: return 'ADDED_BY_US';
        case 11 /* Status.ADDED_BY_THEM */: return 'ADDED_BY_THEM';
        case 12 /* Status.DELETED_BY_US */: return 'DELETED_BY_US';
        case 13 /* Status.DELETED_BY_THEM */: return 'DELETED_BY_THEM';
        case 14 /* Status.BOTH_ADDED */: return 'BOTH_ADDED';
        case 15 /* Status.BOTH_DELETED */: return 'BOTH_DELETED';
        case 16 /* Status.BOTH_MODIFIED */: return 'BOTH_MODIFIED';
    }
    return 'UNKNOWN';
}
