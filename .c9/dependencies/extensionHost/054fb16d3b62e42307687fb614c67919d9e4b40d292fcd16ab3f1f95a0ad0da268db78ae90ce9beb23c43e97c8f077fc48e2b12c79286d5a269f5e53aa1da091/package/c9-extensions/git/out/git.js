...
function findGitWin32InPath(onValidate) {
    // @ts-ignore
...
async function findGit(hints, onValidate) {
...
class Repository {
    ...
    getStatus(opts) {
        return new Promise((c, e) => {
            ...
            const args = ['status', '-z'];
            if ((opts === null || opts === void 0 ? void 0 : opts.untrackedChanges) === 'hidden') {
                args.push('-uno');
            }
            else {
                args.push('-uall');
            ...
            const limit = (_a = opts === null || opts === void 0 ? void 0 : opts.limit) !== null && _a !== void 0 ? _a : 10000;
    ...
    async getRefs(opts) {
        ...
        const fn = (line) => {
            ...
            if (match = /^refs\/heads\/([^ ]+) ([0-9a-f]{40}) ([0-9a-f]{40})?$/.exec(line)) {
                ...
                return { name: match[1], commit: (_a = match[3]) !== null && _a !== void 0 ? _a : match[2], type: 2 /* RefType.Tag */ };
            }
            return null;
        };
    ...
    async getBranches(query) {
        ...
        return refs.filter(value => (value.type !== 2 /* RefType.Tag */) && (query.remote || !value.remote));
    }
