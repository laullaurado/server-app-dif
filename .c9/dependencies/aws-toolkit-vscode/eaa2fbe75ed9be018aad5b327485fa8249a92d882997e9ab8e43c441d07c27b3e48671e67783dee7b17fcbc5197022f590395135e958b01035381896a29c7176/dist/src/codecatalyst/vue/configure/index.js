(()=>{var ce={694:(e,o,s)=>{"use strict";s.r(o),s.d(o,{default:()=>b});var a=s(537),i=s.n(a),l=s(645),h=s.n(l),g=h()(i());g.push([e.id,`
...
`],sourceRoot:""}]);const b=g},234:(e,o,s)=>{"use strict";s.r(o),s.d(o,{default:()=>b});var a=s(537),i=s.n(a),l=s(645),h=s.n(l),g=h()(i());g.push([e.id,`
...
`],sourceRoot:""}]);const b=g},969:(e,o,s)=>{"use strict";s.r(o),s.d(o,{default:()=>b});var a=s(537),i=s.n(a),l=s(645),h=s.n(l),g=h()(i());g.push([e.id,`
...
`],sourceRoot:""}]);const b=g},306:(e,o,s)=>{"use strict";s.r(o),s.d(o,{default:()=>b});var a=s(537),i=s.n(a),l=s(645),h=s.n(l),g=h()(i());g.push([e.id,`
...
`],sourceRoot:""}]);const b=g},645:e=>{"use strict";e.exports=function(o){var s=[];return s.toString=function(){return this.map(function(i){var l="",h=typeof i[5]!="undefined";return i[4]&&(l+="@supports (".concat(i[4],") {")),i[2]&&(l+="@media ".concat(i[2]," {")),h&&(l+="@layer".concat(i[5].length>0?" ".concat(i[5]):""," {")),l+=o(i),h&&(l+="}"),i[2]&&(l+="}"),i[4]&&(l+="}"),l}).join("")},s.i=function(i,l,h,g,b){typeof i=="string"&&(i=[[null,i,void 0]]);var S={};if(h)for(var k=0;k<this.length;k++){var O=this[k][0];O!=null&&(S[O]=!0)}for(var P=0;P<i.length;P++){var _=[].concat(i[P]);h&&S[_[0]]||(typeof b!="undefined"&&(typeof _[5]=="undefined"||(_[1]="@layer".concat(_[5].length>0?" ".concat(_[5]):""," {").concat(_[1],"}")),_[5]=b),l&&(_[2]&&(_[1]="@media ".concat(_[2]," {").concat(_[1],"}")),_[2]=l),g&&(_[4]?(_[1]="@supports (".concat(_[4],") {").concat(_[1],"}"),_[4]=g):_[4]="".concat(g)),s.push(_))}},s}},537:e=>{"use strict";e.exports=function(o){var s=o[1],a=o[3];if(!a)return s;if(typeof btoa=="function"){var i=btoa(unescape(encodeURIComponent(JSON.stringify(a)))),l="sourceMappingURL=data:application/json;charset=utf-8;base64,".concat(i),h="/*# ".concat(l," */");return[s].concat([h]).join(`
`)}return[s].join(`
`)}},744:(e,o)=>{"use strict";var s;s={value:!0},o.Z=(a,i)=>{for(const[l,h]of i)a[l]=h;return a}},648:(e,o,s)=>{var a=s(694);a.__esModule&&(a=a.default),typeof a=="string"&&(a=[[e.id,a,""]]),a.locals&&(e.exports=a.locals);var i=s(346).Z,l=i("5af41cdc",a,!1,{})},461:(e,o,s)=>{var a=s(234);a.__esModule&&(a=a.default),typeof a=="string"&&(a=[[e.id,a,""]]),a.locals&&(e.exports=a.locals);var i=s(346).Z,l=i("716e461a",a,!1,{})},638:(e,o,s)=>{var a=s(969);a.__esModule&&(a=a.default),typeof a=="string"&&(a=[[e.id,a,""]]),a.locals&&(e.exports=a.locals);var i=s(346).Z,l=i("455d4da0",a,!1,{})},679:(e,o,s)=>{var a=s(306);a.__esModule&&(a=a.default),typeof a=="string"&&(a=[[e.id,a,""]]),a.locals&&(e.exports=a.locals);var i=s(346).Z,l=i("7708e8a2",a,!1,{})},346:(e,o,s)=>{"use strict";s.d(o,{Z:()=>J});function a(r,m){for(var u=[],p={},c=0;c<m.length;c++){var I=m[c],A=I[0],$=I[1],w=I[2],L=I[3],y={id:r+":"+c,css:$,media:w,sourceMap:L};p[A]?p[A].parts.push(y):u.push(p[A]={id:A,parts:[y]})}return u}var i=typeof document!="undefined";if(typeof DEBUG!="undefined"&&DEBUG&&!i)throw new Error("vue-style-loader cannot be used in a non-browser environment. Use { target: 'node' } in your Webpack config to indicate a server-rendering environment.");var l={},h=i&&(document.head||document.getElementsByTagName("head")[0]),g=null,b=0,S=!1,k=function(){},O=null,P="data-vue-ssr-id",_=typeof navigator!="undefined"&&/msie [6-9]\b/.test(navigator.userAgent.toLowerCase());function J(r,m,u,p){S=u,O=p||{};var c=a(r,m);return z(c),function(A){for(var $=[],w=0;w<c.length;w++){var L=c[w],y=l[L.id];y.refs--,$.push(y)}A?(c=a(r,A),z(c)):c=[];for(var w=0;w<$.length;w++){var y=$[w];if(y.refs===0){for(var R=0;R<y.parts.length;R++)y.parts[R]();delete l[y.id]}}}}function z(r){for(var m=0;m<r.length;m++){var u=r[m],p=l[u.id];if(p){p.refs++;for(var c=0;c<p.parts.length;c++)p.parts[c](u.parts[c]);for(;c<u.parts.length;c++)p.parts.push(F(u.parts[c]));p.parts.length>u.parts.length&&(p.parts.length=u.parts.length)}else{for(var I=[],c=0;c<u.parts.length;c++)I.push(F(u.parts[c]));l[u.id]={id:u.id,refs:1,parts:I}}}}function H(){var r=document.createElement("style");return r.type="text/css",h.appendChild(r),r}function F(r){var m,u,p=document.querySelector("style["+P+'~="'+r.id+'"]');if(p){if(S)return k;p.parentNode.removeChild(p)}if(_){var c=b++;p=g||(g=H()),m=G.bind(null,p,c,!1),u=G.bind(null,p,c,!0)}else p=H(),m=q.bind(null,p),u=function(){p.parentNode.removeChild(p)};return m(r),function(A){if(A){if(A.css===r.css&&A.media===r.media&&A.sourceMap===r.sourceMap)return;m(r=A)}else u()}}var Q=function(){var r=[];return function(m,u){return r[m]=u,r.filter(Boolean).join(`
...
/*# sourceMappingURL=data:application/json;base64,`+btoa(unescape(encodeURIComponent(JSON.stringify(c))))+" */"),r.styleSheet)r.styleSheet.cssText=u;else{for(;r.firstChild;)r.removeChild(r.firstChild);r.appendChild(document.createTextNode(u))}}}},se={};function E(e){var o=se[e];if(o!==void 0)return o.exports;var s=se[e]={id:e,exports:{}};return ce[e](s,s.exports,E),s.exports}E.n=e=>{var o=e&&e.__esModule?()=>e.default:()=>e;return E.d(o,{a:o}),o},E.d=(e,o)=>{for(var s in o)E.o(o,s)&&!E.o(e,s)&&Object.defineProperty(e,s,{enumerable:!0,get:o[s]})},E.o=(e,o)=>Object.prototype.hasOwnProperty.call(e,o),E.r=e=>{typeof Symbol!="undefined"&&Symbol.toStringTag&&Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(e,"__esModule",{value:!0})};var W={};(()=>{"use strict";E.r(W);const e=Vue,o=t=>((0,e.pushScopeId)("data-v-7b766e1c"),t=t(),(0,e.popScopeId)(),t),s={id:"configure-header"},a={style:{display:"inline"}},i=o(()=>(0,e.createElementVNode)("br",null,null,-1)),l={key:0,id:"restart-notification",class:"notification"},h=o(()=>(0,e.createElementVNode)("span",{id:"notification-span"},[(0,e.createElementVNode)("span",{id:"info-notification-icon",class:"icon icon-lg icon-vscode-info mr-8"}),(0,e.createElementVNode)("span",null,"Restart your Dev Environment to update with changes.")],-1)),g=["disabled"];function b(t,n,d,v,B,C){const f=(0,e.resolveComponent)("summary-panel"),T=(0,e.resolveComponent)("settings-panel"),D=(0,e.resolveComponent)("devfile-panel"),x=(0,e.resolveComponent)("compute-panel");return(0,e.openBlock)(),(0,e.createElementBlock)(e.Fragment,null,[(0,e.createElementVNode)("div",s,[(0,e.createElementVNode)("h2",a,"Settings for "+(0,e.toDisplayString)(t.devenvName),1),i]),(0,e.createVNode)(e.Transition,{name:"slide-down"},{default:(0,e.withCtx)(()=>[t.canRestart?((0,e.openBlock)(),(0,e.createElementBlock)("div",l,[h,(0,e.createElementVNode)("button",{id:"restart-button",type:"button",class:"button-theme-primary ml-16",disabled:t.restarting,onClick:n[0]||(n[0]=N=>t.restart())},(0,e.toDisplayString)(t.restarting?"Restarting...":"Restart"),9,g)])):(0,e.createCommentVNode)("v-if",!0)]),_:1}),(0,e.createVNode)(T,{id:"summary-panel",title:"Details"},{default:(0,e.withCtx)(()=>[(0,e.createVNode)(f,{modelValue:t.details,"onUpdate:modelValue":n[1]||(n[1]=N=>t.details=N),onEditSettings:t.editCompute},null,8,["modelValue","onEditSettings"])]),_:1}),(0,e.createVNode)(T,{id:"dev-file-panel",title:"Devfile",description:`Contains the definition to build your application libraries and toolchain. You can change the currently 
        configured definition file.`},{default:(0,e.withCtx)(()=>[(0,e.createVNode)(D,{"file-path":t.definitionFilePath},null,8,["file-path"])]),_:1}),(0,e.createVNode)(T,{id:"compute-settings-panel",title:"Dev Environment Configuration",description:"All settings except Storage can be changed after creation."},{default:(0,e.withCtx)(()=>[(0,e.createVNode)(x,{modelValue:t.compute,"onUpdate:modelValue":n[2]||(n[2]=N=>t.compute=N),type:"configure",onEditSettings:t.editCompute},null,8,["modelValue","onEditSettings"])]),_:1})],64)}const S=t=>((0,e.pushScopeId)("data-v-1cf5742c"),t=t(),(0,e.popScopeId)(),t),k={id:"summary-grid"},O={id:"alias",style:{"grid-area":"alias"}},P=S(()=>(0,e.createElementVNode)("span",{class:"label-context soft"},"Alias",-1)),_={key:0,class:"mb-8",style:{display:"block"}},J=["disabled"],z={key:0,id:"branch",style:{"grid-area":"branch"}},H=S(()=>(0,e.createElementVNode)("span",{class:"label-context soft"},"Branch",-1)),F={class:"mb-8",style:{display:"block"}},Q=(0,e.createTextVNode)(" Open Branch in CodeCatalyst "),G={id:"project",style:{"grid-area":"project"}},q=S(()=>(0,e.createElementVNode)("span",{class:"label-context soft"},"Project",-1)),r=["data-connected"],m=S(()=>(0,e.createElementVNode)("span",{class:"label-context soft"},"Status",-1)),u={key:0,id:"connected-icon",class:"icon icon-lg icon-vscode-pass"},p=["innerHTML"],c=["disabled"],$=[S(()=>(0,e.createElementVNode)("span",{id:"stop-icon",class:"icon icon-lg icon-vscode-stop-circle"},null,-1)),(0,e.createTextVNode)("Stop ")],w=["disabled"];function L(t,n,d,v,B,C){return(0,e.openBlock)(),(0,e.createElementBlock)("div",null,[(0,e.createElementVNode)("div",k,[(0,e.createElementVNode)("div",O,[P,t.summary.alias?((0,e.openBlock)(),(0,e.createElementBlock)("b",_,(0,e.toDisplayString)(t.summary.alias),1)):(0,e.createCommentVNode)("v-if",!0),(0,e.createElementVNode)("button",{id:"edit-alias",class:"button-theme-secondary",type:"button",disabled:!t.isConnected,onClick:n[0]||(n[0]=f=>t.$emit("editSettings","alias"))},(0,e.toDisplayString)(t.summary.alias?"Edit Alias":"Add Alias"),9,J)]),(0,e.createCommentVNode)("TODO: render something here if branch is missing"),t.branchName?((0,e.openBlock)(),(0,e.createElementBlock)("div",z,[H,(0,e.createElementVNode)("b",F,(0,e.toDisplayString)(t.branchName),1),(0,e.createElementVNode)("button",{class:"button-theme-secondary",onClick:n[1]||(n[1]=(...f)=>t.openBranch&&t.openBranch(...f))},[(0,e.createCommentVNode)("TODO: support 3P links?"),Q])])):(0,e.createCommentVNode)("v-if",!0),(0,e.createElementVNode)("div",G,[q,(0,e.createElementVNode)("b",null,(0,e.toDisplayString)(t.summary.project.name),1)]),(0,e.createElementVNode)("div",{id:"status",style:{"grid-area":"status"},"data-connected":t.isConnected},[m,(0,e.createElementVNode)("b",null,[t.isConnected?((0,e.openBlock)(),(0,e.createElementBlock)("span",u)):(0,e.createCommentVNode)("v-if",!0),(0,e.createElementVNode)("span",{innerHTML:t.isConnected?"Connected":t.status},null,8,p)])],8,r)]),(0,e.createElementVNode)("button",{id:"toggle-state",class:"button-theme-secondary mt-8",type:"button",disabled:!t.isConnected,onClick:n[2]||(n[2]=(...f)=>t.stopDevEnv&&t.stopDevEnv(...f))},$,8,c),(0,e.createCommentVNode)("TODO: add generic 'delete thing' prompt then enable this"),(0,e.withDirectives)((0,e.createElementVNode)("button",{id:"delete-devenv",class:"button-theme-secondary ml-8 mt-8",type:"button",disabled:!t.isConnected,onClick:n[3]||(n[3]=(...f)=>t.deleteDevEnv&&t.deleteDevEnv(...f))}," Delete Dev Environment ",8,w),[[e.vShow,!1]])])}/*!
 * Copyright 2021 Amazon.com, Inc. or its affiliates. All Rights Reserved.
 * SPDX-License-Identifier: Apache-2.0
 */class y{static registerGlobalCommands(){const n=new Event("remount");window.addEventListener("message",d=>{const{command:v}=d.data;v==="$clear"&&(vscode.setState({}),this.messageListeners.forEach(B=>this.removeListener(B)),window.dispatchEvent(n))})}static addListener(n){this.messageListeners.add(n),window.addEventListener("message",n)}static removeListener(n){this.messageListeners.delete(n),window.removeEventListener("message",n)}static sendRequest(n,d,v){const B=JSON.parse(JSON.stringify(v)),C=new Promise((f,T)=>{const D=N=>{const M=N.data;if(n===M.id)if(this.removeListener(D),window.clearTimeout(x),M.error===!0){const X=JSON.parse(M.data);T(new Error(X.message))}else M.event?(typeof v[0]!="function"&&T(new Error(`Expected frontend event handler to be a function: ${d}`)),f(this.registerEventHandler(d,v[0]))):f(M.data)},x=setTimeout(()=>{this.removeListener(D),T(new Error(`Timed out while waiting for response: id: ${n}, command: ${d}`))},3e5);this.addListener(D)});return vscode.postMessage({id:n,command:d,data:B}),C}static registerEventHandler(n,d){const v=B=>{const C=B.data;if(C.command===n){if(!C.event)throw new Error(`Expected backend handler to be an event emitter: ${n}`);d(C.data)}};return this.addListener(v),{dispose:()=>this.removeListener(v)}}static create(){return this.initialized||(this.initialized=!0,this.registerGlobalCommands()),new Proxy({},{set:()=>{throw new TypeError("Cannot set property to webview client")},get:(n,d)=>{var v;if(typeof d!="string"){console.warn(`Tried to index webview client with non-string property: ${String(d)}`);return}if(d==="init"){const C=(v=vscode.getState())!=null?v:{};if(C.__once)return()=>Promise.resolve();vscode.setState(Object.assign(C,{__once:!0}))}const B=(this.counter++).toString();return(...C)=>this.sendRequest(B,d,C)}})}}y.counter=0,y.initialized=!1,y.messageListeners=new Set;/*!
 * Copyright 2021 Amazon.com, Inc. or its affiliates. All Rights Reserved.
 * SPDX-License-Identifier: Apache-2.0
 */function R(t){return class{constructor(n={}){Object.assign(this,t,n)}}}function oe(t){return Object}const ee=y.create(),te=R({org:{name:""},project:{name:""},repositories:[],status:"",id:""}),pe=(0,e.defineComponent)({name:"devenv-summary",props:{modelValue:{type:oe(te),required:!0}},emits:{editSettings:t=>t!==void 0,"update:modelValue":t=>t!==void 0},computed:{status(){return this.summary.status.charAt(0).concat(this.summary.status.slice(1).toLowerCase())},isConnected(){return this.summary.status==="RUNNING"},summary(){return this.modelValue},branchName(){var t;return(t=this.summary.repositories[0])==null?void 0:t.branchName}},methods:{update(t,n){this.$emit("update:modelValue",{...this.modelValue,[t]:n})},async stopDevEnv(){try{this.update("status","STOPPING"),await ee.stopDevEnv(this.summary)}catch(t){this.update("status","RUNNING")}},async deleteDevEnv(){try{this.update("status","DELETING"),await ee.deleteDevEnv(this.summary)}catch(t){this.update("status","RUNNING")}},async openBranch(){return ee.openBranch()}}});var Ye=E(638),U=E(744);const ue=(0,U.Z)(pe,[["render",L],["__scopeId","data-v-1cf5742c"]]),K=t=>((0,e.pushScopeId)("data-v-6c191c15"),t=t(),(0,e.popScopeId)(),t),me={id:"compute-grid"},_e={id:"size",style:{"grid-area":"size"}},ve=K(()=>(0,e.createElementVNode)("span",{class:"label-context soft"},"Compute",-1)),fe=K(()=>(0,e.createElementVNode)("br",null,null,-1)),he={id:"timeout",style:{"grid-area":"timeout"}},ge=K(()=>(0,e.createElementVNode)("span",{class:"label-context soft"},"Timeout",-1)),Ae={id:"volume",style:{"grid-area":"volume"}},ye=K(()=>(0,e.createElementVNode)("span",{class:"label-context soft"},"Storage",-1)),Ce={key:0,class:"mt-0 mb-0"},be={key:1};function Ee(t,n){return(0,e.openBlock)(),(0,e.createElementBlock)("div",null,[(0,e.createElementVNode)("div",me,[(0,e.createElementVNode)("div",_e,[(0,e.createElementVNode)("div",null,[ve,(0,e.createElementVNode)("b",null,(0,e.toDisplayString)(t.instance.name),1),fe,(0,e.createTextVNode)(" "+(0,e.toDisplayString)(t.instance.specs),1)]),(0,e.createElementVNode)("button",{type:"button",id:"edit-size",class:"button-theme-secondary mt-8",onClick:n[0]||(n[0]=d=>t.$emit("editSettings","instanceType"))}," Edit Compute ")]),(0,e.createElementVNode)("div",he,[(0,e.createElementVNode)("div",null,[ge,(0,e.createElementVNode)("b",null,(0,e.toDisplayString)(t.timeout),1)]),(0,e.createElementVNode)("button",{type:"button",id:"edit-timeout",class:"button-theme-secondary mt-8",onClick:n[1]||(n[1]=d=>t.$emit("editSettings","inactivityTimeoutMinutes"))}," Edit Timeout ")]),(0,e.createElementVNode)("div",Ae,[ye,(0,e.createElementVNode)("b",null,(0,e.toDisplayString)(t.storage),1),t.mode==="update"?((0,e.openBlock)(),(0,e.createElementBlock)("p",Ce,(0,e.toDisplayString)(t.readonlyText),1)):((0,e.openBlock)(),(0,e.createElementBlock)("div",be,[(0,e.createElementVNode)("button",{type:"button",id:"edit-storage",class:"button-theme-secondary mt-8",onClick:n[2]||(n[2]=d=>t.$emit("editSettings","persistentStorage"))}," Edit Storage Size ")]))])])])}/*!
 * Copyright 2021 Amazon.com, Inc. or its affiliates. All Rights Reserved.
 * SPDX-License-Identifier: Apache-2.0
 */const Y=new Set;window.addEventListener("remount",()=>Y.clear());const ne={created(){var t,n,d,v,B;if(this.$data===void 0)return;const C=(t=vscode.getState())!=null?t:{};this.$options._count=((n=this.$options._count)!=null?n:0)+1;const f=(v=this.id)!=null?v:`${(d=this.name)!=null?d:`DEFAULT-${Y.size}`}-${this.$options._count}`;if(this.$options._unid=f,Y.has(f)){console.warn(`Component "${f}" already exists. State-saving functionality will be disabled.`);return}Y.add(f);const T=(B=C[f])!=null?B:{};Object.keys(this.$data).forEach(D=>{var x;this.$data[D]=(x=T[D])!=null?x:this.$data[D]}),Object.keys(this.$data).forEach(D=>{this.$watch(D,x=>{var N,M;const X=(N=vscode.getState())!=null?N:{},Ke=Object.assign((M=X[f])!=null?M:{},{[D]:x!==void 0?JSON.parse(JSON.stringify(x)):void 0});vscode.setState(Object.assign(X,{[f]:Ke}))},{deep:!0})})}},Be=y.create(),Z={inactivityTimeoutMinutes:15,instanceType:"dev.standard1.small",persistentStorage:{sizeInGiB:16}},j=R(Z),Ie=(0,e.defineComponent)({name:"compute-panel",props:{modelValue:{type:oe(j),default:new j},mode:{type:String,default:"update"}},data(){return{changed:{},readonlyText:"Can't be changed after creation.",descriptions:{},originalData:void 0}},mixins:[ne],created(){Be.getAllInstanceDescriptions().then(t=>this.descriptions=t)},watch:{model(t){if(!(t===void 0||this.originalData===void 0))for(const[n,d]of Object.entries(t))this.changed[n]=this.originalData[n]!==d},modelValue(){var t;(t=this.originalData)!=null||(this.originalData=this.modelValue)}},methods:{getNeedsRestartText(t){return this.mode==="update"&&this.changed[t]?" (needs restart)":""}},computed:{model(){return this.modelValue},instance(){const t=this.model.instanceType,n=this.descriptions[t]?{...this.descriptions[t]}:{name:"",specs:""},d=this.getNeedsRestartText("instanceType")||(t===Z.instanceType?" (default)":"");return n.name=`${n.name}${d}`,n},timeout(){const t=this.model.inactivityTimeoutMinutes,n=`${t} minutes`,d=this.getNeedsRestartText("inactivityTimeoutMinutes")||(t===Z.inactivityTimeoutMinutes?" (default)":"");return`${n}${d}`},storage(){const t=this.model.persistentStorage.sizeInGiB,n=`${t} GB`,d=t===Z.persistentStorage.sizeInGiB?" (default)":"";return`${n}${d}`}},emits:{editSettings:t=>t!==void 0}});var Je=E(648);const De=(0,U.Z)(Ie,[["render",Ee],["__scopeId","data-v-6c191c15"]]),qe=t=>(_pushScopeId("data-v-3858c4ad"),t=t(),_popScopeId(),t),Se=["id"],we={class:"header"},Te=["id"],xe=["for"],Ne={class:"preload-transition collapse-button icon icon-vscode-chevron-up",ref:"icon"},Pe={class:"settings-title"},Ve={class:"soft no-spacing mt-8"},Me={ref:"subPane",class:"sub-pane"};function ke(t,n,d,v,B,C){return(0,e.openBlock)(),(0,e.createElementBlock)("div",{id:t.id,class:"settings-panel"},[(0,e.createElementVNode)("div",we,[t.collapseable||t.startCollapsed?(0,e.withDirectives)(((0,e.openBlock)(),(0,e.createElementBlock)("input",{key:0,id:t.buttonId,style:{display:"none"},type:"checkbox","onUpdate:modelValue":n[0]||(n[0]=f=>t.collapsed=f)},null,8,Te)),[[e.vModelCheckbox,t.collapsed]]):(0,e.createCommentVNode)("v-if",!0),(0,e.createElementVNode)("label",{for:t.buttonId,class:"panel-header"},[(0,e.createElementVNode)("i",Ne,null,512),(0,e.createElementVNode)("span",Pe,(0,e.toDisplayString)(t.title),1)],8,xe),(0,e.createElementVNode)("p",Ve,(0,e.toDisplayString)(t.description),1)]),(0,e.createVNode)(e.Transition,{onEnter:t.updateHeight,onBeforeLeave:t.updateHeight,name:t.collapseable||t.startCollapsed?"collapse":""},{default:(0,e.withCtx)(()=>[(0,e.withDirectives)((0,e.createElementVNode)("div",Me,[(0,e.renderSlot)(t.$slots,"default",{},void 0,!0)],512),[[e.vShow,!t.collapsed]])]),_:3},8,["onEnter","onBeforeLeave","name"])],8,Se)}let re=0;const Oe=(0,e.defineComponent)({name:"settings-panel",props:{id:String,startCollapsed:Boolean,collapseable:Boolean,title:String,description:String},data(){var t;return re+=1,{collapsed:(t=this.$props.startCollapsed)!=null?t:!1,buttonId:`settings-panel-button-${re}`,lastHeight:void 0}},mixins:[ne],methods:{updateHeight(t){t.style&&(this.lastHeight=t.scrollHeight,t.style.setProperty("--max-height",`${this.lastHeight}px`))}},mounted(){var t,n;this.subPane=this.$refs.subPane,this.lastHeight=this.collapsed?this.lastHeight:(n=(t=this.subPane)==null?void 0:t.scrollHeight)!=null?n:this.lastHeight,this.$nextTick(()=>{setTimeout(()=>{var d;(d=this.$refs.icon)==null||d.classList.remove("preload-transition")},100)})}});var et=E(679);const $e=(0,U.Z)(Oe,[["render",ke],["__scopeId","data-v-3858c4ad"]]),Re={id:"location"},Le=(0,e.createElementVNode)("span",{class:"label-context soft"},"Location:",-1);function Ue(t,n,d,v,B,C){return(0,e.openBlock)(),(0,e.createElementBlock)(e.Fragment,null,[(0,e.createElementVNode)("div",Re,[Le,(0,e.createElementVNode)("b",null,(0,e.toDisplayString)(t.filePath),1)]),(0,e.createElementVNode)("button",{id:"preview-devfile",class:"button-theme-secondary no-wrap mt-8",type:"button",style:{"grid-area":"button"},onClick:n[0]||(n[0]=(...f)=>t.preview&&t.preview(...f))}," Open in Editor ")],64)}const je=y.create(),We=(0,e.defineComponent)({name:"devfile",props:{filePath:String},methods:{preview(){je.openDevfile()}}}),ze=(0,U.Z)(We,[["render",Ue]]),V=y.create(),He={details:new te,definitionFilePath:"",devenvUrl:"",devfileStatus:"STABLE",compute:new j,restarting:!1,needsRestart:!1,branchUrl:""},Fe=(0,e.defineComponent)({name:"configure",components:{settingsPanel:$e,devfilePanel:ze,computePanel:De,summaryPanel:ue},mixins:[ne],data(){return He},computed:{devenvName(){var t,n;const d=this.details.alias,v=(t=this.details.repositories[0])==null?void 0:t.branchName;return(n=d!=null?d:v)!=null?n:this.details.id},canRestart(){return(this.needsRestart||this.devfileStatus==="CHANGED")&&this.details.status==="RUNNING"}},created(){V.init().then(t=>{this.details=t?new te(t):this.details,this.compute=t?new j(t):this.compute}),V.onDidChangeDevfile(t=>{var n;this.devfileStatus=(n=t.status)!=null?n:this.devfileStatus}),this.definitionFilePath||V.getDevfileLocation().then(t=>this.definitionFilePath=t)},methods:{async editCompute(t){const n=this.compute[t],d={...this.compute,alias:this.details.alias},v=await V.editSetting(d,t);t!=="alias"?(this.needsRestart=this.needsRestart||n!==v[t],this.compute=new j(v)):v.alias&&(this.details.alias=v.alias,await V.updateDevEnv(this.details,{alias:this.details.alias}))},async restart(){this.restarting=!0;try{if(this.devfileStatus==="CHANGED"&&!this.needsRestart)return await V.updateDevfile(this.definitionFilePath);const t=await V.updateDevEnv(this.details,{instanceType:this.compute.instanceType,inactivityTimeoutMinutes:this.compute.inactivityTimeoutMinutes});this.restarting=!!t}catch(t){this.restarting=!1,V.showLogsMessage("Unable to update the dev Environment. View the logs for more information")}}}});var st=E(461);const Ge=(0,U.Z)(Fe,[["render",b],["__scopeId","data-v-7b766e1c"]]);/*!
 * Copyright 2021 Amazon.com, Inc. or its affiliates. All Rights Reserved.
 * SPDX-License-Identifier: Apache-2.0
