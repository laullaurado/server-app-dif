...
TERMINFO="/home/ubuntu/.c9/local/share/terminfo"
...
(*.[0-9]*)
	...
	if test ! -f "/home/ubuntu/.c9/ncurses-6.3/man_alias.sed" ; then
cat >>/home/ubuntu/.c9/ncurses-6.3/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /home/ubuntu/.c9/ncurses-6.3/man_alias.sed"
	fi
	...
	aliases=`sed -f "$top_srcdir/man/manlinks.sed" "$inalias" |sed -f "/home/ubuntu/.c9/ncurses-6.3/man_alias.sed" | sort -u; test "$inalias" = "$nCurses" && echo curses`
	cf_target=`grep "^$cf_source" /home/ubuntu/.c9/ncurses-6.3/man/man_db.renames | mawk '{print $2}'`
	...
	sed	-f "/home/ubuntu/.c9/ncurses-6.3/man_alias.sed" \
		< "$i" | sed -f /home/ubuntu/.c9/ncurses-6.3/edit_man.sed >$TMP
